...
r.listed=!0
var l=c.suffix.split("."),p=s.slice(0,s.length-l.length)
return c.exception&&p.push(l.shift()),r.tld=l.join("."),p.length?(c.wildcard&&(l.unshift(p.pop()),
r.tld=l.join(".")),
...
var u,c=[],l=!1,p=-1
function d(){
l&&u&&(l=!1,u.length?c=u.concat(c):p=-1,c.length&&m())
}
function m(){
if(!l){
var e=s(d)
...
c.push(new h(e,t)),1!==c.length||l||s(m)
...
return this.states=new l(this),this.head=this.tail=new u(c,0,0),
this.len=0,this
...
return a.Buffer.isBuffer(e)?new i(e):l(e)
})(e)
}:l
}
function d(){
...
return new o(m(this.buf,this.pos+=4),m(this.buf,this.pos+=4))
}
...
var a,o,r,s,u,c,l,d=[],m=t.length,h=t[i],g=t[i+1]
if(i===m&&n._listeners){
...
if("*"===h){
for(r in n){
"_listeners"!==r&&n.hasOwnProperty(r)&&(d=d.concat(p(e,t,n[r],i+1)))
}
return d
}
if("**"===h){
for(r in(l=i+1===m||i+2===m&&"*"===g)&&n._listeners&&(d=d.concat(p(e,t,n,m))),
n){
"_listeners"!==r&&n.hasOwnProperty(r)&&("*"===r||"**"===r?(n[r]._listeners&&!l&&(d=d.concat(p(e,t,n[r],m))),
d=d.concat(p(e,t,n[r],i))):d=r===g?d.concat(p(e,t,n[r],i+2)):d.concat(p(e,t,n[r],i)))
}
return d
}
d=d.concat(p(e,t,n[h],i+1))
}
if((s=n["*"])&&p(e,t,s,i+1),u=n["**"]){
if(i<m){
for(r in u._listeners&&p(e,t,u,m),u){
"_listeners"!==r&&u.hasOwnProperty(r)&&(r===g?p(e,t,u[r],i+2):r===h?p(e,t,u[r],i+1):((c={})[r]=u[r],
p(e,t,{
"**":c
},i+1)))
}
}else{
u._listeners?p(e,t,u,m):u["*"]&&u["*"]._listeners&&p(e,t,u["*"],m)
}
}
return d
}
...
c.call(this,a._listeners.length,o))):a._listeners=t,
!0
}
o=e.shift()
}
...
l.EventEmitter2=l,l.prototype.delimiter=".",l.prototype.setMaxListeners=function(e){
...
p.call(this,o,c,this.listenerTree,0)
}else{
o=this._events[e]
}
...
for(var u=-1,c=0,l=n.length;c<l;c++){
if(n[c]===t||n[c].listener&&n[c].listener===t||n[c]._origin&&n[c]._origin===t){
u=c
break
}
}
...
this._sessionId=n.session_id||c.createSessionId(),
...
this.flush()
},n.batchTimeoutMs||5e3),this.emit(c.Event.INITIALIZED)
})
}
updateIdentity(e){
...
if("undefined"!=typeof navigator&&(l(e,{
platform:{}
}),l(e.platform,{
...
e.exports=JSON.parse('{"ar":{"background.icon.unknown":"{0} - موقع غير معروف","background.icon.safe":"{0} - هذا الموقع آمن","background.icon.bad":"{0} - قد يكون هذا الموقع غير موثوق","background.icon.unsafe":"{0} - قد يكون هذا الموقع غير آمن","background.icon.nps":"هل أنت راضٍ عن {0}؟ يمكنك إجراء استطلاعٍ قصير","background.advertisers.runningGet.description":"جارٍ فحص جهات الإعلان المُتاحة لإلغاء الاشتراك بها…","background.advertisers.runningAct.description":"جارٍ إلغاء الاشتراك في شركات الإعلان…"},"be":{"background.icon.unknown":"{0}: невядомы сайт","background.icon.safe":"{0}: гэты вэб-сайт бяспечны","background.icon.bad":"{0}: гэты сайт можа быць небяспечным","background.icon.unsafe":"{0}: гэты вэб-сайт небяспечны","background.icon.nps":"Вы задаволены {0}? Прайдзіце кароткае апытанне","background.advertisers.runningGet.description":"Пошук рэкламадаўцаў, ад паслуг якіх можна адмовіцца…","background.advertisers.runningAct.description":"Выконваецца адмова ад паслуг рэкламных кампаній…"},"bg":{"background.icon.unknown":"{0} – Неизвестен сайт","background.icon.safe":"{0} – Уеб сайтът е безопасен","background.icon.bad":"{0} – Сайтът може да не е благонадежден","background.icon.unsafe":"{0} – Уеб сайтът не е безопасен","background.icon.nps":"Доволни ли сте от {0}? Попълнете една бърза анкета","background.advertisers.runningGet.description":"Сканиране на рекламодателите, които са налични за отказване…","background.advertisers.runningAct.description":"Изпълнява се отказване от рекламни компании…"},"bn":{"background.icon.unknown":"{0} - অজানা সাইট","background.icon.safe":"{0}- এই ওয়েবসাইটটি নিরাপদ","background.icon.bad":"{0}- এই সাইটটি বিশ্বাসযোগ্য নয়","background.icon.unsafe":"{0}- এই ওয়েবসাইটটি নিরাপদ নয়","background.icon.nps":" আপনি কি {0} সম্পর্কে খুশি? দ্রুত একটি সার্ভে করে দেখুন","background.advertisers.runningGet.description":"অপ্ট-আউট করার জন্য উপলভ্য বিজ্ঞাপনদাতাদের স্ক্যান করা…","background.advertisers.runningAct.description":"বিজ্ঞাপনী সংস্থাগুলি থেকে অপ্ট-আউট করার অগ্রগতি চলছে…"},"ca":{"background.icon.unknown":"{0}: Lloc desconegut.","background.icon.safe":"{0}: Aquest lloc web és segur.","background.icon.bad":"{0}: Aquest lloc pot ser no fiable.","background.icon.unsafe":"{0}: Aquest lloc web no és segur.","background.icon.nps":"Esteu satisfet amb l\'{0}? Responeu una enquesta ràpida","background.advertisers.runningGet.description":"S\'estan analitzant els anunciants els anuncis dels quals podeu triar deixar de rebre…","background.advertisers.runningAct.description":"El rebuig d\'empreses publicitàries està en curs…"},"cs":{"background.icon.unknown":"{0} – neznámá stránka","background.icon.safe":"{0} – tato stránka je bezpečná","background.icon.bad":"{0} – tato stránka může být nedůvěryhodná","background.icon.unsafe":"{0} – tato stránka je nebezpečná","background.icon.nps":"Vyhovuje vám {0}? Zúčastněte se krátkého průzkumu!","background.advertisers.runningGet.description":"Hledání reklamních firem k poslání nesouhlasu…","background.advertisers.runningAct.description":"Posílání nesouhlasu reklamním firmám…"},"da":{"background.icon.unknown":"{0} – ukendt websted","background.icon.safe":"{0} – dette websted er sikkert","background.icon.bad":"{0} – dette websted kan være upålideligt","background.icon.unsafe":"{0} – dette websted er ikke sikkert","background.icon.nps":"Er du glad for {0}? Tag en hurtig spørgeundersøgelse","background.advertisers.runningGet.description":"Scanner annoncører, der kan fravælges …","background.advertisers.runningAct.description":"Fravalg af annonceringsvirksomheder i gang …"},"de":{"background.icon.unknown":"{0} - Unbekannte Webseite","background.icon.safe":"{0} - Diese Webseite ist sicher","background.icon.bad":"{0} - Diese Webseite ist möglichweise nicht vertrauenswürdig","background.icon.unsafe":"{0} - Diese Webseite ist nicht sicher","background.icon.nps":"Sind Sie mit Ihrem {0} zufrieden? Nehmen Sie an einer schnellen Umfrage teil","background.advertisers.runningGet.description":"Scanne auf verfügbare Werbeunternehmen, bei denen Sie sich gegen eine Datenerfassung entscheiden können…","background.advertisers.runningAct.description":"Die Unterbindung der weiteren Datenerfassung durch Werbeunternehmen wird eingeleitet…"},"el":{"background.icon.unknown":"{0} - Άγνωστος ιστότοπος","background.icon.safe":"{0} - Αυτός ο ιστότοπος είναι ασφαλής","background.icon.bad":"{0} - Αυτός ο ιστότοπος μπορεί να είναι αναξιόπιστος","background.icon.unsafe":"{0} - Αυτός ο ιστότοπος δεν είναι ασφαλής","background.icon.nps":"Είστε ευχαριστημένοι από το {0}; Απαντήστε σε μια γρήγορη έρευνα","background.advertisers.runningGet.description":"Σάρωση διαφημιζόμενων διαθέσιμων για εξαίρεση…","background.advertisers.runningAct.description":"Εξαίρεση από διαφημιστικές εταιρείες σε εξέλιξη…"},"en":{"background.icon.unknown":"{0} - Unknown site","background.icon.safe":"{0} - This website is safe","background.icon.bad":"{0} - This site may be untrustworthy","background.icon.unsafe":"{0} - This website is unsafe","background.icon.nps":"Are you happy with {0}? Take a quick survey","background.advertisers.runningGet.description":"Scanning advertisers available for opt-out…","background.advertisers.runningAct.description":"Opt-out from advertising companies in progress…"},"es":{"background.icon.unknown":"{0}: Sitio desconocido","background.icon.safe":"{0}: Este sitio web es seguro.","background.icon.bad":"{0}: Este sitio puede ser poco fiable.","background.icon.unsafe":"{0}: Este sitio web no es seguro.","background.icon.nps":"¿Está satisfecho con {0}? Conteste a una breve encuesta","background.advertisers.runningGet.description":"Analizando los anunciantes que se pueden rechazar…","background.advertisers.runningAct.description":"Rechazo de empresas de publicidad en curso…"},"et":{"background.icon.unknown":"{0} - Tundmatu leht","background.icon.safe":"{0} - See veebileht on turvaline","background.icon.bad":"{0} - See leht võib olla ebausaldusväärne","background.icon.unsafe":"{0} - See veebileht ei ole turvaline","background.icon.nps":"Kas sa oled rahul {0}? Vasta lühikesele küsitlusele","background.advertisers.runningGet.description":"Reklaamipakkujate otsimine, kellest saab loobuda…","background.advertisers.runningAct.description":"Reklaamiettevõtetest loobumise protsess on pooleli…"},"fa":{"background.icon.unknown":"{0} - سایت ناشناخته","background.icon.safe":"{0} - این وب‌سایت امن است","background.icon.bad":"{0} - این سایت ممکن است نامعتبر باشد","background.icon.unsafe":"{0} - این وب‌سایت ناامن است","background.icon.nps":"آیا از {0} راضی هستید؟ در یک نظرسنجی سریع شرکت کنید","background.advertisers.runningGet.description":"اسکن تبلیغ‌کنندگان موجود برای انصراف دادن…","background.advertisers.runningAct.description":"انصراف از شرکت‌های تبلیغ‌کننده در حال انجام است…"},"fi":{"background.icon.unknown":"{0} - tuntematon sivusto","background.icon.safe":"{0} - Tämä sivusto on turvallinen","background.icon.bad":"{0} - sivusto voi olla epäluotettava","background.icon.unsafe":"{0} - Tämä sivusto ei ole turvallinen","background.icon.nps":"Onko {0} sellainen kuin toivotkin? Vastaa lyhyeen kyselyyn","background.advertisers.runningGet.description":"Etsitään mainostajia, joiden mainonnasta voidaan kieltäytyä…","background.advertisers.runningAct.description":"Kieltäydytään yritysten mainonnasta…"},"fr":{"background.icon.unknown":"{0} - Site inconnu","background.icon.safe":"{0} - Ce site Web est sûr","background.icon.bad":"{0} - Ce site peut être indigne de confiance","background.icon.unsafe":"{0} - Ce site Web n\'est pas sûr","background.icon.nps":"Êtes-vous satisfait des services d\'{0}? Répondez à notre petit sondage","background.advertisers.runningGet.description":"Recherche d\'annonceurs avec possibilité de désinscription…","background.advertisers.runningAct.description":"Désinscription des publicités d\'annonceurs…"},"he":{"background.icon.unknown":"{0} - אתר לא מוכר","background.icon.safe":"{0} - האתר הזה בטוח","background.icon.bad":"{0} - ייתכן שהאתר הזה לא בטוח","background.icon.unsafe":"{0} - האתר הזה לא בטוח","background.icon.nps":"אתה מרוצה מ-{0}? השתתף בסקר מהיר","background.advertisers.runningGet.description":"סריקת המפרסמים שאפשר לבחור לא לקבל מהם פרסומות…","background.advertisers.runningAct.description":"הבחירה לא לקבל פרסומות מחברות מתבצעת…"},"hi":{"background.icon.unknown":"{0} - अज्ञात साइट","background.icon.safe":"{0} - यह वेबसाइट सुरक्षित है","background.icon.bad":"{0} - यह साइट अविश्वसनीय हो सकती है","background.icon.unsafe":"{0} - यह वेबसाइट असुरक्षित है","background.icon.nps":"क्या आप {0} से खुश हैं? जल्दी से एक सर्वेक्षण लें","background.advertisers.runningGet.description":"ऑप्ट-आउट के लिए उपलब्ध विज्ञापनदाताओं को स्कैन कर रहा है...","background.advertisers.runningAct.description":"विज्ञापन कंपनियों से ऑप्ट-आउट प्रगति पर है…"},"hr":{"background.icon.unknown":"{0} – nepoznato web-mjesto","background.icon.safe":"{0} – ovo je web-mjesto sigurno","background.icon.bad":"{0} –ovo web-mjesto možda nije pouzdano","background.icon.unsafe":"{0} – ovo web-mjesto nije sigurno","background.icon.nps":"Jeste li zadovoljni s proizvodom {0}? Ispunite kratku anketu","background.advertisers.runningGet.description":"Pregledavanje oglašivača kod kojih možete odustati…","background.advertisers.runningAct.description":"U tijeku je odustajanje od oglašivačkih tvrtki…"},"hu":{"background.icon.unknown":"{0} – Ismeretlen webhely","background.icon.safe":"{0} – Ez a webhely biztonságos","background.icon.bad":"{0} – Előfordulhat, hogy ez a webhely nem megbízható","background.icon.unsafe":"{0} – Ez a webhely nem biztonságos","background.icon.nps":"Elégedett az {0} termékeivel? Töltsön ki egy rövid kérdőívet","background.advertisers.runningGet.description":"Leállítható hirdetők vizsgálata…","background.advertisers.runningAct.description":"Hirdetővállalatok adatgyűjtésének leállítása folyamatban…"},"id":{"background.icon.unknown":"{0} - Situs tidak diketahui","background.icon.safe":"{0} - Situs web ini aman","background.icon.bad":"{0} - Situs ini mungkin tidak dapat dipercaya","background.icon.unsafe":"{0} - Situs web ini tidak aman","background.icon.nps":"Anda puas dengan {0}? Ikuti survei singkatnya","background.advertisers.runningGet.description":"Memindai pengiklan tersedia yang akan dikecualikan…","background.advertisers.runningAct.description":"Pengecualian perusahaan iklan sedang berlangsung…"},"it":{"background.icon.unknown":"{0} - Sito sconosciuto","background.icon.safe":"{0} - Questo sito è sicuro","background.icon.bad":"{0} - Questo sito potrebbe non essere affidabile","background.icon.unsafe":"{0} - Questo sito non è sicuro","background.icon.nps":"Sei soddisfatto di {0}? Rispondi a un rapido sondaggio","background.advertisers.runningGet.description":"Scansione degli inserzionisti disponibili per la disattivazione in corso…","background.advertisers.runningAct.description":"Disattivazione delle aziende pubblicitarie in corso…"},"ja":{"background.icon.unknown":"{0} - 不明なサイト","background.icon.safe":"{0} - このウェブサイトは安全です","background.icon.bad":"{0} - このサイトは信頼できない可能性があります","background.icon.unsafe":"{0} - このウェブサイトは安全ではありません","background.icon.nps":"{0}にご満足いただいていますか？ 簡単なアンケートにご協力ください","background.advertisers.runningGet.description":"オプトアウト可能な広告主をスキャンしています…","background.advertisers.runningAct.description":"広告会社からのオプトアウトが進行中です…"},"ko":{"background.icon.unknown":"{0} - 알 수 없는 사이트","background.icon.safe":"{0} - 이 웹사이트는 안전함","background.icon.bad":"{0} - 이 사이트는 신뢰할 수 없음","background.icon.unsafe":"{0} - 이 웹사이트는 안전하지 않음","background.icon.nps":"{0}에 만족하십니까? 간단한 설문조사에 참여해주십시오.","background.advertisers.runningGet.description":"옵트아웃할 수 있는 광고업체 검사 중...","background.advertisers.runningAct.description":"광고업체로부터 옵트아웃하는 중..."},"lt":{"background.icon.unknown":"{0} – Nežinoma interneto svetainė","background.icon.safe":"{0} – Ši interneto svetainė yra saugi","background.icon.bad":"{0} – Ši interneto svetainė gali būti nepatikima","background.icon.unsafe":"{0} – Ši interneto svetainė yra nesaugi","background.icon.nps":"Ar esate patenkinti {0}? Atlikite greitą apklausą","background.advertisers.runningGet.description":"Skenuojama, kokių reklamuotojų galima atsisakyti…","background.advertisers.runningAct.description":"Vykdomas reklamavimo įmonių atsisakymas…"},"lv":{"background.icon.unknown":"{0} - nezināma vietne","background.icon.safe":"{0} - šī vietne ir droša","background.icon.bad":"{0} - šī vietne, iespējams, ir neuzticama","background.icon.unsafe":"{0} - šī vietne nav droša","background.icon.nps":"Vai {0} jūs apmierina? Veiciet īsu aptauju","background.advertisers.runningGet.description":"Skenē reklāmdevējus, kas ir pieejami atteikšanās opcijai…","background.advertisers.runningAct.description":"Notiek atteikšanās no reklāmdevēju uzņēmumiem…"},"ms":{"background.icon.unknown":"{0} – Tapak tidak diketahui","background.icon.safe":"{0} – Tapak web ini selamat","background.icon.bad":"{0} – Tapak web ini mungkin tidak boleh dipercayai","background.icon.unsafe":"{0} – Tapak web ini tidak selamat","background.icon.nps":"Adakah anda gembira dengan {0}? Jawab tinjauan pantas","background.advertisers.runningGet.description":"Mengimbas pengiklan yang tersedia bagi memilih untuk tidak menyertai…","background.advertisers.runningAct.description":"Sedang memilih untuk tidak menyertai syarikat pengiklanan…"},"nb":{"background.icon.unknown":"{0} – ukjent nettsted","background.icon.safe":"{0} – dette nettstedet er trygt","background.icon.bad":"{0} – dette nettstedet kan være upålitelig","background.icon.unsafe":"{0} – dette nettstedet er usikkert","background.icon.nps":"Er du fornøyd med {0}? Svar på noen kjappe spørsmål.","background.advertisers.runningGet.description":"Skanner etter annonsører som du kan reservere deg mot … ","background.advertisers.runningAct.description":"Reservasjon mot annonsører behandles …"},"nl":{"background.icon.unknown":"{0} - Onbekende website","background.icon.safe":"{0} - Deze website is veilig","background.icon.bad":"{0} - Deze website is mogelijk onbetrouwbaar","background.icon.unsafe":"{0} - Deze website is niet veilig","background.icon.nps":"Bent u tevreden over {0}? Doe mee aan een korte enquête","background.advertisers.runningGet.description":"Adverteerders scannen bij wie u zich kunt afmelden…","background.advertisers.runningAct.description":"Bezig met afmelden voor reclamebureaus…"},"pl":{"background.icon.unknown":"{0} — Nieznana witryna","background.icon.safe":"{0} — Ta witryna jest bezpieczna","background.icon.bad":"{0} — Ta witryna może być niegodna zaufania","background.icon.unsafe":"{0} — Ta witryna jest niebezpieczna","background.icon.nps":"Czy usługi {0} Ci odpowiadają? Wypełnij krótką ankietę","background.advertisers.runningGet.description":"Trwa skanowanie dostępnych reklamodawców, do których odnosi się rezygnacja…","background.advertisers.runningAct.description":"Trwa rezygnowanie z reklamodawców…"},"pt_BR":{"background.icon.unknown":"{0} - Site desconhecido","background.icon.safe":"{0} - Este site é seguro","background.icon.bad":"{0} - Este site pode não ser confiável","background.icon.unsafe":"{0} - Este site não é seguro","background.icon.nps":"Está satisfeito com o {0}? Responda a uma breve pesquisa","background.advertisers.runningGet.description":"Verificando anunciantes disponíveis a serem desativados…","background.advertisers.runningAct.description":"Desativação de empresas de publicidade em progresso…"},"pt_PT":{"background.icon.unknown":"{0} - Site desconhecido","background.icon.safe":"{0} - Este site é seguro","background.icon.bad":"{0} - Este site pode não ser fidedigno","background.icon.unsafe":"{0} - Este site não é seguro","background.icon.nps":"Está satisfeito com a {0}? Responda a um breve inquérito","background.advertisers.runningGet.description":"A analisar anunciantes disponíveis para recusa…","background.advertisers.runningAct.description":"Recusa de empresas de publicidade em curso…"},"ro":{"background.icon.unknown":"{0} - Site necunoscut","background.icon.safe":"{0} - Acest site Web este sigur","background.icon.bad":"{0} - Acest site nu este demn de încredere","background.icon.unsafe":"{0} - Acest site Web nu este sigur","background.icon.nps":"Sunteți mulțumiți de {0}? Participați la un scurt sondaj","background.advertisers.runningGet.description":"Se scanează agenții de publicitate disponibili, pentru renunțare…","background.advertisers.runningAct.description":"Renunțarea la companiile de publicitate este în curs…"},"ru":{"background.icon.unknown":"{0}: неизвестный сайт","background.icon.safe":"{0}: этот сайт безопасен","background.icon.bad":"{0}: этот сайт может быть ненадежным","background.icon.unsafe":"{0}: этот сайт небезопасен","background.icon.nps":"Вы довольны {0}? Пройдите краткий опрос","background.advertisers.runningGet.description":"Поиск рекламодателей, от услуг которых можно отказаться…","background.advertisers.runningAct.description":"Выполняется отказ от услуг рекламных компаний…"},"sk":{"background.icon.unknown":"{0} – neznáma stránka","background.icon.safe":"{0} – táto stránka je bezpečná","background.icon.bad":"{0} – táto stránka môže byť nedôveryhodná","background.icon.unsafe":"{0} – táto stránka je nebezpečná","background.icon.nps":"Vyhovuje vám {0}? Zúčastnite sa krátkeho prieskumu","background.advertisers.runningGet.description":"Hľadajú sa reklamné firmy na poslanie nesúhlasu…","background.advertisers.runningAct.description":"Odosiela sa nesúhlas reklamným firmám…"},"sl":{"background.icon.unknown":"{0} – neznano spletno mesto","background.icon.safe":"{0} – to spletno mesto je varno","background.icon.bad":"{0} – to spletno mesto morda ni zaupanja vredno","background.icon.unsafe":"{0} – to spletno mesto ni varno","background.icon.nps":"Kako vam je všeč {0}? Izpolnite kratko anketo.","background.advertisers.runningGet.description":"Iskanje oglaševalcev, ki omogočajo zavrnitev uporabe …","background.advertisers.runningAct.description":"Zavrnitev sodelovanja z oglaševalskimi podjetji je v teku …"},"sr":{"background.icon.unknown":"{0} – Nepoznata lokacija","background.icon.safe":"{0} – Ova veb lokacija je bezbedna","background.icon.bad":"{0} – Ova lokacija možda nije pouzdana","background.icon.unsafe":"{0} – Ova veb lokacija nije bezbedna","background.icon.nps":"Da li ste zadovoljni {0} programima? Popunite kratku anketu","background.advertisers.runningGet.description":"Skeniranje oglašivača dostupnih za odjavljivanje…","background.advertisers.runningAct.description":"Odjavljivanje od kompanija za oglašavanje je u toku…"},"sv":{"background.icon.unknown":"{0} – okänd webbplats","background.icon.safe":"{0} – webbplatsen är säker","background.icon.bad":"{0} – webbplatsen kan vara opålitlig","background.icon.unsafe":"{0} – webbplatsen är osäker","background.icon.nps":"Är du nöjd med {0}? Besvara enkäten","background.advertisers.runningGet.description":"Skannar annonsörer som kan väljas bort…","background.advertisers.runningAct.description":"Reklamföretag väljs bort…"},"tr":{"background.icon.unknown":"{0} - Bilinmeyen site","background.icon.safe":"{0} - Bu web sitesi güvenli","background.icon.bad":"{0} - Bu site güvenilir olmayabilir","background.icon.unsafe":"{0} - Bu web sitesi güvenli değil","background.icon.nps":"{0} kullanmaktan memnun musunuz? Kısa bir ankete katılın","background.advertisers.runningGet.description":"Devre dışı bırakılabilecek reklamcılar taranıyor…","background.advertisers.runningAct.description":"Reklam şirketlerini devre dışı bırakma işlemi devam ediyor…"},"uk":{"background.icon.unknown":"{0}: невідомий веб-сайт","background.icon.safe":"{0}: цей веб-сайт безпечний","background.icon.bad":"{0}: цей веб-сайт може бути ненадійним","background.icon.unsafe":"{0}: цей веб-сайт ненадійний","background.icon.nps":"Ви задоволені {0}? Пройдіть коротке опитування","background.advertisers.runningAct.description":"Виконується відмова від оголошень рекламних компаній…"},"ur":{"background.icon.unknown":"{0} - نامعلوم سائٹ","background.icon.safe":"{0} - یہ ویب سائٹ محفوظ ہے۔","background.icon.bad":"{0} - یہ سائٹ غیر معتبر ہو سکتی ہے","background.icon.unsafe":"{0} - یہ ویب سائٹ غیر محفوظ ہے۔","background.icon.nps":"کیا آپ {0} سے خوش ہیں؟ ایک فوری سروے لیں","background.advertisers.runningGet.description":"آپٹ-آؤٹ کے لئے دستیاب مشتہرین کو اسکین کیا جا رہا ہے…","background.advertisers.runningAct.description":"مشتہر کمپنیوں سے آپٹ آؤٹ کرنا جاری ہے…"},"vi":{"background.icon.unknown":"{0} - Trang không xác định","background.icon.safe":"{0} - Trang web này an toàn","background.icon.bad":"{0} - Trang web này có thể không đáng tin","background.icon.unsafe":"{0} - Trang web này không an toàn","background.icon.nps":"Bạn có hài lòng với {0} không? Hãy tham gia khảo sát nhanh","background.advertisers.runningGet.description":"Đang quét các nhà quảng cáo có sẵn để bạn chọn không chia sẻ thông tin…","background.advertisers.runningAct.description":"Đang chọn không chia sẻ thông tin cho nhà quảng cáo…"},"zh_CN":{"background.icon.unknown":"{0} -未知站点","background.icon.safe":"{0} -此网站是安全的","background.icon.bad":"{0} -此网站可能不可信","background.icon.unsafe":"{0} -此网站不安全","background.icon.nps":"您对 {0} 满意吗？完成一项快速调查","background.advertisers.runningGet.description":"正在扫描适用选择退出功能的广告商…","background.advertisers.runningAct.description":"选择退出广告公司正在进行中…"},"zh_TW":{"background.icon.unknown":"{0} - 未知的網站","background.icon.safe":"{0} - 這個網站很安全","background.icon.bad":"{0} - 這個網站可能不值得信賴","background.icon.unsafe":"{0} - 這個網站不安全","background.icon.nps":"您對 {0} 感到滿意嗎？請填寫一份簡短的問卷","background.advertisers.runningGet.description":"正在掃描可選擇退出的廣告商…","background.advertisers.runningAct.description":"正在退出廣告公司…"}}')
},function(e,t){
e.exports={
ar:function(e){
...
var r,s=2147483647,u=/^xn--/,c=/[^\x20-\x7E]/,l=/[\x2E\u3002\uFF0E\uFF61]/g,p={
...
function f(e,t){
var n=e.split("@"),i=""
return n.length>1&&(i=n[0]+"@",e=n[1]),i+g((e=e.replace(l,".")).split("."),t).join(".")
}
function b(e){
...
function v(e,t,n){
var i=0
for(e=n?d(e/700):e>>1,e+=d(e/t);e>455;i+=36){
e=d(e/35)
}
return d(i+36*e/(e+38))
}
function w(e){
var t,n,i,a,o,r,u,c,l,p,m,g=[],f=e.length,b=0,k=128,w=72
for((n=e.lastIndexOf("-"))<0&&(n=0),i=0;i<n;++i){
e.charCodeAt(i)>=128&&h("not-basic"),
g.push(e.charCodeAt(i))
}
for(a=n>0?n+1:0;a<f;){
for(o=b,r=1,u=36;a>=f&&h("invalid-input"),((c=(m=e.charCodeAt(a++))-48<10?m-22:m-65<26?m-65:m-97<26?m-97:36)>=36||c>d((s-b)/r))&&h("overflow"),
b+=c*r,
!(c<(l=u<=w?1:u>=w+26?26:u-w));u+=36){
r>d(s/(p=36-l))&&h("overflow"),r*=p
}
w=v(b-o,t=g.length+1,0==o),d(b/t)>s-k&&h("overflow"),k+=d(b/t),b%=t,g.splice(b++,0,k)
}
return y(g)
}
function j(e){
var t,n,i,a,o,r,u,c,l,p,g,f,y,w,j,A=[]
for(f=(e=b(e)).length,t=128,n=0,o=72,r=0;r<f;++r){
(g=e[r])<128&&A.push(m(g))
}
for(i=a=A.length,a&&A.push("-");i<f;){
for(u=s,r=0;r<f;++r){
(g=e[r])>=t&&g<u&&(u=g)
}
for(u-t>d((s-n)/(y=i+1))&&h("overflow"),n+=(u-t)*y,t=u,r=0;r<f;++r){
if((g=e[r])<t&&++n>s&&h("overflow"),
g==t){
for(c=n,l=36;!(c<(p=l<=o?1:l>=o+26?26:l-o));l+=36){
j=c-p,w=36-p,A.push(m(k(p+j%w,0))),
c=d(j/w)
}
A.push(m(k(c,0))),o=v(n,y,i==a),n=0,++i
}
}
++n,++t
}
...
function p(e,t,n,i){
var a,o,r
if(c(n),void 0===(o=e._events)?(o=e._events=Object.create(null),e._eventsCount=0):(void 0!==o.newListener&&(e.emit("newListener",t,n.listener?n.listener:n),
o=e._events),
r=o[t]),void 0===r){
r=o[t]=n,++e._eventsCount
}else if("function"==typeof r?r=o[t]=i?[n,r]:[r,n]:i?r.unshift(n):r.push(n),
(a=l(e))>0&&r.length>a&&!r.warned){
r.warned=!0
...
return c(t),this.on(e,m(this,e,t)),this
},s.prototype.prependOnceListener=function(e,t){
return c(t),this.prependListener(e,m(this,e,t)),
this
},s.prototype.removeListener=function(e,t){
var n,i,a,o,r
if(c(t),void 0===(i=this._events)){
return this
}
if(void 0===(n=i[e])){
return this
...
!function(a,o){
"use strict"
var r="model",s="name",u="type",c="vendor",l="version",p="mobile",d="tablet",m="smarttv",h={
extend:function(e,t){
var n={}
for(var i in e){
...
device:[[/\((ipad|playbook);[\w\s\),;-]+(rim|apple)/i],[r,c,[u,d]],[/applecoremedia\/[\w\.]+ \((ipad)/],[r,[c,"Apple"],[u,d]],[/(apple\s{0,1}tv)/i],[[r,"Apple TV"],[c,"Apple"],[u,m]],[/(archos)\s(gamepad2?)/i,/(hp).+(touchpad)/i,/(hp).+(tablet)/i,/(kindle)\/([\w\.]+)/i,/\s(nook)[\w\s]+build\/(\w+)/i,/(dell)\s(strea[kpr\s\d]*[\dko])/i],[c,r,[u,d]],[/(kf[A-z]+)(\sbuild\/|\)).+silk\//i],[r,[c,"Amazon"],[u,d]],[/(sd|kf)[0349hijorstuw]+(\sbuild\/|\)).+silk\//i],[[r,g.str,f.device.amazon.model],[c,"Amazon"],[u,p]],[/android.+aft([bms])\sbuild/i],[r,[c,"Amazon"],[u,m]],[/\((ip[honed|\s\w*]+);.+(apple)/i],[r,c,[u,p]],[/\((ip[honed|\s\w*]+);/i],[r,[c,"Apple"],[u,p]],[/(blackberry)[\s-]?(\w+)/i,/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[\s_-]?([\w-]*)/i,/(hp)\s([\w\s]+\w)/i,/(asus)-?(\w+)/i],[c,r,[u,p]],[/\(bb10;\s(\w+)/i],[r,[c,"BlackBerry"],[u,p]],[/android.+(transfo[prime\s]{4,10}\s\w+|eeepc|slider\s\w+|nexus 7|padfone|p00c)/i],[r,[c,"Asus"],[u,d]],[/(sony)\s(tablet\s[ps])\sbuild\//i,/(sony)?(?:sgp.+)\sbuild\//i],[[c,"Sony"],[r,"Xperia Tablet"],[u,d]],[/android.+\s([c-g]\d{4}|so[-l]\w+)(?=\sbuild\/|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[r,[c,"Sony"],[u,p]],[/\s(ouya)\s/i,/(nintendo)\s([wids3u]+)/i],[c,r,[u,"console"]],[/android.+;\s(shield)\sbuild/i],[r,[c,"Nvidia"],[u,"console"]],[/(playstation\s[34portablevi]+)/i],[r,[c,"Sony"],[u,"console"]],[/(sprint\s(\w+))/i],[[c,g.str,f.device.sprint.vendor],[r,g.str,f.device.sprint.model],[u,p]],[/(htc)[;_\s-]{1,2}([\w\s]+(?=\)|\sbuild)|\w+)/i,/(zte)-(\w*)/i,/(alcatel|geeksphone|nexian|panasonic|(?=;\s)sony)[_\s-]?([\w-]*)/i],[c,[r,/_/g," "],[u,p]],[/(nexus\s9)/i],[r,[c,"HTC"],[u,d]],[/d\/huawei([\w\s-]+)[;\)]/i,/android.+\s(nexus\s6p|vog-[at]?l\d\d|ane-[at]?l[x\d]\d|eml-a?l\d\da?|lya-[at]?l\d[\dc]|clt-a?l\d\di?)/i],[r,[c,"Huawei"],[u,p]],[/android.+(bah2?-a?[lw]\d{2})/i],[r,[c,"Huawei"],[u,d]],[/(microsoft);\s(lumia[\s\w]+)/i],[c,r,[u,p]],[/[\s\(;](xbox(?:\sone)?)[\s\);]/i],[r,[c,"Microsoft"],[u,"console"]],[/(kin\.[onetw]{3})/i],[[r,/\./g," "],[c,"Microsoft"],[u,p]],[/\s(milestone|droid(?:[2-4x]|\s(?:bionic|x2|pro|razr))?:?(\s4g)?)[\w\s]+build\//i,/mot[\s-]?(\w*)/i,/(XT\d{3,4}) build\//i,/(nexus\s6)/i],[r,[c,"Motorola"],[u,p]],[/android.+\s(mz60\d|xoom[\s2]{0,2})\sbuild\//i],[r,[c,"Motorola"],[u,d]],[/hbbtv\/\d+\.\d+\.\d+\s+\([\w\s]*;\s*(\w[^;]*);([^;]*)/i],[[c,h.trim],[r,h.trim],[u,m]],[/hbbtv.+maple;(\d+)/i],[[r,/^/,"SmartTV"],[c,"Samsung"],[u,m]],[/\(dtv[\);].+(aquos)/i],[r,[c,"Sharp"],[u,m]],[/android.+((sch-i[89]0\d|shw-m380s|SM-P605|SM-P610|gt-p\d{4}|gt-n\d+|sgh-t8[56]9|nexus 10))/i,/((SM-T\w+))/i],[[c,"Samsung"],r,[u,d]],[/smart-tv.+(samsung)/i],[c,[u,m],r],[/((s[cgp]h-\w+|gt-\w+|galaxy\snexus|sm-\w[\w\d]+))/i,/(sam[sung]*)[\s-]*(\w+-?[\w-]*)/i,/sec-((sgh\w+))/i],[[c,"Samsung"],r,[u,p]],[/sie-(\w*)/i],[r,[c,"Siemens"],[u,p]],[/(maemo|nokia).*(n900|lumia\s\d+)/i,/(nokia)[\s_-]?([\w-]*)/i],[[c,"Nokia"],r,[u,p]],[/android[x\d\.\s;]+\s([ab][1-7]\-?[0178a]\d\d?)/i],[r,[c,"Acer"],[u,d]],[/android.+([vl]k\-?\d{3})\s+build/i],[r,[c,"LG"],[u,d]],[/android\s3\.[\s\w;-]{10}(lg?)-([06cv9]{3,4})/i],[[c,"LG"],r,[u,d]],[/linux;\snetcast.+smarttv/i,/lg\snetcast\.tv-201\d/i],[[c,"LG"],r,[u,m]],[/(nexus\s[45])/i,/lg[e;\s\/-]+(\w*)/i,/android.+lg(\-?[\d\w]+)\s+build/i],[r,[c,"LG"],[u,p]],[/(lenovo)\s?(s(?:5000|6000)(?:[\w-]+)|tab(?:[\s\w]+))/i],[c,r,[u,d]],[/android.+(ideatab[a-z0-9\-\s]+)/i],[r,[c,"Lenovo"],[u,d]],[/(lenovo)[_\s-]?([\w-]+)/i],[c,r,[u,p]],[/linux;.+((jolla));/i],[c,r,[u,p]],[/((pebble))app\/[\d\.]+\s/i],[c,r,[u,"wearable"]],[/android.+;\s(oppo)\s?([\w\s]+)\sbuild/i],[c,r,[u,p]],[/crkey/i],[[r,"Chromecast"],[c,"Google"],[u,m]],[/android.+;\s(glass)\s\d/i],[r,[c,"Google"],[u,"wearable"]],[/android.+;\s(pixel c)[\s)]/i],[r,[c,"Google"],[u,d]],[/android.+;\s(pixel( [2-9]a?)?( xl)?)[\s)]/i],[r,[c,"Google"],[u,p]],[/android.+;\s(\w+)\s+build\/hm\1/i,/android.+(hm[\s\-_]?note?[\s_]?(?:\d\w)?)\sbuild/i,/android.+(redmi[\s\-_]?(?:note|k)?(?:[\s_]?[\w\s]+))(?:\sbuild|\))/i,/android.+(mi[\s\-_]?(?:a\d|one|one[\s_]plus|note lte)?[\s_]?(?:\d?\w?)[\s_]?(?:plus)?)\sbuild/i],[[r,/_/g," "],[c,"Xiaomi"],[u,p]],[/android.+(mi[\s\-_]?(?:pad)(?:[\s_]?[\w\s]+))(?:\sbuild|\))/i],[[r,/_/g," "],[c,"Xiaomi"],[u,d]],[/android.+;\s(m[1-5]\snote)\sbuild/i],[r,[c,"Meizu"],[u,p]],[/(mz)-([\w-]{2,})/i],[[c,"Meizu"],r,[u,p]],[/android.+a000(1)\s+build/i,/android.+oneplus\s(a\d{4})[\s)]/i],[r,[c,"OnePlus"],[u,p]],[/android.+[;\/]\s*(RCT[\d\w]+)\s+build/i],[r,[c,"RCA"],[u,d]],[/android.+[;\/\s](Venue[\d\s]{2,7})\s+build/i],[r,[c,"Dell"],[u,d]],[/android.+[;\/]\s*(Q[T|M][\d\w]+)\s+build/i],[r,[c,"Verizon"],[u,d]],[/android.+[;\/]\s+(Barnes[&\s]+Noble\s+|BN[RT])(V?.*)\s+build/i],[[c,"Barnes & Noble"],r,[u,d]],[/android.+[;\/]\s+(TM\d{3}.*\b)\s+build/i],[r,[c,"NuVision"],[u,d]],[/android.+;\s(k88)\sbuild/i],[r,[c,"ZTE"],[u,d]],[/android.+[;\/]\s*(gen\d{3})\s+build.*49h/i],[r,[c,"Swiss"],[u,p]],[/android.+[;\/]\s*(zur\d{3})\s+build/i],[r,[c,"Swiss"],[u,d]],[/android.+[;\/]\s*((Zeki)?TB.*\b)\s+build/i],[r,[c,"Zeki"],[u,d]],[/(android).+[;\/]\s+([YR]\d{2})\s+build/i,/android.+[;\/]\s+(Dragon[\-\s]+Touch\s+|DT)(\w{5})\sbuild/i],[[c,"Dragon Touch"],r,[u,d]],[/android.+[;\/]\s*(NS-?\w{0,9})\sbuild/i],[r,[c,"Insignia"],[u,d]],[/android.+[;\/]\s*((NX|Next)-?\w{0,9})\s+build/i],[r,[c,"NextBook"],[u,d]],[/android.+[;\/]\s*(Xtreme\_)?(V(1[045]|2[015]|30|40|60|7[05]|90))\s+build/i],[[c,"Voice"],r,[u,p]],[/android.+[;\/]\s*(LVTEL\-)?(V1[12])\s+build/i],[[c,"LvTel"],r,[u,p]],[/android.+;\s(PH-1)\s/i],[r,[c,"Essential"],[u,p]],[/android.+[;\/]\s*(V(100MD|700NA|7011|917G).*\b)\s+build/i],[r,[c,"Envizen"],[u,d]],[/android.+[;\/]\s*(Le[\s\-]+Pan)[\s\-]+(\w{1,9})\s+build/i],[c,r,[u,d]],[/android.+[;\/]\s*(Trio[\s\w\-\.]+)\s+build/i],[r,[c,"MachSpeed"],[u,d]],[/android.+[;\/]\s*(Trinity)[\-\s]*(T\d{3})\s+build/i],[c,r,[u,d]],[/android.+[;\/]\s*TU_(1491)\s+build/i],[r,[c,"Rotor"],[u,d]],[/android.+(Gigaset)[\s\-]+(Q\w{1,9})\s+build/i],[c,r,[u,d]],[/android .+?; ([^;]+?)(?: build|\) applewebkit).+? mobile safari/i],[r,[u,p]],[/android .+?;\s([^;]+?)(?: build|\) applewebkit).+?(?! mobile) safari/i],[r,[u,d]],[/\s(tablet|tab)[;\/]/i,/\s(mobile)(?:[;\/]|\ssafari)/i],[[u,h.lowerize],c,r],[/[\s\/\(](smart-?tv)[;\)]/i],[[u,m]],[/(android[\w\.\s\-]{0,9});.+build/i],[r,[c,"Generic"]]],
...
this.tn.omit(":")?c(e.options,n+"."+i,this._readValue(!0)):this._parseOptionValue(e,n+"."+i)
}
}
...
},p=l.prototype=Object.create(o.prototype)
function d(e,n){
...
s[n.keyElem.valueToString(l.value[0])]=c(l.value[1],i,a,n.valueElem.resolvedType)
}
return s
}
var p=n.$type,d=void 0
for(var m in n){
n.hasOwnProperty(m)&&(p&&(d=p.getChild(m))?s[m]=c(n[m],i,a,d.resolvedType):s[m]=c(n[m],i,a))
}
return s
}
...
if((a=this.children[o])instanceof f||a instanceof l||a instanceof k){
...
"number"!=typeof n&&(n=-1)
for(var a,o,r,s,u=e.offset,c=new this.clazz;e.offset<u+n||-1===n&&e.remaining()>0;){
...
if(null===c[(s=this._fields[h]).name]){
if("proto3"===this.syntax){
...
var m=function(e,n,a,o,r,s,u,c,p,d){
...
this.keyElement=null,!this.builder.options.convertFieldsToCamelCase||this instanceof l.ExtensionField||(this.name=t.Util.toCamelCase(this.name))
},h=m.prototype=Object.create(i.prototype)
h.build=function(){
...
if(u>1){
var c=i.slice(r,i.offset)
r+=u-1,i.offset=r,i.append(c)
}
...
var c=n.clone()
for(c.limit=c.offset+o,n.offset+=o;c.remaining()>0;){
var l=c.readVarint32()
e=7&l
var p=l>>>3
if(1===p){
u=this.keyElement.decode(c,e,p)
}else{
if(2!==p){
throw Error("Unexpected tag in map field key/value submessage")
}
a=this.element.decode(c,e,p)
}
}
return[u,a]
}
...
m.call(this,e,t,n,null,i,a,o,r),this.extension
}
g.prototype=Object.create(m.prototype),n.Message.ExtensionField=g,n.Message.OneOf=function(e,t,n){
i.call(this,e,t,n),
this.fields=[]
}
...
if(l=e.Util.IS_NODE?n(6).join(s,l):s+a+l,!0===this.files[l]){
continue
}
/\.proto$/i.test(l)&&!e.DotProto&&(l=l.replace(/\.proto$/,".json"))
var p=e.Util.fetch(l)
if(null===p){
throw Error("failed to import '"+l+"' in '"+i+"': file not found")
}
/\.json$/i.test(l)?this.import(JSON.parse(p+""),l):this.import(e.DotProto.Parser.parse(p),l)
}else{
i?/\.(\w+)$/.test(i)?this.import(t.imports[c],i.replace(/^(.+)\.(\w+)$/,(function(e,t,n){
return t+"_import"+c+"."+n
}))):this.import(t.imports[c],i+"_import"+c):this.import(t.imports[c])
}
}
...
var o,r,s=8*a-i-1,u=(1<<s)-1,c=u>>1,l=-7,p=n?a-1:0,d=n?-1:1,m=e[t+p]
for(p+=d,o=m&(1<<-l)-1,m>>=-l,l+=s;l>0;o=256*o+e[t+p],p+=d,l-=8){}
for(r=o&(1<<-l)-1,
o>>=-l,l+=i;l>0;r=256*r+e[t+p],p+=d,l-=8){}
if(0===o){
o=1-c
}else{
if(o===u){
...
return(m?-1:1)*r*Math.pow(2,o-i)
}
function u(e,t,n,i,a,o){
var r,s,u,c=8*o-a-1,l=(1<<c)-1,p=l>>1,d=23===a?Math.pow(2,-24)-Math.pow(2,-77):0,m=i?0:o-1,h=i?1:-1,g=t<0||0===t&&1/t<0?1:0
for(t=Math.abs(t),isNaN(t)||t===1/0?(s=isNaN(t)?1:0,r=l):(r=Math.floor(Math.log(t)/Math.LN2),
t*(u=Math.pow(2,-r))<1&&(r--,
u*=2),(t+=r+p>=1?d/u:d*Math.pow(2,1-p))*u>=2&&(r++,
u/=2),r+p>=l?(s=0,r=l):r+p>=1?(s=(t*u-1)*Math.pow(2,a),
r+=p):(s=t*Math.pow(2,p-1)*Math.pow(2,a),
r=0));a>=8;e[n+m]=255&s,m+=h,s/=256,a-=8){}
for(r=r<<a|s,c+=a;c>0;e[n+m]=255&r,m+=h,
r/=256,c-=8){}
e[n+m-h]|=128*g
}
t.accessor=function(){
...
switch(i>c&&this.resize((c*=2)>i?c:i),i-=o,o){
case 10:
this.view[i+9]=u>>>7&1
case 9:
...
a=l.calculateUTF16asUTF8(o(e))[1],t+=a+1
var r=this.buffer.byteLength
return t>r&&this.resize((r*=2)>t?r:t),t-=a+1,l.encodeUTF16toUTF8(o(e),function(e){
this.view[t++]=e
...
var i,a=t
i=l.calculateUTF16asUTF8(o(e),this.noAssert)[1],t+=4+i
var r=this.buffer.byteLength
...
this.view[t+2]=i>>>8&255,this.view[t+3]=255&i),t+=4,l.encodeUTF16toUTF8(o(e),function(e){
this.view[t++]=e
}.bind(this)),t!==a+4+i){
...
var r=this.buffer.byteLength
return t>r&&this.resize((r*=2)>t?r:t),t-=n,l.encodeUTF16toUTF8(o(e),function(e){
this.view[t++]=e
...
}.bind(this),o=r(),this.noAssert),i!==c){
throw RangeError("Illegal range: Truncated data, "+i+" == "+c)
}
return a?(this.offset=i,o()):{
string:o(),
length:i-u
...
var a,r,s=n
a=l.calculateUTF16asUTF8(o(e),this.noAssert)[1],r=t.calculateVarint32(a),n+=r+a
var u=this.buffer.byteLength
if(n>u&&this.resize((u*=2)>n?u:n),n-=r+a,n+=this.writeVarint32(a,n),l.encodeUTF16toUTF8(o(e),function(e){
this.view[n++]=e
}.bind(this)),n!==s+a+r){
...
for(var a,o,r=e.length,s=new t((r+1)/3|0,n,i),u=0,c=0,l=!1,p=!1,d=!1,m=!1,h=!1;u<r;){
switch(a=e.charAt(u++)){
case"!":
if(!i){
if(p||d||m){
...
s.offset=s.markedOffset=s.limit=c,l=!1
break
case"|":
if(!i){
if(p||m){
...
var a=new t(l.calculateUTF16asUTF8(o(e),!0)[1],n,i),r=0
...
return e<0?o(-e,t).neg():r(e%l|0,e/l|0,t)
}
function r(t,n,i){
return new e(t,n,i)
}
...
for(var a=o(s(n,8)),r=h,c=0;c<e.length;c+=8){
var l=Math.min(8,e.length-c),p=parseInt(e.substring(c,c+l),n)
if(l<8){
var d=o(s(n,l))
r=r.mul(d).add(o(p))
}else{
...
var l=4294967296,p=l*l,d=p/2,m=a(1<<24),h=a(0)
e.ZERO=h
var g=a(0,!0)
e.UZERO=g
var f=a(1)
...
var c=r.div(a),l=(r.sub(c.mul(a)).toInt()>>>0).toString(e)
if((r=c).isZero()){
return l+u
}
for(;l.length<6;){
...
t(e)||(e=c(e))
var n=this.high>>>16,i=65535&this.high,a=this.low>>>16,o=65535&this.low,s=e.high>>>16,u=65535&e.high,l=e.low>>>16,p=0,d=0,m=0,h=0
return m+=(h+=o+(65535&e.low))>>>16,d+=(m+=a+l)>>>16,p+=(d+=i+u)>>>16,p+=n+s,r((m&=65535)<<16|(h&=65535),(p&=65535)<<16|(d&=65535),this.unsigned)
},
...
var n=this.high>>>16,i=65535&this.high,a=this.low>>>16,s=65535&this.low,u=e.high>>>16,l=65535&e.high,p=e.low>>>16,d=65535&e.low,g=0,f=0,b=0,y=0
return b+=(y+=s*d)>>>16,f+=(b+=a*d)>>>16,b&=65535,f+=(b+=s*p)>>>16,g+=(f+=i*d)>>>16,
f&=65535,
g+=(f+=a*p)>>>16,f&=65535,g+=(f+=s*l)>>>16,g+=n*d+i*p+a*l+s*u,r((b&=65535)<<16|(y&=65535),(g&=65535)<<16|(f&=65535),this.unsigned)
},
...
for(var r=Math.ceil(Math.log(n)/Math.LN2),u=r<=48?1:s(2,r-48),l=o(n),p=l.mul(e);p.isNegative()||p.gt(i);){
p=(l=o(n-=u,this.unsigned)).mul(e)
}
l.isZero()&&(l=f),a=a.add(l),i=i.sub(p)
}
return a
...
switch(u){
case 0:
r[s++]=a[c>>2],i=(3&c)<<4,u=1
break
case 1:
r[s++]=a[i|c>>4],i=(15&c)<<2,u=2
break
case 2:
r[s++]=a[i|c>>6],r[s++]=a[63&c],u=0
}
...
var o=e(i,a+t),r=e(i,a+n),s=2*(r>>31)+1,u=r>>>20&2047,c=4294967296*(1048575&r)+o
...
var m=function(e){
return null==e?void 0===e?"[object Undefined]":"[object Null]":d&&d in Object(e)?c(e):p(e)
}
var h=function(e){
var t=typeof e
...
return""
},j=/^\[object .+?Constructor\]$/,A=Function.prototype,S=Object.prototype,E=A.toString,O=S.hasOwnProperty,_=RegExp("^"+E.call(O).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$")
var T=function(e){
...
for(var i=arguments,a=-1,o=W(i.length-t,0),r=Array(o);++a<o;){
r[a]=i[t+a]
}
a=-1
...
var ne=function(e){
return te(e)&&"[object Arguments]"==m(e)
...
var le=function(e){
return te(e)&&H(e.length)&&!!ce[m(e)]
}
var pe=function(e){
return function(t){
return e(t)
}
},de=n(2),me=de.a&&de.a.isTypedArray,he=me?pe(me):le,ge=Object.prototype.hasOwnProperty
var fe=function(e,t){
var n=se(e),i=!n&&re(e),a=!n&&!i&&Object(ue.a)(e),o=!n&&!i&&!a&&he(e),r=n||i||a||o,s=r?ee(e.length,String):[],u=s.length
for(var c in e){
!t&&!ge.call(e,c)||r&&("length"==c||a&&("offset"==c||"parent"==c)||o&&("buffer"==c||"byteLength"==c||"byteOffset"==c)||J(c,u))||s.push(c)
}
return s
}
var be=function(e,t){
...
},je=Object.prototype.hasOwnProperty,Ae=X((function(e,t){
if(Q(t)||Y(t)){
z(t,we(t),e)
}else{
for(var n in t){
...
ttl_phishing:3600,
rating_level:0
},n.webrep?(this.values=Ae({},this.defaults,{
ajax:n.ajax
...
n.webrep.hasOwnProperty("rating_level")&&n.webrep.rating_level&&(this.values.rating_level=n.webrep.rating_level)):this.values=Ae({},this.defaults,n),
...
var u=r?"getUTC":"get",c=a[u+"Date"](),l=a[u+"Day"](),p=a[u+"Month"](),d=a[u+"FullYear"](),m=a[u+"Hours"](),h=a[u+"Minutes"](),g=a[u+"Seconds"](),f=a[u+"Milliseconds"](),b=r?0:a.getTimezoneOffset(),y={
d:c,
dd:i(c),
ddd:s.i18n.dayNames[l],
dddd:s.i18n.dayNames[l+7],
m:p+1,
mm:i(p+1),
...
var t=Q(e),n=[]
for(var i in e){
("constructor"!=i||!t&&We.call(e,i))&&n.push(i)
}
return n
}
var Ve=function(e){
return Y(e)?fe(e,!0):Ue(e)
}
var Me=function(e,t){
...
ht.prototype.clear=st,ht.prototype.delete=ut,ht.prototype.get=lt,ht.prototype.has=dt,
ht.prototype.set=mt
var gt=ht
var ft=function(){
...
At.prototype.clear=ft,At.prototype.delete=kt,At.prototype.get=vt,At.prototype.has=wt,
At.prototype.set=jt
var St=At
var Et=function(e,t){
var n=this.__data__
...
var l=-1,p=!0,d=2&n?new Ct:void 0
for(o.set(e,t),o.set(t,e);++l<s;){
var m=e[l],h=t[l]
if(i){
var g=r?i(h,m,l,t,e,o):i(m,h,l,e,t,o)
}
if(void 0!==g){
if(g){
continue
...
},Bt=a?a.prototype:void 0,Wt=Bt?Bt.valueOf:void 0
var Ut=function(e,t,n,i,a,o,r){
switch(n){
...
var h=e[l=s[c]],g=t[l]
if(i){
var f=r?i(g,h,l,t,e,o):i(h,g,l,e,t,o)
}
...
},Xt=R(i.a,"DataView"),$t=R(i.a,"Promise"),Qt=R(i.a,"Set"),en=R(i.a,"WeakMap"),tn=w(Xt),nn=w(ot),an=w($t),on=w(Qt),rn=w(en),sn=m
...
var t=m(e),n="[object Object]"==t?e.constructor:void 0,i=n?w(n):""
if(i){
switch(i){
case tn:
...
var un=sn,cn=Object.prototype.hasOwnProperty
var ln=function(e,t,n,i,a,o){
var r=se(e),s=se(t),u=r?"[object Array]":un(e),c=s?"[object Array]":un(t),l="[object Object]"==(u="[object Arguments]"==u?"[object Object]":u),p="[object Object]"==(c="[object Arguments]"==c?"[object Object]":c),d=u==c
if(d&&Object(ue.a)(e)){
if(!Object(ue.a)(t)){
return!1
}
...
if(d&&!l){
return o||(o=new _t),r||he(e)?Pt(e,t,n,i,a,o):Ut(e,t,u,n,i,a,o)
}
if(!(1&n)){
var m=l&&cn.call(e,"__wrapped__"),h=p&&cn.call(t,"__wrapped__")
if(m||h){
var g=m?e.value():e,f=h?t.value():t
return o||(o=new _t),a(g,f,n,i,o)
}
}
return!!d&&(o||(o=new _t),Zt(e,t,n,i,a,o))
}
var pn=function e(t,n,i,a,o){
return t===n||(null==t||null==n||!te(t)&&!te(n)?t!=t&&n!=n:ln(t,n,i,a,e,o))
}
...
var bn=function(e){
return"symbol"==typeof e||te(e)&&"[object Symbol]"==m(e)
},yn=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,kn=/^\w*$/
var vn=function(e,t){
if(se(e)){
return!1
...
return n.cache=new(wn.Cache||St),n
}
wn.Cache=St
var jn=wn
var An=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,Sn=/\\(\\)?/g,En=function(e){
...
var t=[]
return 46===e.charCodeAt(0)&&t.push(""),e.replace(An,(function(e,n,i,a){
t.push(i?a.replace(Sn,"$1"):n||e)
})),t
}))
var On=function(e,t){
...
var Cn=function(e,t){
return se(e)?e:vn(e,t)?[e]:En(Rn(e))
}
var xn=function(e){
...
var Bn=function(e,t){
return vn(e)&&mn(t)?gn(xn(e),t):function(n){
var i=Pn(n,e)
...
let d=n[r].length,m=0,h=0,g=this.trackersByCategory[r]
for(let e in g){
let t=g[e]
h+=1,a.trackers[t]&&(m+=1)
}
s.push({
type:r,
...
allAllowed:!a.categories[r]&&0===m&&h>0,
allBlocked:(a.categories[r]||m===h)&&h>0,
someBlocked:!a.categories[r]&&m>0&&m<h
}),c.actives+=l,c.total+=d
}
return{
tabId:e,
host:t,
...
var pi=function(e,t){
return z(e,Yt(e),t)
},di=be(Object.getPrototypeOf,Object),mi=Object.getOwnPropertySymbols?function(e){
for(var t=[];e;){
Vt(t,Yt(e)),e=di(e)
}
return t
...
},ji=a?a.prototype:void 0,Ai=ji?ji.valueOf:void 0
var Si=function(e){
...
var Ii=function(e){
return"function"!=typeof e.constructor||Q(e)?{}:Ti(di(e))
}
var Ri=function(e){
return te(e)&&"[object Map]"==un(e)
},Ci=de.a&&de.a.isMap,xi=Ci?pe(Ci):Ri
var Ni=function(e){
return te(e)&&"[object Set]"==un(e)
},Pi=de.a&&de.a.isSet,Li=Pi?pe(Pi):Ni,zi={}
...
var d=un(t),m="[object Function]"==d||"[object GeneratorFunction]"==d
if(Object(ue.a)(t)){
return Object(ci.a)(t,u)
}
if("[object Object]"==d||"[object Arguments]"==d||m&&!o){
if(s=c||m?{}:Ii(t),!u){
return c?hi(t,ui(s,t)):pi(t,si(s,t))
}
}else{
if(!zi[d]){
return o?t:{}
...
var f=l?c?gi:Kt:c?keysIn:we,b=p?void 0:f(t)
...
init(){
this.headers=Wi({},this.AvastWRC.Query.CONST.HEADERS,this.headers),this.message(),
...
timeout:0,
go:!0
},t),this.AvastWRC.Query.CONST.LOCAL_TOKEN&&(this.headers=Wi({
...
this.tabId=t.tabId,this.windowId=t.windowId,this.url=t.url,
this.host=e.bal.getHostFromUrl(t.url),
this.data={}
}
init(){
...
prepareDataAdvertisers(){
const e=this.AvastWRC.Advertisers.runs.length<1,t=e?null:this.AvastWRC.Advertisers.runs[this.AvastWRC.Advertisers.runs.length-1],n={
state:e?"ONBOARDING":t.state,
brokers:t?t.brokers:[],
settings:{
autoOptOut:this.AvastWRC.Advertisers.settings.autoOptOut
}
}
this.data.advertisers=n
}
tabSendMessage(e){
...
break
case"advertisersStartScan":
n=this.advertisersStartScan()
break
case"advertisersStartOptOut":
n=this.advertisersStartOptOut()
break
case"advertisersTryAgain":
n=this.advertisersTryAgain()
break
case"advertisersSelectOneForOptOut":
n=this.advertisersSelectOneForOptOut({
title:t.title,
value:t.value
})
break
case"advertisersSelectAllForOptOut":
n=this.advertisersSelectAllForOptOut()
break
case"advertisersSettingsAutoScanChanged":
n=this.advertisersSettingsAutoScanChanged(t.value)
break
case"advertisersOpenLearnMore":
n=this.advertisersOpenLearnMore()
break
case"openFeedback":
...
return this.AvastWRC.bal.advertisersStartScan(),!0
}
advertisersStartOptOut(){
return this.AvastWRC.bal.advertisersStartOptOut(),!0
}
advertisersTryAgain(){
return this.AvastWRC.bal.advertisersTryAgain(),!0
}
advertisersSelectOneForOptOut({title:e,value:t}){
return this.AvastWRC.bal.advertisersSelectOneForOptOut({
title:e,
value:t
}),!0
}
advertisersSelectAllForOptOut(){
return this.AvastWRC.bal.advertisersSelectAllForOptOut(),
!0
}
advertisersSettingsAutoScanChanged(e){
return this.AvastWRC.bal.advertisersSettingsAutoScanChanged(e),
!0
}
advertisersOpenLearnMore(){
return this.AvastWRC.bal.advertisersOpenLearnMore(),!0
}
takeSurveyNow(){
...
var ea=n(17)
var ta=n(18),na=n.n(ta),ia=n(19),aa=n.n(ia),oa=n(20),ra=n.n(oa)
const sa=n(7)
class ua{
constructor(e,t,n,i){
this.state=i,this.title=e,this.url=t,this.description=n,this.isSelectedForOptOut=!0
}
static fromSavedBroker({title:e,url:t,description:n,state:i,isSelectedForOptOut:a}){
const o=new ua(e,t,n,i)
return o.selectForOptOut(a),o
}
updateState(e){
this.state=e
}
selectForOptOut(e){
this.isSelectedForOptOut=e
}
}
const ca={
autoOptOut:!0,
autoOptOutInterval:864e5,
autoOptOutCheckInterval:6e5
},la="INITIALIZED",pa="RUNNING_GET",da="FINISHED_GET",ma="RUNNING_OPT_OUT",ha="FINISHED_OPT_OUT",ga="FAILED",fa="READY_FOR_OPT_OUT",ba="OPTED_OUT",ya="OPTED_OUT_ALREADY",ka=e=>e.state===fa,va=e=>{
e.setStorage("aos.advertisers.lastAutoOptOutDate",Date.now())
},wa=async(e,t)=>{
const n=await(e=>new Promise(t=>e.getStorage(["aos.advertisers.lastAutoOptOutDate"],t)))(e)
return Date.now()-n>=t
}
class ja{
constructor(e,t={
maxBufferTabs:5,
closeAfterLastTabTimer:3e3,
windowTimeout:13e4
}){
this.AvastWRC=e,this.Api=e.Api,this._settings=t,this._currentWindow=void 0,this._windowTimeout=void 0,
this._tabsBuffer=[],
this._onFocusChangedBinded=this._onFocusChanged.bind(this)
}
get _currentTab(){
if(!this._tabsBuffer.length){
return
}
const e=this._tabsBuffer.length-1
return this._tabsBuffer[e]
}
registerListeners({onTimeout:e,onError:t}){
this.onTimeout=e,this.onError=()=>{
this.dispose(),t()
}
}
async create(e,t){
return this._currentWindow||(this._currentWindow=await this._createWindowAsync(),
this.Api.windows.onFocusChanged.addListener(this._onFocusChangedBinded)),
this._createTab(e,t)
}
dispose(){
this._currentWindow&&(this.Api.windows.onFocusChanged.removeListener(this._onFocusChangedBinded),
clearTimeout(this._windowTimeout),
this._closeWindow(this._currentWindow.id),this._currentWindow=void 0,
this._windowTimeout=void 0,
this._tabsBuffer=[])
}
async _createTab(e,t){
const n=await this._createTabAsync({
url:e,
windowId:this._currentWindow.id
})
if(!n){
return this.onError()
}
this._currentTab&&await this._closeTab(),this._setScraperTimeout(n.id,n.windowId),
this._tabsBuffer.push(n),
this._injectScript(t)
}
async _closeTab(){
if(this._tabsBuffer.length<this._settings.maxBufferTabs){
return
}
const e=this._tabsBuffer.shift()
await this._getTabAsync(e.id)&&this.Api.tabs.remove(e.id)
}
_closeWindow(e){
setTimeout(async()=>{
const t=(await this._getTabsInWindow(e)).map(e=>this._removeTabAsync(e.id))
await Promise.all(t),await this._getWindowAsync(e)&&this.Api.windows.remove(e)
},this._settings.closeAfterLastTabTimer)
}
_injectScript(e){
var t
e&&e.getIsOptedOutFunc&&this.Api.tabs.executeScript(this._currentTab.id,{
code:(t=e.getIsOptedOutFunc,
`\n  window.isOptedOutFunc = ${t};\n  undefined; // Because Firefox\n  `),
runAt:"document_start"
}),this.Api.tabs.executeScript(this._currentTab.id,{
file:"/scripts/contentAdvertisersScraper.js",
runAt:"document_end"
})
}
async _getTabAsync(e){
return new Promise(t=>this.Api.tabs.get(e,t))
}
async _getTabsInWindow(e){
return new Promise(t=>this.Api.tabs.query({
windowId:e
},t))
}
async _getWindowAsync(e,t){
return new Promise(n=>this.Api.windows.get(e,t,n))
}
async _createTabAsync(e){
return new Promise(t=>this.Api.tabs.create(e,t))
}
async _createWindowAsync(e){
return new Promise(t=>this.AvastWRC.bs.openHiddenWindow(e,t))
}
async _removeTabAsync(e){
return new Promise(t=>this.Api.tabs.remove(e,t))
}
_setScraperTimeout(e,t){
clearTimeout(this._windowTimeout),this._windowTimeout=setTimeout(async()=>{
if(!await this._getWindowAsync(t)){
return this.onError()
}
this._currentTab.id===e&&this.onTimeout()
},this._settings.windowTimeout)
}
_onFocusChanged(e){
if(!this._currentWindow||e!==this._currentWindow.id){
return
}
const t=Math.floor(window.screen.width/2-250),n=Math.floor(window.screen.height/2-200)
this.Api.windows.update(e,{
height:400,
width:500,
left:t,
top:n
...
class Aa{
constructor(e,t){
this.AvastWRC=e,this.Api=e.Api,this.window=new ja(e),this.window.registerListeners({
onTimeout:()=>this.finishScenario(!0),
onError:this.onWindowError.bind(this)
}),this.state=la,this.advertiserScenarios=t,
this.queue=[],this.brokers=[],this.currentAdvertiser=void 0
}
static fromSavedRun(e,t,n){
const i=new Aa(e,t)
return i.brokers=n.brokers.map(e=>ua.fromSavedBroker(e)),i.state=n.state,i
}
runGet(){
this.queue=[...this.advertiserScenarios],this.nextGetScenario(),this.state=pa,
this.emitNewState()
}
nextGetScenario(){
this.currentAdvertiser=this.queue.shift()
const{getScenario:e,getIsOptedOutFunc:t}=this.currentAdvertiser
this.window.create(e.metadata.start_url+"?breachGuardStartScraping=true",{
getIsOptedOutFunc:t
})
}
finishGet(){
if(this.queue.length>0){
return this.nextGetScenario()
}
if(this.window.dispose(),0===this.brokers.length){
return this.finishError()
}
const e=this.brokers.filter(ka)
this.state=e.length?da:ha,this.emitNewState()
}
runOptOut(){
this.queue=this.getReadyForOptOutAdvertisers(),this.nextOptOutScenario(),
this.state=ma,
this.emitNewState()
}
nextOptOutScenario(){
this.currentAdvertiser=this.queue.shift()
const{optOutScenario:e}=this.currentAdvertiser
this.window.create(e.metadata.start_url+"?breachGuardStartScraping=true")
}
finishOptOut(e){
if(e||this.updateBroker(this.currentAdvertiser,ba),this.queue.length>0){
return this.nextOptOutScenario()
}
var t,n
va(this.AvastWRC),this.window.dispose(),this.state=ha,t=this.AvastWRC,n={
...this,
advertiserScenarios:void 0,
AvastWRC:void 0,
Api:void 0
},t.setStorage("aos.advertisers.run",n),this.emitNewState()
}
stopScan(){
this.window.dispose()
}
finishError(){
this.state=ga,this.emitNewState()
}
finishScenario(e){
this.state===pa?this.finishGet():this.finishOptOut(e)
}
startAutoOptOut(e){
if(this.brokers=((e=[],t)=>t.map(t=>{
const n=e.find(e=>e.title===t.name)
return n||new ua(t.name,t.getScenario.metadata.start_url,t.description,fa)
}))(e,this.advertiserScenarios),
this.getReadyForOptOutAdvertisers().length>0){
return this.runOptOut()
}
this.state=ha,this.emitNewState()
}
parseScrape(e){
return this.addBroker(this.currentAdvertiser,(e=>e?ya:fa)(e))
}
getReadyForOptOutAdvertisers(){
return[...this.advertiserScenarios].filter((e=this.brokers,
t=>e.some(e=>e.title===t.name&&ka(e)&&e.isSelectedForOptOut)))
var e
}
selectOneForOptOut({title:e,value:t}){
const n=this.brokers.find(t=>t.title===e)
n&&n.selectForOptOut(t)
}
selectAllForOptOut(){
this.brokers.filter(e=>e.state===fa).forEach(e=>e.selectForOptOut(!0))
}
addBroker(e,t){
this.brokers.push(new ua(e.name,e.getScenario.metadata.start_url,e.description,t))
}
updateBroker(e,t){
const n=this.brokers.find(t=>t.title===e.name)
n&&n.updateState(t)
}
onWindowError(e){
this.finishError()
...
emitNewState(){
this.AvastWRC.panelbl.activeSidebarTabId&&this.Api.tabs.get(this.AvastWRC.panelbl.activeSidebarTabId,e=>{
e&&this.AvastWRC.bs.messageTab(e,{
message:"updatePanel",
data:{
data:{
uiAction:{
...
settings:{
...this.AvastWRC.Advertisers.settings
}
}
}
}
...
var Sa=n(0)
const Ea=Sa.Reader,Oa=Sa.Writer,_a=Sa.util,Ta=Sa.roots.default||(Sa.roots.default={}),Ia=(Ta.com=(()=>{
const e={}
...
return e.prototype.domain=_a.emptyArray,e.prototype.callerId=_a.Long?_a.Long.fromBits(0,0,!1):0,
e.prototype.apikey=_a.newBuffer([]),
e.prototype.identity=null,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.domain&&e.domain.length){
...
null!=e.identity&&e.hasOwnProperty("identity")&&Ta.com.avast.cloud.webrep.proto.AvastIdentity.encode(e.identity,t.uint32(34).fork()).ldelim(),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.DomainInfoRequest
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
break
case 4:
i.identity=Ta.com.avast.cloud.webrep.proto.AvastIdentity.decode(e,e.uint32())
break
default:
e.skipType(7&t)
}
...
return e instanceof Ea||(e=new Ea(e)),this.decode(e,e.uint32())
},e.verify=function(e){
if("object"!=typeof e||null===e){
...
if(!_a.isString(e.domain[t])){
return"domain: string[] expected"
}
}
}
if(null!=e.callerId&&e.hasOwnProperty("callerId")&&!(_a.isInteger(e.callerId)||e.callerId&&_a.isInteger(e.callerId.low)&&_a.isInteger(e.callerId.high))){
return"callerId: integer|Long expected"
}
if(null!=e.apikey&&e.hasOwnProperty("apikey")&&!(e.apikey&&"number"==typeof e.apikey.length||_a.isString(e.apikey))){
return"apikey: buffer expected"
}
if(null!=e.identity&&e.hasOwnProperty("identity")){
let t=Ta.com.avast.cloud.webrep.proto.AvastIdentity.verify(e.identity)
if(t){
return"identity."+t
}
}
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.DomainInfoRequest){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.DomainInfoRequest
if(e.domain){
if(!Array.isArray(e.domain)){
...
if(null!=e.callerId&&(_a.Long?(t.callerId=_a.Long.fromValue(e.callerId)).unsigned=!1:"string"==typeof e.callerId?t.callerId=parseInt(e.callerId,10):"number"==typeof e.callerId?t.callerId=e.callerId:"object"==typeof e.callerId&&(t.callerId=new _a.LongBits(e.callerId.low>>>0,e.callerId.high>>>0).toNumber())),
null!=e.apikey&&("string"==typeof e.apikey?_a.base64.decode(e.apikey,t.apikey=_a.newBuffer(_a.base64.length(e.apikey)),0):e.apikey.length&&(t.apikey=e.apikey)),
null!=e.identity){
if("object"!=typeof e.identity){
throw TypeError(".com.avast.cloud.webrep.proto.DomainInfoRequest.identity: object expected")
}
t.identity=Ta.com.avast.cloud.webrep.proto.AvastIdentity.fromObject(e.identity)
}
return t
...
if(_a.Long){
let e=new _a.Long(0,0,!1)
n.callerId=t.longs===String?e.toString():t.longs===Number?e.toNumber():e
}else{
n.callerId=t.longs===String?"0":0
}
t.bytes===String?n.apikey="":(n.apikey=[],t.bytes!==Array&&(n.apikey=_a.newBuffer(n.apikey))),
n.identity=null
}
...
return null!=e.callerId&&e.hasOwnProperty("callerId")&&("number"==typeof e.callerId?n.callerId=t.longs===String?String(e.callerId):e.callerId:n.callerId=t.longs===String?_a.Long.prototype.toString.call(e.callerId):t.longs===Number?new _a.LongBits(e.callerId.low>>>0,e.callerId.high>>>0).toNumber():e.callerId),
null!=e.apikey&&e.hasOwnProperty("apikey")&&(n.apikey=t.bytes===String?_a.base64.encode(e.apikey,0,e.apikey.length):t.bytes===Array?Array.prototype.slice.call(e.apikey):e.apikey),
null!=e.identity&&e.hasOwnProperty("identity")&&(n.identity=Ta.com.avast.cloud.webrep.proto.AvastIdentity.toObject(e.identity,t)),
n
...
return e.prototype.domainInfo=_a.emptyArray,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.domainInfo&&e.domainInfo.length){
for(let n=0;n<e.domainInfo.length;++n){
Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo.encode(e.domainInfo[n],t.uint32(10).fork()).ldelim()
}
}
return t
},e.encodeDelimited=function(e,t){
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.DomainInfoResponse
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.domainInfo&&i.domainInfo.length||(i.domainInfo=[]),i.domainInfo.push(Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo.decode(e,e.uint32()))
break
default:
e.skipType(7&t)
}
...
let n=Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo.verify(e.domainInfo[t])
if(n){
return"domainInfo."+n
}
}
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.DomainInfoResponse){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.DomainInfoResponse
if(e.domainInfo){
if(!Array.isArray(e.domainInfo)){
...
t.domainInfo[n]=Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo.fromObject(e.domainInfo[n])
}
}
return t
},e.toObject=function(e,t){
...
n.domainInfo[i]=Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo.toObject(e.domainInfo[i],t)
}
}
return n
},e.prototype.toJSON=function(){
...
return t||(t=Oa.create()),null!=e.domain&&e.hasOwnProperty("domain")&&t.uint32(10).string(e.domain),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.domain&&e.hasOwnProperty("domain")&&!_a.isString(e.domain)?"domain: string expected":null!=e.clean&&e.hasOwnProperty("clean")&&"boolean"!=typeof e.clean?"clean: boolean expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.DomainInfoResponse.DomainInfo
...
return e.prototype.uri=_a.emptyArray,e.prototype.callerId=_a.Long?_a.Long.fromBits(0,0,!1):0,
e.prototype.locale="",
e.prototype.apikey=_a.newBuffer([]),e.prototype.identity=null,
e.prototype.visited=!1,
e.prototype.updateRequest=null,e.prototype.requestedServices=0,
e.prototype.customKeyValue=_a.emptyArray,
...
e.prototype.reserved=_a.newBuffer([]),e.prototype.safeShop=_a.Long?_a.Long.fromBits(0,0,!1):0,
e.prototype.client=null,
e.prototype.originHash=0,e.prototype.lastOrigin=null,e.prototype.clientTimestamp=_a.Long?_a.Long.fromBits(0,0,!1):0,
e.prototype.refererDetails=null,
e.prototype.initiating_user_action=0,e.prototype.served_from_cache=!1,
e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.uri&&e.uri.length){
...
null!=e.identity&&e.hasOwnProperty("identity")&&Ta.com.avast.cloud.webrep.proto.Identity.encode(e.identity,t.uint32(42).fork()).ldelim(),
null!=e.visited&&e.hasOwnProperty("visited")&&t.uint32(48).bool(e.visited),
null!=e.updateRequest&&e.hasOwnProperty("updateRequest")&&Ta.com.avast.cloud.webrep.proto.UpdateRequest.encode(e.updateRequest,t.uint32(58).fork()).ldelim(),
...
Ta.com.avast.cloud.webrep.proto.KeyValue.encode(e.customKeyValue[n],t.uint32(74).fork()).ldelim()
}
}
...
null!=e.client&&e.hasOwnProperty("client")&&Ta.com.avast.cloud.webrep.proto.Client.encode(e.client,t.uint32(146).fork()).ldelim(),
null!=e.originHash&&e.hasOwnProperty("originHash")&&t.uint32(152).int32(e.originHash),
null!=e.lastOrigin&&e.hasOwnProperty("lastOrigin")&&Ta.com.avast.cloud.webrep.proto.Origin.encode(e.lastOrigin,t.uint32(162).fork()).ldelim(),
null!=e.clientTimestamp&&e.hasOwnProperty("clientTimestamp")&&t.uint32(168).int64(e.clientTimestamp),
null!=e.refererDetails&&e.hasOwnProperty("refererDetails")&&Ta.com.avast.cloud.webrep.proto.RefererDetails.encode(e.refererDetails,t.uint32(178).fork()).ldelim(),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.UrlInfoRequest
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
break
case 5:
i.identity=Ta.com.avast.cloud.webrep.proto.Identity.decode(e,e.uint32())
break
case 6:
i.visited=e.bool()
break
case 7:
i.updateRequest=Ta.com.avast.cloud.webrep.proto.UpdateRequest.decode(e,e.uint32())
break
case 8:
i.requestedServices=e.sint32()
break
case 9:
i.customKeyValue&&i.customKeyValue.length||(i.customKeyValue=[]),i.customKeyValue.push(Ta.com.avast.cloud.webrep.proto.KeyValue.decode(e,e.uint32()))
break
case 10:
i.referer=e.string()
break
...
break
case 18:
i.client=Ta.com.avast.cloud.webrep.proto.Client.decode(e,e.uint32())
break
case 19:
i.originHash=e.int32()
break
case 20:
i.lastOrigin=Ta.com.avast.cloud.webrep.proto.Origin.decode(e,e.uint32())
break
case 21:
i.clientTimestamp=e.int64()
break
case 22:
i.refererDetails=Ta.com.avast.cloud.webrep.proto.RefererDetails.decode(e,e.uint32())
break
case 23:
...
if(null!=e.locale&&e.hasOwnProperty("locale")&&!_a.isString(e.locale)){
...
if(null!=e.identity&&e.hasOwnProperty("identity")){
let t=Ta.com.avast.cloud.webrep.proto.Identity.verify(e.identity)
if(t){
return"identity."+t
}
}
...
let t=Ta.com.avast.cloud.webrep.proto.UpdateRequest.verify(e.updateRequest)
if(t){
return"updateRequest."+t
}
}
if(null!=e.requestedServices&&e.hasOwnProperty("requestedServices")&&!_a.isInteger(e.requestedServices)){
...
let n=Ta.com.avast.cloud.webrep.proto.KeyValue.verify(e.customKeyValue[t])
if(n){
return"customKeyValue."+n
}
}
}
if(null!=e.referer&&e.hasOwnProperty("referer")&&!_a.isString(e.referer)){
return"referer: string expected"
}
if(null!=e.windowNum&&e.hasOwnProperty("windowNum")&&!_a.isInteger(e.windowNum)){
return"windowNum: integer expected"
}
if(null!=e.tabNum&&e.hasOwnProperty("tabNum")&&!_a.isInteger(e.tabNum)){
...
if(null!=e.reserved&&e.hasOwnProperty("reserved")&&!(e.reserved&&"number"==typeof e.reserved.length||_a.isString(e.reserved))){
return"reserved: buffer expected"
}
if(null!=e.safeShop&&e.hasOwnProperty("safeShop")&&!(_a.isInteger(e.safeShop)||e.safeShop&&_a.isInteger(e.safeShop.low)&&_a.isInteger(e.safeShop.high))){
return"safeShop: integer|Long expected"
}
if(null!=e.client&&e.hasOwnProperty("client")){
let t=Ta.com.avast.cloud.webrep.proto.Client.verify(e.client)
if(t){
return"client."+t
}
}
if(null!=e.originHash&&e.hasOwnProperty("originHash")&&!_a.isInteger(e.originHash)){
return"originHash: integer expected"
}
if(null!=e.lastOrigin&&e.hasOwnProperty("lastOrigin")){
let t=Ta.com.avast.cloud.webrep.proto.Origin.verify(e.lastOrigin)
if(t){
return"lastOrigin."+t
}
}
if(null!=e.clientTimestamp&&e.hasOwnProperty("clientTimestamp")&&!(_a.isInteger(e.clientTimestamp)||e.clientTimestamp&&_a.isInteger(e.clientTimestamp.low)&&_a.isInteger(e.clientTimestamp.high))){
return"clientTimestamp: integer|Long expected"
}
if(null!=e.refererDetails&&e.hasOwnProperty("refererDetails")){
let t=Ta.com.avast.cloud.webrep.proto.RefererDetails.verify(e.refererDetails)
if(t){
...
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.UrlInfoRequest){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.UrlInfoRequest
if(e.uri){
if(!Array.isArray(e.uri)){
...
t.identity=Ta.com.avast.cloud.webrep.proto.Identity.fromObject(e.identity)
}
...
t.updateRequest=Ta.com.avast.cloud.webrep.proto.UpdateRequest.fromObject(e.updateRequest)
}
...
t.customKeyValue[n]=Ta.com.avast.cloud.webrep.proto.KeyValue.fromObject(e.customKeyValue[n])
}
}
...
if(null!=e.dnl&&(t.dnl=Boolean(e.dnl)),null!=e.reserved&&("string"==typeof e.reserved?_a.base64.decode(e.reserved,t.reserved=_a.newBuffer(_a.base64.length(e.reserved)),0):e.reserved.length&&(t.reserved=e.reserved)),
null!=e.safeShop&&(_a.Long?(t.safeShop=_a.Long.fromValue(e.safeShop)).unsigned=!1:"string"==typeof e.safeShop?t.safeShop=parseInt(e.safeShop,10):"number"==typeof e.safeShop?t.safeShop=e.safeShop:"object"==typeof e.safeShop&&(t.safeShop=new _a.LongBits(e.safeShop.low>>>0,e.safeShop.high>>>0).toNumber())),
null!=e.client){
if("object"!=typeof e.client){
throw TypeError(".com.avast.cloud.webrep.proto.UrlInfoRequest.client: object expected")
}
t.client=Ta.com.avast.cloud.webrep.proto.Client.fromObject(e.client)
}
...
t.lastOrigin=Ta.com.avast.cloud.webrep.proto.Origin.fromObject(e.lastOrigin)
}
if(null!=e.clientTimestamp&&(_a.Long?(t.clientTimestamp=_a.Long.fromValue(e.clientTimestamp)).unsigned=!1:"string"==typeof e.clientTimestamp?t.clientTimestamp=parseInt(e.clientTimestamp,10):"number"==typeof e.clientTimestamp?t.clientTimestamp=e.clientTimestamp:"object"==typeof e.clientTimestamp&&(t.clientTimestamp=new _a.LongBits(e.clientTimestamp.low>>>0,e.clientTimestamp.high>>>0).toNumber())),
...
t.refererDetails=Ta.com.avast.cloud.webrep.proto.RefererDetails.fromObject(e.refererDetails)
}
switch(e.initiating_user_action){
case"LINK":
case 0:
...
if(n.locale="",t.bytes===String?n.apikey="":(n.apikey=[],t.bytes!==Array&&(n.apikey=_a.newBuffer(n.apikey))),
n.identity=null,
...
n.dnl=!1,
t.bytes===String?n.reserved="":(n.reserved=[],t.bytes!==Array&&(n.reserved=_a.newBuffer(n.reserved))),
_a.Long){
let e=new _a.Long(0,0,!1)
...
if(n.client=null,n.originHash=0,n.lastOrigin=null,_a.Long){
let e=new _a.Long(0,0,!1)
...
if(null!=e.callerId&&e.hasOwnProperty("callerId")&&("number"==typeof e.callerId?n.callerId=t.longs===String?String(e.callerId):e.callerId:n.callerId=t.longs===String?_a.Long.prototype.toString.call(e.callerId):t.longs===Number?new _a.LongBits(e.callerId.low>>>0,e.callerId.high>>>0).toNumber():e.callerId),
null!=e.locale&&e.hasOwnProperty("locale")&&(n.locale=e.locale),
null!=e.apikey&&e.hasOwnProperty("apikey")&&(n.apikey=t.bytes===String?_a.base64.encode(e.apikey,0,e.apikey.length):t.bytes===Array?Array.prototype.slice.call(e.apikey):e.apikey),
null!=e.identity&&e.hasOwnProperty("identity")&&(n.identity=Ta.com.avast.cloud.webrep.proto.Identity.toObject(e.identity,t)),
null!=e.visited&&e.hasOwnProperty("visited")&&(n.visited=e.visited),
null!=e.updateRequest&&e.hasOwnProperty("updateRequest")&&(n.updateRequest=Ta.com.avast.cloud.webrep.proto.UpdateRequest.toObject(e.updateRequest,t)),
...
n.customKeyValue[i]=Ta.com.avast.cloud.webrep.proto.KeyValue.toObject(e.customKeyValue[i],t)
}
}
...
null!=e.windowEvent&&e.hasOwnProperty("windowEvent")&&(n.windowEvent=t.enums===String?Ta.com.avast.cloud.webrep.proto.EventType[e.windowEvent]:e.windowEvent),
null!=e.origin&&e.hasOwnProperty("origin")&&(n.origin=t.enums===String?Ta.com.avast.cloud.webrep.proto.OriginType[e.origin]:e.origin),
null!=e.dnl&&e.hasOwnProperty("dnl")&&(n.dnl=e.dnl),
null!=e.reserved&&e.hasOwnProperty("reserved")&&(n.reserved=t.bytes===String?_a.base64.encode(e.reserved,0,e.reserved.length):t.bytes===Array?Array.prototype.slice.call(e.reserved):e.reserved),
null!=e.safeShop&&e.hasOwnProperty("safeShop")&&("number"==typeof e.safeShop?n.safeShop=t.longs===String?String(e.safeShop):e.safeShop:n.safeShop=t.longs===String?_a.Long.prototype.toString.call(e.safeShop):t.longs===Number?new _a.LongBits(e.safeShop.low>>>0,e.safeShop.high>>>0).toNumber():e.safeShop),
null!=e.client&&e.hasOwnProperty("client")&&(n.client=Ta.com.avast.cloud.webrep.proto.Client.toObject(e.client,t)),
null!=e.originHash&&e.hasOwnProperty("originHash")&&(n.originHash=e.originHash),
null!=e.lastOrigin&&e.hasOwnProperty("lastOrigin")&&(n.lastOrigin=Ta.com.avast.cloud.webrep.proto.Origin.toObject(e.lastOrigin,t)),
null!=e.clientTimestamp&&e.hasOwnProperty("clientTimestamp")&&("number"==typeof e.clientTimestamp?n.clientTimestamp=t.longs===String?String(e.clientTimestamp):e.clientTimestamp:n.clientTimestamp=t.longs===String?_a.Long.prototype.toString.call(e.clientTimestamp):t.longs===Number?new _a.LongBits(e.clientTimestamp.low>>>0,e.clientTimestamp.high>>>0).toNumber():e.clientTimestamp),
null!=e.refererDetails&&e.hasOwnProperty("refererDetails")&&(n.refererDetails=Ta.com.avast.cloud.webrep.proto.RefererDetails.toObject(e.refererDetails,t)),
null!=e.initiating_user_action&&e.hasOwnProperty("initiating_user_action")&&(n.initiating_user_action=t.enums===String?Ta.com.avast.cloud.webrep.proto.OriginType[e.initiating_user_action]:e.initiating_user_action),
...
return t||(t=Oa.create()),null!=e.webrep&&e.hasOwnProperty("webrep")&&Ta.com.avast.cloud.webrep.proto.Webrep.encode(e.webrep,t.uint32(10).fork()).ldelim(),
null!=e.phishing&&e.hasOwnProperty("phishing")&&Ta.com.avast.cloud.webrep.proto.Phishing.encode(e.phishing,t.uint32(18).fork()).ldelim(),
null!=e.blocker&&e.hasOwnProperty("blocker")&&Ta.com.avast.cloud.webrep.proto.Blocker.encode(e.blocker,t.uint32(26).fork()).ldelim(),
null!=e.typo&&e.hasOwnProperty("typo")&&Ta.com.avast.cloud.webrep.proto.Typo.encode(e.typo,t.uint32(34).fork()).ldelim(),
null!=e.safeshop&&e.hasOwnProperty("safeshop")&&Ta.com.avast.cloud.webrep.proto.SafeShop.encode(e.safeshop,t.uint32(42).fork()).ldelim(),
null!=e.categories&&e.hasOwnProperty("categories")&&Ta.com.avast.cloud.webrep.proto.Categories.encode(e.categories,t.uint32(50).fork()).ldelim(),
null!=e.ajax&&e.hasOwnProperty("ajax")&&Ta.com.avast.cloud.webrep.proto.Ajax.encode(e.ajax,t.uint32(58).fork()).ldelim(),
null!=e.iot_botnet&&e.hasOwnProperty("iot_botnet")&&Ta.com.avast.cloud.webrep.proto.IotBotnet.encode(e.iot_botnet,t.uint32(66).fork()).ldelim(),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.UrlInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.webrep=Ta.com.avast.cloud.webrep.proto.Webrep.decode(e,e.uint32())
break
case 2:
i.phishing=Ta.com.avast.cloud.webrep.proto.Phishing.decode(e,e.uint32())
break
case 3:
i.blocker=Ta.com.avast.cloud.webrep.proto.Blocker.decode(e,e.uint32())
break
case 4:
i.typo=Ta.com.avast.cloud.webrep.proto.Typo.decode(e,e.uint32())
break
case 5:
i.safeshop=Ta.com.avast.cloud.webrep.proto.SafeShop.decode(e,e.uint32())
break
case 6:
i.categories=Ta.com.avast.cloud.webrep.proto.Categories.decode(e,e.uint32())
break
case 7:
i.ajax=Ta.com.avast.cloud.webrep.proto.Ajax.decode(e,e.uint32())
break
case 8:
i.iot_botnet=Ta.com.avast.cloud.webrep.proto.IotBotnet.decode(e,e.uint32())
break
default:
e.skipType(7&t)
}
...
let t=Ta.com.avast.cloud.webrep.proto.Webrep.verify(e.webrep)
if(t){
return"webrep."+t
}
}
if(null!=e.phishing&&e.hasOwnProperty("phishing")){
let t=Ta.com.avast.cloud.webrep.proto.Phishing.verify(e.phishing)
if(t){
return"phishing."+t
}
}
if(null!=e.blocker&&e.hasOwnProperty("blocker")){
let t=Ta.com.avast.cloud.webrep.proto.Blocker.verify(e.blocker)
if(t){
return"blocker."+t
}
}
if(null!=e.typo&&e.hasOwnProperty("typo")){
let t=Ta.com.avast.cloud.webrep.proto.Typo.verify(e.typo)
if(t){
return"typo."+t
}
}
if(null!=e.safeshop&&e.hasOwnProperty("safeshop")){
let t=Ta.com.avast.cloud.webrep.proto.SafeShop.verify(e.safeshop)
if(t){
return"safeshop."+t
}
}
if(null!=e.categories&&e.hasOwnProperty("categories")){
let t=Ta.com.avast.cloud.webrep.proto.Categories.verify(e.categories)
if(t){
return"categories."+t
}
}
if(null!=e.ajax&&e.hasOwnProperty("ajax")){
let t=Ta.com.avast.cloud.webrep.proto.Ajax.verify(e.ajax)
if(t){
return"ajax."+t
}
}
if(null!=e.iot_botnet&&e.hasOwnProperty("iot_botnet")){
let t=Ta.com.avast.cloud.webrep.proto.IotBotnet.verify(e.iot_botnet)
if(t){
return"iot_botnet."+t
}
}
...
t.categories=Ta.com.avast.cloud.webrep.proto.Categories.fromObject(e.categories)
}
if(null!=e.ajax){
if("object"!=typeof e.ajax){
throw TypeError(".com.avast.cloud.webrep.proto.UrlInfo.ajax: object expected")
}
t.ajax=Ta.com.avast.cloud.webrep.proto.Ajax.fromObject(e.ajax)
}
...
t.iot_botnet=Ta.com.avast.cloud.webrep.proto.IotBotnet.fromObject(e.iot_botnet)
}
return t
},e.toObject=function(e,t){
t||(t={})
...
n.categories=null,
n.ajax=null,n.iot_botnet=null),null!=e.webrep&&e.hasOwnProperty("webrep")&&(n.webrep=Ta.com.avast.cloud.webrep.proto.Webrep.toObject(e.webrep,t)),
null!=e.phishing&&e.hasOwnProperty("phishing")&&(n.phishing=Ta.com.avast.cloud.webrep.proto.Phishing.toObject(e.phishing,t)),
null!=e.blocker&&e.hasOwnProperty("blocker")&&(n.blocker=Ta.com.avast.cloud.webrep.proto.Blocker.toObject(e.blocker,t)),
null!=e.typo&&e.hasOwnProperty("typo")&&(n.typo=Ta.com.avast.cloud.webrep.proto.Typo.toObject(e.typo,t)),
null!=e.safeshop&&e.hasOwnProperty("safeshop")&&(n.safeshop=Ta.com.avast.cloud.webrep.proto.SafeShop.toObject(e.safeshop,t)),
null!=e.categories&&e.hasOwnProperty("categories")&&(n.categories=Ta.com.avast.cloud.webrep.proto.Categories.toObject(e.categories,t)),
null!=e.ajax&&e.hasOwnProperty("ajax")&&(n.ajax=Ta.com.avast.cloud.webrep.proto.Ajax.toObject(e.ajax,t)),
null!=e.iot_botnet&&e.hasOwnProperty("iot_botnet")&&(n.iot_botnet=Ta.com.avast.cloud.webrep.proto.IotBotnet.toObject(e.iot_botnet,t)),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
return e.prototype.urlInfo=_a.emptyArray,e.prototype.updateResponse=null,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.urlInfo&&e.urlInfo.length){
for(let n=0;n<e.urlInfo.length;++n){
Ta.com.avast.cloud.webrep.proto.UrlInfo.encode(e.urlInfo[n],t.uint32(10).fork()).ldelim()
}
}
return null!=e.updateResponse&&e.hasOwnProperty("updateResponse")&&Ta.com.avast.cloud.webrep.proto.UpdateResponse.encode(e.updateResponse,t.uint32(18).fork()).ldelim(),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.UrlInfoResponse
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.urlInfo&&i.urlInfo.length||(i.urlInfo=[]),i.urlInfo.push(Ta.com.avast.cloud.webrep.proto.UrlInfo.decode(e,e.uint32()))
break
case 2:
i.updateResponse=Ta.com.avast.cloud.webrep.proto.UpdateResponse.decode(e,e.uint32())
break
default:
e.skipType(7&t)
}
...
let n=Ta.com.avast.cloud.webrep.proto.UrlInfo.verify(e.urlInfo[t])
if(n){
return"urlInfo."+n
}
}
...
let t=Ta.com.avast.cloud.webrep.proto.UpdateResponse.verify(e.updateResponse)
if(t){
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.UrlInfoResponse){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.UrlInfoResponse
if(e.urlInfo){
if(!Array.isArray(e.urlInfo)){
...
t.urlInfo[n]=Ta.com.avast.cloud.webrep.proto.UrlInfo.fromObject(e.urlInfo[n])
}
}
...
t.updateResponse=Ta.com.avast.cloud.webrep.proto.UpdateResponse.fromObject(e.updateResponse)
}
return t
},e.toObject=function(e,t){
t||(t={})
...
n.urlInfo[i]=Ta.com.avast.cloud.webrep.proto.UrlInfo.toObject(e.urlInfo[i],t)
}
}
return null!=e.updateResponse&&e.hasOwnProperty("updateResponse")&&(n.updateResponse=Ta.com.avast.cloud.webrep.proto.UpdateResponse.toObject(e.updateResponse,t)),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
return e.prototype.rating=0,e.prototype.weight=0,e.prototype.ttl=0,e.prototype.flags=_a.Long?_a.Long.fromBits(0,0,!1):0,
e.prototype.rating_level=1,
e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.rating&&e.hasOwnProperty("rating")&&t.uint32(8).sint32(e.rating),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Webrep
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(null!=e.rating&&e.hasOwnProperty("rating")&&!_a.isInteger(e.rating)){
return"rating: integer expected"
}
if(null!=e.weight&&e.hasOwnProperty("weight")&&!_a.isInteger(e.weight)){
return"weight: integer expected"
}
if(null!=e.ttl&&e.hasOwnProperty("ttl")&&!_a.isInteger(e.ttl)){
return"ttl: integer expected"
}
if(null!=e.flags&&e.hasOwnProperty("flags")&&!(_a.isInteger(e.flags)||e.flags&&_a.isInteger(e.flags.low)&&_a.isInteger(e.flags.high))){
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.Webrep){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Webrep
switch(null!=e.rating&&(t.rating=0|e.rating),null!=e.weight&&(t.weight=0|e.weight),
null!=e.ttl&&(t.ttl=0|e.ttl),
null!=e.flags&&(_a.Long?(t.flags=_a.Long.fromValue(e.flags)).unsigned=!1:"string"==typeof e.flags?t.flags=parseInt(e.flags,10):"number"==typeof e.flags?t.flags=e.flags:"object"==typeof e.flags&&(t.flags=new _a.LongBits(e.flags.low>>>0,e.flags.high>>>0).toNumber())),
e.rating_level){
case"GOOD":
case 1:
t.rating_level=1
...
let n={}
if(t.defaults){
if(n.rating=0,n.weight=0,n.ttl=0,_a.Long){
let e=new _a.Long(0,0,!1)
...
null!=e.flags&&e.hasOwnProperty("flags")&&("number"==typeof e.flags?n.flags=t.longs===String?String(e.flags):e.flags:n.flags=t.longs===String?_a.Long.prototype.toString.call(e.flags):t.longs===Number?new _a.LongBits(e.flags.low>>>0,e.flags.high>>>0).toNumber():e.flags),
null!=e.rating_level&&e.hasOwnProperty("rating_level")&&(n.rating_level=t.enums===String?Ta.com.avast.cloud.webrep.proto.Webrep.RatingLevel[e.rating_level]:e.rating_level),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
...
return t||(t=Oa.create()),null!=e.phishing&&e.hasOwnProperty("phishing")&&t.uint32(8).sint32(e.phishing),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Phishing
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.phishing&&e.hasOwnProperty("phishing")&&!_a.isInteger(e.phishing)?"phishing: integer expected":null!=e.phishingDomain&&e.hasOwnProperty("phishingDomain")&&!_a.isInteger(e.phishingDomain)?"phishingDomain: integer expected":null!=e.ttl&&e.hasOwnProperty("ttl")&&!_a.isInteger(e.ttl)?"ttl: integer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Phishing){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Phishing
...
return t||(t=Oa.create()),null!=e.url_to&&e.hasOwnProperty("url_to")&&t.uint32(10).string(e.url_to),
null!=e.brand_domain&&e.hasOwnProperty("brand_domain")&&t.uint32(18).string(e.brand_domain),
null!=e.urlInfo&&e.hasOwnProperty("urlInfo")&&Ta.com.avast.cloud.webrep.proto.UrlInfo.encode(e.urlInfo,t.uint32(26).fork()).ldelim(),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Typo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
break
case 3:
i.urlInfo=Ta.com.avast.cloud.webrep.proto.UrlInfo.decode(e,e.uint32())
break
case 4:
i.is_typo=e.bool()
break
...
if(null!=e.url_to&&e.hasOwnProperty("url_to")&&!_a.isString(e.url_to)){
return"url_to: string expected"
}
if(null!=e.brand_domain&&e.hasOwnProperty("brand_domain")&&!_a.isString(e.brand_domain)){
return"brand_domain: string expected"
}
if(null!=e.urlInfo&&e.hasOwnProperty("urlInfo")){
let t=Ta.com.avast.cloud.webrep.proto.UrlInfo.verify(e.urlInfo)
if(t){
return"urlInfo."+t
}
}
...
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Typo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Typo
...
t.urlInfo=Ta.com.avast.cloud.webrep.proto.UrlInfo.fromObject(e.urlInfo)
}
...
null!=e.urlInfo&&e.hasOwnProperty("urlInfo")&&(n.urlInfo=Ta.com.avast.cloud.webrep.proto.UrlInfo.toObject(e.urlInfo,t)),
...
return e.prototype.block=_a.Long?_a.Long.fromBits(0,0,!1):0,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.block&&e.hasOwnProperty("block")&&t.uint32(8).sint64(e.block),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Blocker
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.block&&e.hasOwnProperty("block")&&!(_a.isInteger(e.block)||e.block&&_a.isInteger(e.block.low)&&_a.isInteger(e.block.high))?"block: integer|Long expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Blocker){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Blocker
return null!=e.block&&(_a.Long?(t.block=_a.Long.fromValue(e.block)).unsigned=!1:"string"==typeof e.block?t.block=parseInt(e.block,10):"number"==typeof e.block?t.block=e.block:"object"==typeof e.block&&(t.block=new _a.LongBits(e.block.low>>>0,e.block.high>>>0).toNumber())),
t
},e.toObject=function(e,t){
t||(t={})
let n={}
...
return null!=e.block&&e.hasOwnProperty("block")&&("number"==typeof e.block?n.block=t.longs===String?String(e.block):e.block:n.block=t.longs===String?_a.Long.prototype.toString.call(e.block):t.longs===Number?new _a.LongBits(e.block.low>>>0,e.block.high>>>0).toNumber():e.block),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.IotBotnet
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.IotBotnet){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.IotBotnet
return null!=e.block&&(_a.Long?(t.block=_a.Long.fromValue(e.block)).unsigned=!1:"string"==typeof e.block?t.block=parseInt(e.block,10):"number"==typeof e.block?t.block=e.block:"object"==typeof e.block&&(t.block=new _a.LongBits(e.block.low>>>0,e.block.high>>>0).toNumber())),
t
},e.toObject=function(e,t){
t||(t={})
...
return e.prototype.timestamp=_a.Long?_a.Long.fromBits(0,0,!1):0,e.prototype.regex="",
e.prototype.selector="",
e.prototype.match=!1,e.prototype.is_fake=!1,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.timestamp&&e.hasOwnProperty("timestamp")&&t.uint32(8).int64(e.timestamp),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.SafeShop
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.timestamp&&e.hasOwnProperty("timestamp")&&!(_a.isInteger(e.timestamp)||e.timestamp&&_a.isInteger(e.timestamp.low)&&_a.isInteger(e.timestamp.high))?"timestamp: integer|Long expected":null!=e.regex&&e.hasOwnProperty("regex")&&!_a.isString(e.regex)?"regex: string expected":null!=e.selector&&e.hasOwnProperty("selector")&&!_a.isString(e.selector)?"selector: string expected":null!=e.match&&e.hasOwnProperty("match")&&"boolean"!=typeof e.match?"match: boolean expected":null!=e.is_fake&&e.hasOwnProperty("is_fake")&&"boolean"!=typeof e.is_fake?"is_fake: boolean expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.SafeShop){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.SafeShop
return null!=e.timestamp&&(_a.Long?(t.timestamp=_a.Long.fromValue(e.timestamp)).unsigned=!1:"string"==typeof e.timestamp?t.timestamp=parseInt(e.timestamp,10):"number"==typeof e.timestamp?t.timestamp=e.timestamp:"object"==typeof e.timestamp&&(t.timestamp=new _a.LongBits(e.timestamp.low>>>0,e.timestamp.high>>>0).toNumber())),
...
return null!=e.timestamp&&e.hasOwnProperty("timestamp")&&("number"==typeof e.timestamp?n.timestamp=t.longs===String?String(e.timestamp):e.timestamp:n.timestamp=t.longs===String?_a.Long.prototype.toString.call(e.timestamp):t.longs===Number?new _a.LongBits(e.timestamp.low>>>0,e.timestamp.high>>>0).toNumber():e.timestamp),
...
return e.prototype.guid=_a.newBuffer([]),e.prototype.uuid=_a.newBuffer([]),e.prototype.token=_a.newBuffer([]),
e.prototype.auid=_a.newBuffer([]),
e.prototype.browserType=0,e.prototype.token_verified=0,
e.prototype.ip_address=_a.newBuffer([]),
e.prototype.userid=_a.newBuffer([]),e.prototype.product=_a.newBuffer([]),
e.prototype.version=_a.newBuffer([]),
e.prototype.hwid=_a.newBuffer([]),e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.guid&&e.hasOwnProperty("guid")&&t.uint32(10).bytes(e.guid),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Identity
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(null!=e.guid&&e.hasOwnProperty("guid")&&!(e.guid&&"number"==typeof e.guid.length||_a.isString(e.guid))){
return"guid: buffer expected"
}
if(null!=e.uuid&&e.hasOwnProperty("uuid")&&!(e.uuid&&"number"==typeof e.uuid.length||_a.isString(e.uuid))){
return"uuid: buffer expected"
}
if(null!=e.token&&e.hasOwnProperty("token")&&!(e.token&&"number"==typeof e.token.length||_a.isString(e.token))){
return"token: buffer expected"
}
if(null!=e.auid&&e.hasOwnProperty("auid")&&!(e.auid&&"number"==typeof e.auid.length||_a.isString(e.auid))){
...
return null!=e.token_verified&&e.hasOwnProperty("token_verified")&&!_a.isInteger(e.token_verified)?"token_verified: integer expected":null!=e.ip_address&&e.hasOwnProperty("ip_address")&&!(e.ip_address&&"number"==typeof e.ip_address.length||_a.isString(e.ip_address))?"ip_address: buffer expected":null!=e.userid&&e.hasOwnProperty("userid")&&!(e.userid&&"number"==typeof e.userid.length||_a.isString(e.userid))?"userid: buffer expected":null!=e.product&&e.hasOwnProperty("product")&&!(e.product&&"number"==typeof e.product.length||_a.isString(e.product))?"product: buffer expected":null!=e.version&&e.hasOwnProperty("version")&&!(e.version&&"number"==typeof e.version.length||_a.isString(e.version))?"version: buffer expected":null!=e.hwid&&e.hasOwnProperty("hwid")&&!(e.hwid&&"number"==typeof e.hwid.length||_a.isString(e.hwid))?"hwid: buffer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Identity){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Identity
switch(null!=e.guid&&("string"==typeof e.guid?_a.base64.decode(e.guid,t.guid=_a.newBuffer(_a.base64.length(e.guid)),0):e.guid.length&&(t.guid=e.guid)),
null!=e.uuid&&("string"==typeof e.uuid?_a.base64.decode(e.uuid,t.uuid=_a.newBuffer(_a.base64.length(e.uuid)),0):e.uuid.length&&(t.uuid=e.uuid)),
null!=e.token&&("string"==typeof e.token?_a.base64.decode(e.token,t.token=_a.newBuffer(_a.base64.length(e.token)),0):e.token.length&&(t.token=e.token)),
null!=e.auid&&("string"==typeof e.auid?_a.base64.decode(e.auid,t.auid=_a.newBuffer(_a.base64.length(e.auid)),0):e.auid.length&&(t.auid=e.auid)),
e.browserType){
case"CHROME":
case 0:
t.browserType=0
...
return null!=e.token_verified&&(t.token_verified=0|e.token_verified),null!=e.ip_address&&("string"==typeof e.ip_address?_a.base64.decode(e.ip_address,t.ip_address=_a.newBuffer(_a.base64.length(e.ip_address)),0):e.ip_address.length&&(t.ip_address=e.ip_address)),
null!=e.userid&&("string"==typeof e.userid?_a.base64.decode(e.userid,t.userid=_a.newBuffer(_a.base64.length(e.userid)),0):e.userid.length&&(t.userid=e.userid)),
null!=e.product&&("string"==typeof e.product?_a.base64.decode(e.product,t.product=_a.newBuffer(_a.base64.length(e.product)),0):e.product.length&&(t.product=e.product)),
null!=e.version&&("string"==typeof e.version?_a.base64.decode(e.version,t.version=_a.newBuffer(_a.base64.length(e.version)),0):e.version.length&&(t.version=e.version)),
null!=e.hwid&&("string"==typeof e.hwid?_a.base64.decode(e.hwid,t.hwid=_a.newBuffer(_a.base64.length(e.hwid)),0):e.hwid.length&&(t.hwid=e.hwid)),
t
},e.toObject=function(e,t){
t||(t={})
let n={}
return t.defaults&&(t.bytes===String?n.guid="":(n.guid=[],t.bytes!==Array&&(n.guid=_a.newBuffer(n.guid))),
t.bytes===String?n.uuid="":(n.uuid=[],
t.bytes!==Array&&(n.uuid=_a.newBuffer(n.uuid))),
t.bytes===String?n.token="":(n.token=[],
t.bytes!==Array&&(n.token=_a.newBuffer(n.token))),
t.bytes===String?n.auid="":(n.auid=[],
t.bytes!==Array&&(n.auid=_a.newBuffer(n.auid))),
n.browserType=t.enums===String?"CHROME":0,
n.token_verified=0,t.bytes===String?n.ip_address="":(n.ip_address=[],
t.bytes!==Array&&(n.ip_address=_a.newBuffer(n.ip_address))),
t.bytes===String?n.userid="":(n.userid=[],
t.bytes!==Array&&(n.userid=_a.newBuffer(n.userid))),
t.bytes===String?n.product="":(n.product=[],
t.bytes!==Array&&(n.product=_a.newBuffer(n.product))),
t.bytes===String?n.version="":(n.version=[],
t.bytes!==Array&&(n.version=_a.newBuffer(n.version))),
t.bytes===String?n.hwid="":(n.hwid=[],
t.bytes!==Array&&(n.hwid=_a.newBuffer(n.hwid)))),
null!=e.guid&&e.hasOwnProperty("guid")&&(n.guid=t.bytes===String?_a.base64.encode(e.guid,0,e.guid.length):t.bytes===Array?Array.prototype.slice.call(e.guid):e.guid),
null!=e.uuid&&e.hasOwnProperty("uuid")&&(n.uuid=t.bytes===String?_a.base64.encode(e.uuid,0,e.uuid.length):t.bytes===Array?Array.prototype.slice.call(e.uuid):e.uuid),
null!=e.token&&e.hasOwnProperty("token")&&(n.token=t.bytes===String?_a.base64.encode(e.token,0,e.token.length):t.bytes===Array?Array.prototype.slice.call(e.token):e.token),
null!=e.auid&&e.hasOwnProperty("auid")&&(n.auid=t.bytes===String?_a.base64.encode(e.auid,0,e.auid.length):t.bytes===Array?Array.prototype.slice.call(e.auid):e.auid),
null!=e.browserType&&e.hasOwnProperty("browserType")&&(n.browserType=t.enums===String?Ta.com.avast.cloud.webrep.proto.Identity.BrowserType[e.browserType]:e.browserType),
null!=e.token_verified&&e.hasOwnProperty("token_verified")&&(n.token_verified=e.token_verified),
null!=e.ip_address&&e.hasOwnProperty("ip_address")&&(n.ip_address=t.bytes===String?_a.base64.encode(e.ip_address,0,e.ip_address.length):t.bytes===Array?Array.prototype.slice.call(e.ip_address):e.ip_address),
null!=e.userid&&e.hasOwnProperty("userid")&&(n.userid=t.bytes===String?_a.base64.encode(e.userid,0,e.userid.length):t.bytes===Array?Array.prototype.slice.call(e.userid):e.userid),
null!=e.product&&e.hasOwnProperty("product")&&(n.product=t.bytes===String?_a.base64.encode(e.product,0,e.product.length):t.bytes===Array?Array.prototype.slice.call(e.product):e.product),
null!=e.version&&e.hasOwnProperty("version")&&(n.version=t.bytes===String?_a.base64.encode(e.version,0,e.version.length):t.bytes===Array?Array.prototype.slice.call(e.version):e.version),
null!=e.hwid&&e.hasOwnProperty("hwid")&&(n.hwid=t.bytes===String?_a.base64.encode(e.hwid,0,e.hwid.length):t.bytes===Array?Array.prototype.slice.call(e.hwid):e.hwid),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
...
return t||(t=Oa.create()),null!=e.key&&e.hasOwnProperty("key")&&t.uint32(10).string(e.key),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.KeyValue
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.key&&e.hasOwnProperty("key")&&!_a.isString(e.key)?"key: string expected":null!=e.value&&e.hasOwnProperty("value")&&!_a.isString(e.value)?"value: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.KeyValue){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.KeyValue
...
return t||(t=Oa.create()),null!=e.origin&&e.hasOwnProperty("origin")&&t.uint32(8).int32(e.origin),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Origin
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return null!=e.hash&&e.hasOwnProperty("hash")&&!_a.isInteger(e.hash)?"hash: integer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Origin){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Origin
switch(e.origin){
case"LINK":
case 0:
t.origin=0
...
t||(t={})
let n={}
return t.defaults&&(n.origin=t.enums===String?"LINK":0,n.hash=0),null!=e.origin&&e.hasOwnProperty("origin")&&(n.origin=t.enums===String?Ta.com.avast.cloud.webrep.proto.OriginType[e.origin]:e.origin),
...
return t||(t=Oa.create()),null!=e.id&&e.hasOwnProperty("id")&&Ta.com.avast.cloud.webrep.proto.AvastIdentity.encode(e.id,t.uint32(10).fork()).ldelim(),
null!=e.type&&e.hasOwnProperty("type")&&t.uint32(16).int32(e.type),
null!=e.browserExtInfo&&e.hasOwnProperty("browserExtInfo")&&Ta.com.avast.cloud.webrep.proto.BrowserExtInfo.encode(e.browserExtInfo,t.uint32(26).fork()).ldelim(),
null!=e.messageClientInfo&&e.hasOwnProperty("messageClientInfo")&&Ta.com.avast.cloud.webrep.proto.MessageClientInfo.encode(e.messageClientInfo,t.uint32(34).fork()).ldelim(),
null!=e.browserCleanUpInfo&&e.hasOwnProperty("browserCleanUpInfo")&&Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo.encode(e.browserCleanUpInfo,t.uint32(42).fork()).ldelim(),
null!=e.amsInfo&&e.hasOwnProperty("amsInfo")&&Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo.encode(e.amsInfo,t.uint32(50).fork()).ldelim(),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Client
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.id=Ta.com.avast.cloud.webrep.proto.AvastIdentity.decode(e,e.uint32())
break
case 2:
i.type=e.int32()
break
case 3:
i.browserExtInfo=Ta.com.avast.cloud.webrep.proto.BrowserExtInfo.decode(e,e.uint32())
break
case 4:
i.messageClientInfo=Ta.com.avast.cloud.webrep.proto.MessageClientInfo.decode(e,e.uint32())
break
case 5:
i.browserCleanUpInfo=Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo.decode(e,e.uint32())
break
case 6:
i.amsInfo=Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo.decode(e,e.uint32())
break
default:
e.skipType(7&t)
}
...
let t=Ta.com.avast.cloud.webrep.proto.AvastIdentity.verify(e.id)
if(t){
return"id."+t
}
}
...
let t=Ta.com.avast.cloud.webrep.proto.BrowserExtInfo.verify(e.browserExtInfo)
if(t){
return"browserExtInfo."+t
}
}
if(null!=e.messageClientInfo&&e.hasOwnProperty("messageClientInfo")){
let t=Ta.com.avast.cloud.webrep.proto.MessageClientInfo.verify(e.messageClientInfo)
if(t){
return"messageClientInfo."+t
}
}
if(null!=e.browserCleanUpInfo&&e.hasOwnProperty("browserCleanUpInfo")){
let t=Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo.verify(e.browserCleanUpInfo)
if(t){
return"browserCleanUpInfo."+t
}
}
if(null!=e.amsInfo&&e.hasOwnProperty("amsInfo")){
let t=Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo.verify(e.amsInfo)
if(t){
return"amsInfo."+t
}
}
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.Client){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Client
if(null!=e.id){
if("object"!=typeof e.id){
throw TypeError(".com.avast.cloud.webrep.proto.Client.id: object expected")
}
t.id=Ta.com.avast.cloud.webrep.proto.AvastIdentity.fromObject(e.id)
}
switch(e.type){
case"TEST":
case 1:
...
t.browserExtInfo=Ta.com.avast.cloud.webrep.proto.BrowserExtInfo.fromObject(e.browserExtInfo)
}
...
t.messageClientInfo=Ta.com.avast.cloud.webrep.proto.MessageClientInfo.fromObject(e.messageClientInfo)
}
...
t.browserCleanUpInfo=Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo.fromObject(e.browserCleanUpInfo)
}
if(null!=e.amsInfo){
if("object"!=typeof e.amsInfo){
throw TypeError(".com.avast.cloud.webrep.proto.Client.amsInfo: object expected")
}
t.amsInfo=Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo.fromObject(e.amsInfo)
}
return t
},e.toObject=function(e,t){
t||(t={})
...
n.browserCleanUpInfo=null,n.amsInfo=null),null!=e.id&&e.hasOwnProperty("id")&&(n.id=Ta.com.avast.cloud.webrep.proto.AvastIdentity.toObject(e.id,t)),
null!=e.type&&e.hasOwnProperty("type")&&(n.type=t.enums===String?Ta.com.avast.cloud.webrep.proto.Client.CType[e.type]:e.type),
null!=e.browserExtInfo&&e.hasOwnProperty("browserExtInfo")&&(n.browserExtInfo=Ta.com.avast.cloud.webrep.proto.BrowserExtInfo.toObject(e.browserExtInfo,t)),
null!=e.messageClientInfo&&e.hasOwnProperty("messageClientInfo")&&(n.messageClientInfo=Ta.com.avast.cloud.webrep.proto.MessageClientInfo.toObject(e.messageClientInfo,t)),
null!=e.browserCleanUpInfo&&e.hasOwnProperty("browserCleanUpInfo")&&(n.browserCleanUpInfo=Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo.toObject(e.browserCleanUpInfo,t)),
null!=e.amsInfo&&e.hasOwnProperty("amsInfo")&&(n.amsInfo=Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo.toObject(e.amsInfo,t)),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e.CType=function(){
...
return e.prototype.guid=_a.newBuffer([]),e.prototype.uuid=_a.newBuffer([]),e.prototype.token=_a.newBuffer([]),
e.prototype.auid=_a.newBuffer([]),
e.prototype.userid=_a.newBuffer([]),e.prototype.hwid=_a.newBuffer([]),
e.prototype.android_advertisement_id=_a.newBuffer([]),
e.prototype.plugin_guid=_a.newBuffer([]),
e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.guid&&e.hasOwnProperty("guid")&&t.uint32(10).bytes(e.guid),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.AvastIdentity
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.guid&&e.hasOwnProperty("guid")&&!(e.guid&&"number"==typeof e.guid.length||_a.isString(e.guid))?"guid: buffer expected":null!=e.uuid&&e.hasOwnProperty("uuid")&&!(e.uuid&&"number"==typeof e.uuid.length||_a.isString(e.uuid))?"uuid: buffer expected":null!=e.token&&e.hasOwnProperty("token")&&!(e.token&&"number"==typeof e.token.length||_a.isString(e.token))?"token: buffer expected":null!=e.auid&&e.hasOwnProperty("auid")&&!(e.auid&&"number"==typeof e.auid.length||_a.isString(e.auid))?"auid: buffer expected":null!=e.userid&&e.hasOwnProperty("userid")&&!(e.userid&&"number"==typeof e.userid.length||_a.isString(e.userid))?"userid: buffer expected":null!=e.hwid&&e.hasOwnProperty("hwid")&&!(e.hwid&&"number"==typeof e.hwid.length||_a.isString(e.hwid))?"hwid: buffer expected":null!=e.android_advertisement_id&&e.hasOwnProperty("android_advertisement_id")&&!(e.android_advertisement_id&&"number"==typeof e.android_advertisement_id.length||_a.isString(e.android_advertisement_id))?"android_advertisement_id: buffer expected":null!=e.plugin_guid&&e.hasOwnProperty("plugin_guid")&&!(e.plugin_guid&&"number"==typeof e.plugin_guid.length||_a.isString(e.plugin_guid))?"plugin_guid: buffer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.AvastIdentity){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.AvastIdentity
return null!=e.guid&&("string"==typeof e.guid?_a.base64.decode(e.guid,t.guid=_a.newBuffer(_a.base64.length(e.guid)),0):e.guid.length&&(t.guid=e.guid)),
null!=e.uuid&&("string"==typeof e.uuid?_a.base64.decode(e.uuid,t.uuid=_a.newBuffer(_a.base64.length(e.uuid)),0):e.uuid.length&&(t.uuid=e.uuid)),
null!=e.token&&("string"==typeof e.token?_a.base64.decode(e.token,t.token=_a.newBuffer(_a.base64.length(e.token)),0):e.token.length&&(t.token=e.token)),
null!=e.auid&&("string"==typeof e.auid?_a.base64.decode(e.auid,t.auid=_a.newBuffer(_a.base64.length(e.auid)),0):e.auid.length&&(t.auid=e.auid)),
null!=e.userid&&("string"==typeof e.userid?_a.base64.decode(e.userid,t.userid=_a.newBuffer(_a.base64.length(e.userid)),0):e.userid.length&&(t.userid=e.userid)),
null!=e.hwid&&("string"==typeof e.hwid?_a.base64.decode(e.hwid,t.hwid=_a.newBuffer(_a.base64.length(e.hwid)),0):e.hwid.length&&(t.hwid=e.hwid)),
null!=e.android_advertisement_id&&("string"==typeof e.android_advertisement_id?_a.base64.decode(e.android_advertisement_id,t.android_advertisement_id=_a.newBuffer(_a.base64.length(e.android_advertisement_id)),0):e.android_advertisement_id.length&&(t.android_advertisement_id=e.android_advertisement_id)),
null!=e.plugin_guid&&("string"==typeof e.plugin_guid?_a.base64.decode(e.plugin_guid,t.plugin_guid=_a.newBuffer(_a.base64.length(e.plugin_guid)),0):e.plugin_guid.length&&(t.plugin_guid=e.plugin_guid)),
t
},e.toObject=function(e,t){
t||(t={})
let n={}
...
t.bytes!==Array&&(n.android_advertisement_id=_a.newBuffer(n.android_advertisement_id))),
t.bytes===String?n.plugin_guid="":(n.plugin_guid=[],
t.bytes!==Array&&(n.plugin_guid=_a.newBuffer(n.plugin_guid)))),
null!=e.guid&&e.hasOwnProperty("guid")&&(n.guid=t.bytes===String?_a.base64.encode(e.guid,0,e.guid.length):t.bytes===Array?Array.prototype.slice.call(e.guid):e.guid),
null!=e.uuid&&e.hasOwnProperty("uuid")&&(n.uuid=t.bytes===String?_a.base64.encode(e.uuid,0,e.uuid.length):t.bytes===Array?Array.prototype.slice.call(e.uuid):e.uuid),
null!=e.token&&e.hasOwnProperty("token")&&(n.token=t.bytes===String?_a.base64.encode(e.token,0,e.token.length):t.bytes===Array?Array.prototype.slice.call(e.token):e.token),
null!=e.auid&&e.hasOwnProperty("auid")&&(n.auid=t.bytes===String?_a.base64.encode(e.auid,0,e.auid.length):t.bytes===Array?Array.prototype.slice.call(e.auid):e.auid),
null!=e.userid&&e.hasOwnProperty("userid")&&(n.userid=t.bytes===String?_a.base64.encode(e.userid,0,e.userid.length):t.bytes===Array?Array.prototype.slice.call(e.userid):e.userid),
null!=e.hwid&&e.hasOwnProperty("hwid")&&(n.hwid=t.bytes===String?_a.base64.encode(e.hwid,0,e.hwid.length):t.bytes===Array?Array.prototype.slice.call(e.hwid):e.hwid),
null!=e.android_advertisement_id&&e.hasOwnProperty("android_advertisement_id")&&(n.android_advertisement_id=t.bytes===String?_a.base64.encode(e.android_advertisement_id,0,e.android_advertisement_id.length):t.bytes===Array?Array.prototype.slice.call(e.android_advertisement_id):e.android_advertisement_id),
null!=e.plugin_guid&&e.hasOwnProperty("plugin_guid")&&(n.plugin_guid=t.bytes===String?_a.base64.encode(e.plugin_guid,0,e.plugin_guid.length):t.bytes===Array?Array.prototype.slice.call(e.plugin_guid):e.plugin_guid),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
return t||(t=Oa.create()),null!=e.extensionType&&e.hasOwnProperty("extensionType")&&t.uint32(8).int32(e.extensionType),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.BrowserExtInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(null!=e.extensionVersion&&e.hasOwnProperty("extensionVersion")&&!_a.isInteger(e.extensionVersion)){
...
if(null!=e.browserVersion&&e.hasOwnProperty("browserVersion")&&!_a.isString(e.browserVersion)){
...
return null!=e.osVersion&&e.hasOwnProperty("osVersion")&&!_a.isString(e.osVersion)?"osVersion: string expected":null!=e.dataVersion&&e.hasOwnProperty("dataVersion")&&!_a.isInteger(e.dataVersion)?"dataVersion: integer expected":null!=e.avVersion&&e.hasOwnProperty("avVersion")&&!_a.isString(e.avVersion)?"avVersion: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.BrowserExtInfo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.BrowserExtInfo
switch(e.extensionType){
case"AOS":
case 1:
t.extensionType=1
...
n.avVersion=""),null!=e.extensionType&&e.hasOwnProperty("extensionType")&&(n.extensionType=t.enums===String?Ta.com.avast.cloud.webrep.proto.ExtensionType[e.extensionType]:e.extensionType),
null!=e.extensionVersion&&e.hasOwnProperty("extensionVersion")&&(n.extensionVersion=e.extensionVersion),
null!=e.browserType&&e.hasOwnProperty("browserType")&&(n.browserType=t.enums===String?Ta.com.avast.cloud.webrep.proto.BrowserType[e.browserType]:e.browserType),
null!=e.browserVersion&&e.hasOwnProperty("browserVersion")&&(n.browserVersion=e.browserVersion),
null!=e.os&&e.hasOwnProperty("os")&&(n.os=t.enums===String?Ta.com.avast.cloud.webrep.proto.OS[e.os]:e.os),
...
return t||(t=Oa.create()),null!=e.os&&e.hasOwnProperty("os")&&t.uint32(8).int32(e.os),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.MessageClientInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return null!=e.osVersion&&e.hasOwnProperty("osVersion")&&!_a.isString(e.osVersion)?"osVersion: string expected":null!=e.dataVersion&&e.hasOwnProperty("dataVersion")&&!_a.isInteger(e.dataVersion)?"dataVersion: integer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.MessageClientInfo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.MessageClientInfo
switch(e.os){
case"WIN":
case 1:
t.os=1
...
return t||(t=Oa.create()),null!=e.productLanguage&&e.hasOwnProperty("productLanguage")&&t.uint32(10).string(e.productLanguage),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(null!=e.productLanguage&&e.hasOwnProperty("productLanguage")&&!_a.isString(e.productLanguage)){
return"productLanguage: string expected"
}
if(null!=e.osLanguage&&e.hasOwnProperty("osLanguage")&&!_a.isString(e.osLanguage)){
...
return null!=e.osDetail&&e.hasOwnProperty("osDetail")&&!_a.isString(e.osDetail)?"osDetail: string expected":null!=e.location&&e.hasOwnProperty("location")&&!_a.isString(e.location)?"location: string expected":null!=e.productType&&e.hasOwnProperty("productType")&&!_a.isInteger(e.productType)?"productType: integer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.BrowserCleanUpInfo
...
return e.prototype.versionCode=_a.Long?_a.Long.fromBits(0,0,!1):0,e.prototype.versionName="",
e.create=function(t){
return new e(t)
},e.encode=function(e,t){
return t||(t=Oa.create()),null!=e.versionCode&&e.hasOwnProperty("versionCode")&&t.uint32(8).int64(e.versionCode),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.versionCode&&e.hasOwnProperty("versionCode")&&!(_a.isInteger(e.versionCode)||e.versionCode&&_a.isInteger(e.versionCode.low)&&_a.isInteger(e.versionCode.high))?"versionCode: integer|Long expected":null!=e.versionName&&e.hasOwnProperty("versionName")&&!_a.isString(e.versionName)?"versionName: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.AvastMobileSecurityInfo
return null!=e.versionCode&&(_a.Long?(t.versionCode=_a.Long.fromValue(e.versionCode)).unsigned=!1:"string"==typeof e.versionCode?t.versionCode=parseInt(e.versionCode,10):"number"==typeof e.versionCode?t.versionCode=e.versionCode:"object"==typeof e.versionCode&&(t.versionCode=new _a.LongBits(e.versionCode.low>>>0,e.versionCode.high>>>0).toNumber())),
...
return null!=e.versionCode&&e.hasOwnProperty("versionCode")&&("number"==typeof e.versionCode?n.versionCode=t.longs===String?String(e.versionCode):e.versionCode:n.versionCode=t.longs===String?_a.Long.prototype.toString.call(e.versionCode):t.longs===Number?new _a.LongBits(e.versionCode.low>>>0,e.versionCode.high>>>0).toNumber():e.versionCode),
...
return e.prototype.matches=_a.emptyArray,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.matches&&e.matches.length){
for(let n=0;n<e.matches.length;++n){
Ta.com.avast.cloud.webrep.proto.CategoryMatch.encode(e.matches[n],t.uint32(10).fork()).ldelim()
}
}
return t
},e.encodeDelimited=function(e,t){
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Categories
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.matches&&i.matches.length||(i.matches=[]),i.matches.push(Ta.com.avast.cloud.webrep.proto.CategoryMatch.decode(e,e.uint32()))
break
default:
e.skipType(7&t)
}
...
let n=Ta.com.avast.cloud.webrep.proto.CategoryMatch.verify(e.matches[t])
if(n){
return"matches."+n
}
}
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.Categories){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Categories
if(e.matches){
if(!Array.isArray(e.matches)){
...
t.matches[n]=Ta.com.avast.cloud.webrep.proto.CategoryMatch.fromObject(e.matches[n])
}
}
return t
},e.toObject=function(e,t){
...
n.matches[i]=Ta.com.avast.cloud.webrep.proto.CategoryMatch.toObject(e.matches[i],t)
}
}
return n
},e.prototype.toJSON=function(){
...
return t||(t=Oa.create()),null!=e.collect&&e.hasOwnProperty("collect")&&t.uint32(8).bool(e.collect),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Ajax
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Ajax){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Ajax
...
return t||(t=Oa.create()),null!=e.type&&e.hasOwnProperty("type")&&t.uint32(8).int32(e.type),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.CategoryMatch
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.CategoryMatch){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.CategoryMatch
switch(e.type){
case"DOMAIN":
case 0:
t.type=0
...
null!=e.type&&e.hasOwnProperty("type")&&(n.type=t.enums===String?Ta.com.avast.cloud.webrep.proto.CategoryMatchType[e.type]:e.type),
null!=e.category&&e.hasOwnProperty("category")&&(n.category=t.enums===String?Ta.com.avast.cloud.webrep.proto.Category[e.category]:e.category),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
return t||(t=Oa.create()),null!=e.fakeReferer&&e.hasOwnProperty("fakeReferer")&&t.uint32(10).string(e.fakeReferer),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.RefererDetails
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.fakeReferer&&e.hasOwnProperty("fakeReferer")&&!_a.isString(e.fakeReferer)?"fakeReferer: string expected":null!=e.windowNum&&e.hasOwnProperty("windowNum")&&!_a.isInteger(e.windowNum)?"windowNum: integer expected":null!=e.tabNum&&e.hasOwnProperty("tabNum")&&!_a.isInteger(e.tabNum)?"tabNum: integer expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.RefererDetails){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.RefererDetails
...
return t||(t=Oa.create()),null!=e.pluginType&&e.hasOwnProperty("pluginType")&&t.uint32(10).string(e.pluginType),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.UpdateRequest
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.pluginType&&e.hasOwnProperty("pluginType")&&!_a.isString(e.pluginType)?"pluginType: string expected":null!=e.pluginVersion&&e.hasOwnProperty("pluginVersion")&&!_a.isString(e.pluginVersion)?"pluginVersion: string expected":null!=e.rulesVersion&&e.hasOwnProperty("rulesVersion")&&!_a.isString(e.rulesVersion)?"rulesVersion: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.UpdateRequest){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.UpdateRequest
...
return t||(t=Oa.create()),null!=e.pluginUpdate&&e.hasOwnProperty("pluginUpdate")&&Ta.com.avast.cloud.webrep.proto.PluginUpdate.encode(e.pluginUpdate,t.uint32(10).fork()).ldelim(),
null!=e.rulesUpdate&&e.hasOwnProperty("rulesUpdate")&&Ta.com.avast.cloud.webrep.proto.RulesUpdate.encode(e.rulesUpdate,t.uint32(18).fork()).ldelim(),
t
},e.encodeDelimited=function(e,t){
return this.encode(e,t).ldelim()
},e.decode=function(e,t){
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.UpdateResponse
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
i.pluginUpdate=Ta.com.avast.cloud.webrep.proto.PluginUpdate.decode(e,e.uint32())
break
case 2:
i.rulesUpdate=Ta.com.avast.cloud.webrep.proto.RulesUpdate.decode(e,e.uint32())
break
default:
e.skipType(7&t)
}
...
let t=Ta.com.avast.cloud.webrep.proto.PluginUpdate.verify(e.pluginUpdate)
if(t){
return"pluginUpdate."+t
}
}
if(null!=e.rulesUpdate&&e.hasOwnProperty("rulesUpdate")){
let t=Ta.com.avast.cloud.webrep.proto.RulesUpdate.verify(e.rulesUpdate)
if(t){
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.UpdateResponse){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.UpdateResponse
...
t.pluginUpdate=Ta.com.avast.cloud.webrep.proto.PluginUpdate.fromObject(e.pluginUpdate)
}
...
t.rulesUpdate=Ta.com.avast.cloud.webrep.proto.RulesUpdate.fromObject(e.rulesUpdate)
}
return t
},e.toObject=function(e,t){
t||(t={})
let n={}
return t.defaults&&(n.pluginUpdate=null,n.rulesUpdate=null),null!=e.pluginUpdate&&e.hasOwnProperty("pluginUpdate")&&(n.pluginUpdate=Ta.com.avast.cloud.webrep.proto.PluginUpdate.toObject(e.pluginUpdate,t)),
null!=e.rulesUpdate&&e.hasOwnProperty("rulesUpdate")&&(n.rulesUpdate=Ta.com.avast.cloud.webrep.proto.RulesUpdate.toObject(e.rulesUpdate,t)),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
...
return t||(t=Oa.create()),null!=e.plyginType&&e.hasOwnProperty("plyginType")&&t.uint32(10).string(e.plyginType),
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.PluginUpdate
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.plyginType&&e.hasOwnProperty("plyginType")&&!_a.isString(e.plyginType)?"plyginType: string expected":null!=e.version&&e.hasOwnProperty("version")&&!_a.isString(e.version)?"version: string expected":null!=e.releaseNotes&&e.hasOwnProperty("releaseNotes")&&!_a.isString(e.releaseNotes)?"releaseNotes: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.PluginUpdate){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.PluginUpdate
...
return e.prototype.version="",e.prototype.rules=_a.emptyArray,e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Oa.create()),null!=e.version&&e.hasOwnProperty("version")&&t.uint32(10).string(e.version),
null!=e.rules&&e.rules.length){
for(let n=0;n<e.rules.length;++n){
Ta.com.avast.cloud.webrep.proto.Rule.encode(e.rules[n],t.uint32(18).fork()).ldelim()
}
}
return t
},e.encodeDelimited=function(e,t){
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.RulesUpdate
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
break
case 2:
i.rules&&i.rules.length||(i.rules=[]),i.rules.push(Ta.com.avast.cloud.webrep.proto.Rule.decode(e,e.uint32()))
break
default:
e.skipType(7&t)
}
...
if(null!=e.version&&e.hasOwnProperty("version")&&!_a.isString(e.version)){
...
let n=Ta.com.avast.cloud.webrep.proto.Rule.verify(e.rules[t])
if(n){
return"rules."+n
}
}
...
if(e instanceof Ta.com.avast.cloud.webrep.proto.RulesUpdate){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.RulesUpdate
...
t.rules[n]=Ta.com.avast.cloud.webrep.proto.Rule.fromObject(e.rules[n])
}
}
return t
},e.toObject=function(e,t){
...
n.rules[i]=Ta.com.avast.cloud.webrep.proto.Rule.toObject(e.rules[i],t)
}
}
return n
},e.prototype.toJSON=function(){
...
e instanceof Ea||(e=Ea.create(e))
let n=void 0===t?e.len:e.pos+t,i=new Ta.com.avast.cloud.webrep.proto.Rule
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return"object"!=typeof e||null===e?"object expected":null!=e.domain&&e.hasOwnProperty("domain")&&!_a.isString(e.domain)?"domain: string expected":null!=e.url&&e.hasOwnProperty("url")&&!_a.isString(e.url)?"url: string expected":null!=e.ignore&&e.hasOwnProperty("ignore")&&!_a.isString(e.ignore)?"ignore: string expected":null!=e.style&&e.hasOwnProperty("style")&&!_a.isString(e.style)?"style: string expected":null
},
e.fromObject=function(e){
if(e instanceof Ta.com.avast.cloud.webrep.proto.Rule){
return e
}
let t=new Ta.com.avast.cloud.webrep.proto.Rule
...
})(),Sa.Reader),Ra=Sa.Writer,Ca=Sa.util,xa=Sa.roots.default||(Sa.roots.default={})
xa.BrowserType=function(){
const e={},t=Object.create(e)
return t[e[0]="INVALID"]=0,t[e[1]="IE"]=1,t[e[2]="FIREFOX"]=2,t[e[3]="CHROME"]=3,
t[e[4]="OPERA"]=4,
t[e[5]="SAFARI"]=5,t[e[6]="EDGE"]=6,t[e[7]="CHROMIUMEDGE"]=7,t
}(),xa.CommandType=function(){
const e={},t=Object.create(e)
...
return e.prototype.type=1,e.prototype.params=Ca.emptyArray,e.prototype.browser=0,
e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Ra.create()),null!=e.type&&e.hasOwnProperty("type")&&t.uint32(8).int32(e.type),
...
e instanceof Ia||(e=Ia.create(e))
let n=void 0===t?e.len:e.pos+t,i=new xa.LocalServerCommandRequest
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
return e instanceof Ia||(e=new Ia(e)),this.decode(e,e.uint32())
},e.verify=function(e){
if("object"!=typeof e||null===e){
return"object expected"
}
...
if(!(e.params[t]&&"number"==typeof e.params[t].length||Ca.isString(e.params[t]))){
...
if(e instanceof xa.LocalServerCommandRequest){
return e
}
let t=new xa.LocalServerCommandRequest
switch(e.type){
case"ACKNOWLEDGEMENT":
case 1:
t.type=1
...
t.params=[]
for(let n=0;n<e.params.length;++n){
"string"==typeof e.params[n]?Ca.base64.decode(e.params[n],t.params[n]=Ca.newBuffer(Ca.base64.length(e.params[n])),0):e.params[n].length&&(t.params[n]=e.params[n])
}
}
switch(e.browser){
case"INVALID":
...
null!=e.type&&e.hasOwnProperty("type")&&(n.type=t.enums===String?xa.CommandType[e.type]:e.type),
e.params&&e.params.length){
n.params=[]
for(let i=0;i<e.params.length;++i){
n.params[i]=t.bytes===String?Ca.base64.encode(e.params[i],0,e.params[i].length):t.bytes===Array?Array.prototype.slice.call(e.params[i]):e.params[i]
}
}
return null!=e.browser&&e.hasOwnProperty("browser")&&(n.browser=t.enums===String?xa.BrowserType[e.browser]:e.browser),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
})(),xa.LocalServerCommandResponse=(()=>{
function e(e){
if(this.result=[],e){
for(let t=Object.keys(e),n=0;n<t.length;++n){
null!=e[t[n]]&&(this[t[n]]=e[t[n]])
...
return e.prototype.result=Ca.emptyArray,e.prototype.error=Ca.newBuffer([]),e.create=function(t){
return new e(t)
},e.encode=function(e,t){
if(t||(t=Ra.create()),null!=e.result&&e.result.length){
...
e instanceof Ia||(e=Ia.create(e))
let n=void 0===t?e.len:e.pos+t,i=new xa.LocalServerCommandResponse
for(;e.pos<n;){
let t=e.uint32()
switch(t>>>3){
case 1:
...
if(!(e.result[t]&&"number"==typeof e.result[t].length||Ca.isString(e.result[t]))){
return"result: buffer[] expected"
}
}
}
return null!=e.error&&e.hasOwnProperty("error")&&!(e.error&&"number"==typeof e.error.length||Ca.isString(e.error))?"error: buffer expected":null
},
e.fromObject=function(e){
if(e instanceof xa.LocalServerCommandResponse){
return e
}
let t=new xa.LocalServerCommandResponse
if(e.result){
if(!Array.isArray(e.result)){
...
t.result=[]
for(let n=0;n<e.result.length;++n){
"string"==typeof e.result[n]?Ca.base64.decode(e.result[n],t.result[n]=Ca.newBuffer(Ca.base64.length(e.result[n])),0):e.result[n].length&&(t.result[n]=e.result[n])
}
}
return null!=e.error&&("string"==typeof e.error?Ca.base64.decode(e.error,t.error=Ca.newBuffer(Ca.base64.length(e.error)),0):e.error.length&&(t.error=e.error)),
t
},e.toObject=function(e,t){
t||(t={})
let n={}
if((t.arrays||t.defaults)&&(n.result=[]),t.defaults&&(t.bytes===String?n.error="":(n.error=[],
t.bytes!==Array&&(n.error=Ca.newBuffer(n.error)))),
e.result&&e.result.length){
n.result=[]
for(let i=0;i<e.result.length;++i){
n.result[i]=t.bytes===String?Ca.base64.encode(e.result[i],0,e.result[i].length):t.bytes===Array?Array.prototype.slice.call(e.result[i]):e.result[i]
}
}
return null!=e.error&&e.hasOwnProperty("error")&&(n.error=t.bytes===String?Ca.base64.encode(e.error,0,e.error.length):t.bytes===Array?Array.prototype.slice.call(e.error):e.error),
n
},e.prototype.toJSON=function(){
return this.constructor.toObject(this,Sa.util.toJSONOptions)
},e
})()
var Na=n(21),Pa=n(22),La=n.n(Pa)
...
this.tabs=new Ji(t),this.windows=new Zi(t),this.webNavigation=new Xi(t),
this.webRequest=new $i(t)
}
}(chrome),Da=new class extends class{
constructor(){
...
STORE_URL:'https://chrome.google.com/webstore/detail/avg-online-security/nbmoafcmbajniiapeidgficgifbfmjfo?utm_source=extension&utm_medium=nps&utm_campaign=AOS'
},this.CONFIG={
ENABLE_SERP:!0,
ENABLE_SERP_POPUP:!0,
URL_CONSENT:null,
...
OS_VERSION:"0",
FEEDBACK_URL:null,
ADVERTISERS_LEARN_MORE_URL:null,
FEEDBACK_RESET:0,
FEEDBACK_CLICKED:0,
INSTALL_DATE:0
},this.get=this.throttle(this.getUrlInfo,this.DEFAULTS.THROTTLE),this.Browser={},
this.WRCUrlInfo=Se,
this.Utils=new Ie(this),this.Cache=new Ee(this),this.TabReqCache=new Oe,
this.Queue=new _e,
...
return function(){
var u=new Date,c=t-(u-r)
return n=this,i=arguments,c<=0?(clearTimeout(a),a=null,r=u,o=e.apply(n,i)):a||(a=setTimeout(s,c)),
o
}
}
}(za)
Da.DEFAULTS.BRAND="AVG",Da.DEFAULTS.BRAND_NAME="AVG",Da.DEFAULTS.PHISHING_REDIRECT="https://www.avg.com?utm_source=OnlineSecurity&utm_medium=redirect&utm_campaign=avg",
Da.PHISHING_REDIRECT=Da.DEFAULTS.PHISHING_REDIRECT,
Da.AVAST_UPGRADE_PAGE_URL="http://aos.avast.com/upgrade/",
Da.proto={
UrlInfo:Ta.com.avast.cloud.webrep.proto,
AV:xa
}
const Ba=new class extends class{
init(){}
sendHB(){}
...
init(){
const e=aa.a.create(Object.assign({},ra.a)),t=this._getBurgerOptions(),n=this._getBurgerServer()
this.client=new na.a(n,e,t)
}
_getBurgerServer(){
...
advertisersStartScan(){
this.AvastWRC.Advertisers.startScan()
}
advertisersStartOptOut(){
this.AvastWRC.Advertisers.startOptOut()
}
advertisersTryAgain(){
this.AvastWRC.Advertisers.stopScan(),this.AvastWRC.Advertisers.startScan()
}
advertisersSelectOneForOptOut({title:e,value:t}){
this.AvastWRC.Advertisers.advertisersSelectOneForOptOut({
title:e,
value:t
})
}
advertisersSelectAllForOptOut(){
this.AvastWRC.Advertisers.advertisersSelectAllForOptOut()
}
advertisersSettingsAutoScanChanged(e){
this.AvastWRC.Advertisers.advertisersSettingsAutoScanChanged(e)
}
advertisersOpenLearnMore(){
const e=this.AvastWRC.CONFIG.ADVERTISERS_LEARN_MORE_URL
e&&this.AvastWRC.bs.openInNewTab(e)
}
settingReset(){
...
}(Da,Ba),Da.bal.secureBrowser=new class{
constructor(e){
...
return t&&n
}).then(e=>e?(this.isAvailable=!0,ea.forEach(this.bankRules.add,this.bankRules),
...
}(Da),Da.bs=new class extends class{
constructor(e){
...
openHiddenWindow(e,t){
const n=this.AvastWRC.Utils.getBrowserInfo().isWindows(),i=this.AvastWRC.Utils.getBrowserInfo().isFirefox(),a={
type:"normal"
},o={
...a,
left:1e7,
...
i||(o.focused=!1),this.Api.windows.create({
...n?o:r,
...e
},e=>{
n&&this.Api.windows.update(e.id,{
state:"minimized"
}),t(e)
})
}
}(Da),Da.bs.icon=new class{
constructor(e){
...
}(Da),Da.panelbl=new class{
constructor(e){
this.AvastWRC=e,this.Api=this.AvastWRC.Api,this._tabPanelHandlers={},
this.activeSidebarTabId=void 0
}
init(){
this.Api.tabs.onActivated.addListener(e=>{
const t=e.windowId,n=e.tabId
for(let e in this._tabPanelHandlers){
n!==e&&t===this._tabPanelHandlers[e].windowId&&this._tabPanelHandlers[e].viewClose(!0)
}
})
}
registerModuleListeners(e){
e.on("message.iframeReady",(e,t)=>{
const n=new Qi(this.AvastWRC,{
tabId:t.id,
url:t.url,
windowId:t.windowId
})
...
n&&n.messageHandler("panelOpening"),this.activeSidebarTabId=t.id
}),e.on("message.sidebarHide",(e,t)=>{
const n=this._tabPanelHandlers[t.id]
n&&n.messageHandler("panelClosing"),this.activeSidebarTabId=void 0
...
}(Da,Na,La.a),Da.Advertisers=new class{
constructor(e,t=ca){
this.AvastWRC=e,this.Api=this.AvastWRC.Api,this.Api.runtime.onMessage.addListener(this.onMessage.bind(this)),
this.runs=[],
this.settings={
...t
},this.advertiserScenarios=[],this.startAutomaticOptOutTimer(),this.getInitialState()
}
registerModuleListeners(e){
e.on("shepherd.updated",e=>{
this.advertiserScenarios=e&&e.advertisers&&e.advertisers.scenarios||[]
})
}
onMessage(e,t,n){
if("scraperWindowRequireData"===e.message&&n({
loadingMessage:this.resolveLoadingMessage(),
brand:this.AvastWRC.DEFAULTS.BRAND
}),"scraperScenarioData"===e.message){
const e=this.lastRun()
n({
scenario:e.state===ma?e.currentAdvertiser.optOutScenario:e.currentAdvertiser.getScenario
})
}
"scraperLog"===e.message&&e.data.message.includes("actions left upon unload")&&this.lastRun().finishScenario(),
"scraperData"===e.message&&this.lastRun().parseScrape(e.data.isOptedOut),
"scraperFinished"===e.message&&this.lastRun().finishScenario()
}
async getInitialState(){
const e=await(t=this.AvastWRC,new Promise(e=>t.getStorage(["aos.advertisers.autoOptOutSettings"],e)))
var t
null!=e&&(this.settings.autoOptOut=e)
const n=await(e=>new Promise(t=>e.getStorage(["aos.advertisers.run"],t)))(this.AvastWRC)
n&&n.state!==ga&&(this.runs.push(Aa.fromSavedRun(this.AvastWRC,this.advertiserScenarios,n)),
this.lastRun().emitNewState())
}
startScan(){
this.runs.push(new Aa(this.AvastWRC,this.advertiserScenarios)),this.lastRun().runGet()
}
startOptOut(){
this.lastRun().runOptOut()
}
advertisersSelectOneForOptOut({title:e,value:t}){
this.lastRun().selectOneForOptOut({
title:e,
value:t
})
}
advertisersSelectAllForOptOut(){
this.lastRun().selectAllForOptOut()
}
resolveLoadingMessage(){
return this.lastRun()&&this.lastRun().state===da?this.AvastWRC.localization.localizeString("background.advertisers.runningAct.description",[this.AvastWRC.DEFAULTS.BRAND_NAME]):this.AvastWRC.localization.localizeString("background.advertisers.runningGet.description",[this.AvastWRC.DEFAULTS.BRAND_NAME])
}
advertisersSettingsAutoScanChanged(e){
this.settings.autoOptOut=e,((e,t)=>{
e.setStorage("aos.advertisers.autoOptOutSettings",t)
})(this.AvastWRC,e),va(this.AvastWRC)
}
stopScan(){
this.lastRun().stopScan()
}
startAutomaticOptOutTimer(){
setTimeout(this.startAutomaticOptOut.bind(this),this.settings.autoOptOutCheckInterval)
}
async startAutomaticOptOut(){
this.startAutomaticOptOutTimer()
const e=await wa(this.AvastWRC,this.settings.autoOptOutInterval),t=!!this.lastRun()&&this.lastRun().state!==ha,n=0===this.runs.length
if(!this.settings.autoOptOut||!this.settings.autoOptOutInterval||n||!e||t){
return
}
const i=this.lastRun()
va(this.AvastWRC),this.runs.push(new Aa(this.AvastWRC,this.advertiserScenarios)),
await this.lastRun().startAutoOptOut(i.brokers)
}
lastRun(){
return this.runs.length>0?this.runs[this.runs.length-1]:null
}
injectScraper(e){
this.Api.tabs.executeScript(e.tab.id,{
file:"scripts/contentAdvertisersScraper.js",
runAt:"document_end"
})
}
}(Da),Da.heartbeat=new class{
constructor(e,t={}){
...
}(Da,Ba),Da.bs.webshield=new class{
constructor(e,t={}){
...
let c=!1
if(r&&"main_frame"===t.type?c=!0:!s||"main_frame"===t.type||"text/html"!==t.contentType&&"application/json"!==t.contentType?u&&"main_frame"!==t.type&&"text/html"!==t.contentType&&"application/json"!==t.contentType&&(c=!0):c=!0,
c){
const e={
url:n,
...
}(Da,Ba),Da.bal.registerModule(Da.bal.search),Da.bal.registerModule(Da.bal.aos),
Da.bal.registerModule(Da.bal.secureBrowser),
Da.bal.registerModule(Da.bal.DNT),Da.bal.registerModule(Da.bal.NPS),
Da.bal.registerModule(Da.tracking),
Da.bal.registerModule(Da.Shepherd),Da.bal.registerModule(Da.bs),
Da.bal.registerModule(Da.bs.icon),
Da.bal.registerModule(Da.bs.webshield),Da.bal.registerModule(Da.bs.aos),
Da.bal.registerModule(Da.panelbl),
Da.bal.registerModule(Ba),Da.bal.registerModule(Da.Voting),
Da.bal.registerModule(Da.heartbeat),
Da.bal.registerModule(Da.Advertisers),Da.init(Da.bs.EDITIONS_CONFIG.callerId),
Da.bal.init(Da.bs.EDITIONS_CONFIG)
}])
