...
const b=v("slot,component",!0),h=v("key,ref,slot,slot-scope,is")
function y(e,t){
if(e.length){
const a=e.indexOf(t)
if(a>-1){
...
const q=["component","directive","filter"],E=["beforeCreate","created","beforeMount","mounted","beforeUpdate","updated","beforeDestroy","destroyed","activated","deactivated","errorCaptured","serverPrefetch"]
var D={
...
const V=new RegExp(`[^${M.source}.$_\\d]`)
const I="__proto__"in{},F="undefined"!=typeof window,H="undefined"!=typeof WXEnvironment&&!!WXEnvironment.platform,K=H&&WXEnvironment.platform.toLowerCase(),Z=F&&window.navigator.userAgent.toLowerCase(),J=Z&&/msie|trident/.test(Z),Y=Z&&Z.indexOf("msie 9.0")>0,Q=Z&&Z.indexOf("edge/")>0,X=(Z&&Z.indexOf("android"),
Z&&/iphone|ipad|ipod|ios/.test(Z)||"ios"===K),ee=(Z&&/chrome\/\d+/.test(Z),
Z&&/phantomjs/.test(Z),
Z&&Z.match(/firefox\/(\d+)/)),te={}.watch
let ae,ie=!1
if(F){
try{
const e={}
...
ae),ne=F&&window.__VUE_DEVTOOLS_GLOBAL_HOOK__
function oe(e){
return"function"==typeof e&&/native code/.test(e.toString())
}
const re="undefined"!=typeof Symbol&&oe(Symbol)&&"undefined"!=typeof Reflect&&oe(Reflect.ownKeys)
let le
le="undefined"!=typeof Set&&oe(Set)?Set:class{
constructor(){
...
return(s?`<${a(s)}>`:"<Anonymous>")+(n&&!1!==t?" at "+n:"")
}
const i=(e,t)=>{
let a=""
for(;t;){
...
function je(e){
const t=new he(e.tag,e.data,e.children&&e.children.slice(),e.text,e.elm,e.context,e.componentOptions,e.asyncFactory)
...
return n&&s.observeArray(n),s.dep.notify(),i
}))
}))
...
class _e{
constructor(e){
this.value=e,this.dep=new me,this.vmCount=0,G(e,"__ob__",this),Array.isArray(e)?(I?function(e,t){
e.__proto__=t
}(e,Ae):function(e,t,a){
...
const n=new me,o=Object.getOwnPropertyDescriptor(e,t)
if(o&&!1===o.configurable){
return
}
const r=o&&o.get,l=o&&o.set
...
return me.target&&(n.depend(),c&&(c.dep.depend(),Array.isArray(t)&&Pe(t))),t
},
set:function(t){
const o=r?r.call(e):a
t===o||t!=t&&o!=o||(i&&i(),r&&!l||(l?l.call(e,t):a=t,c=!s&&Te(t),n.notify()))
}
})
}
function xe(e,t,a){
if((i(e)||o(e))&&ce("Cannot set reactive property on undefined, null, or primitive value: "+e),
Array.isArray(e)&&p(t)){
...
function Ce(e,t){
if((i(e)||o(e))&&ce("Cannot delete reactive property on undefined, null, or primitive value: "+e),
Array.isArray(e)&&p(t)){
...
let a,i,s
const n=re?Reflect.ownKeys(t):Object.keys(t)
for(let o=0;o<n.length;o++){
a=n[o],"__ob__"!==a&&(i=e[a],s=t[a],j(e,a)?i!==s&&u(i)&&u(s)&&Ne(i,s):xe(e,a,s))
}
return e
}
function We(e,t,a){
...
(b(e)||D.isReservedTag(e))&&ce("Do not use built-in or reserved HTML elements as component id: "+e)
}
function De(e,t,a){
...
if(Array.isArray(a)){
for(s=a.length;s--;){
n=a[s],"string"==typeof n?(o=z(n),i[o]={
type:null
}):ce("props must be strings when using array syntax.")
}
}else if(u(a)){
for(const e in a){
n=a[e],o=z(e),i[o]=u(n)?n:{
type:n
}
}
}else{
...
const Ve=/^(String|Number|Boolean|Function|Symbol)$/
function Ie(e,t){
let a
const i=Fe(t)
if(Ve.test(i)){
...
let n
try{
n=a?e.apply(t,a):e.call(t),n&&!n._isVue&&g(n)&&!n._handled&&(n.catch(e=>Ye(e,i,s+" (Promise/async)")),
n._handled=!0)
}catch(e){
Ye(e,i,s)
}
...
}else if(J||"undefined"==typeof MutationObserver||!oe(MutationObserver)&&"[object MutationObserverConstructor]"!==MutationObserver.toString()){
it=void 0!==e&&oe(e)?()=>{
e(lt)
}:()=>{
setTimeout(lt,0)
...
e&&e.mark&&e.measure&&e.clearMarks&&e.clearMeasures&&(st=t=>e.mark(t),nt=(t,a,i)=>{
e.measure(t,a,i),
e.clearMarks(a),e.clearMarks(i)
})
}
{
const e=v("Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,require"),t=(e,t)=>{
...
},i="undefined"!=typeof Proxy&&oe(Proxy)
if(i){
const e=v("stop,prevent,self,ctrl,shift,alt,meta,exact")
...
const s={
has(i,s){
const n=s in i,o=e(s)||"string"==typeof s&&"_"===s.charAt(0)&&!(s in i.$data)
return n||o||(s in i.$data?a(i,s):t(i,s)),n||!o
}
},n={
...
ot=function(e){
if(i){
const t=e.$options,a=t.render&&t.render._withStripped?n:s
...
if(!n&&!r(t)||Object.isFrozen(t)||t instanceof he){
return
}
if(t.__ob__){
...
const r=e[t]
function l(){
a.apply(this,arguments),y(o.fns,l)
}
i(r)?o=gt([l]):s(r.fns)&&n(r.merged)?(o=r,o.fns.push(l)):o=gt([r,l]),o.merged=!0,
e[t]=o
}
function vt(e,t,a,i,n){
if(s(t)){
if(j(t,a)){
return e[a]=t[a],n||delete t[a],!0
}
if(j(t,i)){
return e[a]=t[i],n||delete t[i],!0
}
}
return!1
}
function bt(e){
return o(e)?[fe(e)]:Array.isArray(e)?function e(t,a){
const r=[]
let l,c,u,d
for(l=0;l<t.length;l++){
c=t[l],i(c)||"boolean"==typeof c||(u=r.length-1,d=r[u],Array.isArray(c)?c.length>0&&(c=e(c,`${a||""}_${l}`),
ht(c[0])&&ht(d)&&(r[u]=fe(d.text+c[0].text),
c.shift()),r.push.apply(r,c)):o(c)?ht(d)?r[u]=fe(d.text+c):""!==c&&r.push(fe(c)):ht(c)&&ht(d)?r[u]=fe(d.text+c.text):(n(t._isVList)&&s(c.tag)&&i(c.key)&&s(a)&&(c.key=`__vlist${a}_${l}__`),
r.push(c)))
}
return r
}(e):void 0
...
let r=t
for(;r;){
if(r._provided&&j(r._provided,o)){
a[n]=r._provided[o]
break
}
r=r.$parent
...
if("default"in e[n]){
const i=e[n].default
a[n]="function"==typeof i?i.call(t):i
}else{
ce(`Injection "${n}" not found`,t)
}
}
}
return a
...
const s=e[i],n=s.data
if(n&&n.attrs&&n.attrs.slot&&delete n.attrs.slot,s.context!==t&&s.fnContext!==t||!n||null==n.slot){
(a.default||(a.default=[])).push(s)
}else{
const e=n.slot,t=a[e]||(a[e]=[])
...
function wt(e,t,i){
let s
const n=Object.keys(t).length>0,o=e?!!e.$stable:!n,r=e&&e.$key
if(e){
if(e._normalized){
return e._normalized
}
if(o&&i&&i!==a&&r===i.$key&&!n&&!i.$hasNormal){
return i
}
s={}
for(const a in e){
...
return e&&Object.isExtensible(e)&&(e._normalized=s),G(s,"$stable",o),G(s,"$key",r),
G(s,"$hasNormal",n),
s
}
function At(e,t,a){
...
for(a=new Array(e.length),i=0,n=e.length;i<n;i++){
a[i]=t(e[i],i)
}
...
for(o=Object.keys(e),a=new Array(o.length),i=0,n=o.length;i<n;i++){
l=o[i],a[i]=t(e[l],l,i)
}
}
}
...
let n
s?(a=a||{},i&&(r(i)||ce("slot v-bind without argument expects an Object",this),a=x(x({},i),a)),
n=s(a)||t):n=this.$slots[e]||t
const o=a&&a.slot
...
const n=D.keyCodes[t]||a
return s&&i&&!D.keyCodes[t]?Tt(s,i):n?Tt(n,e):i?_(i)!==t:void 0
}
...
n=i||D.mustUseProp(t,a,o)?e.domProps||(e.domProps={}):e.attrs||(e.attrs={})
}
const r=z(o),l=_(o)
if(!(r in n)&&!(l in n)&&(n[o]=a[o],s)){
...
for(let i=0;i<e.length;i++){
const s=e[i]
Array.isArray(s)?Rt(s,t,a):s&&(s.proxy&&(s.fn.proxy=!0),t[s.key]=s.fn)
}
return i&&(t.$key=i),t
}
function $t(e,t){
...
function Et(e){
e._o=Pt,e._n=k,e._s=m,e._l=St,e._t=Bt,e._q=W,e._i=R,e._m=Ct,e._f=_t,
e._k=Ot,e._b=xt,
e._v=fe,e._e=ye,e._u=Rt,e._g=Wt,e._d=$t,e._p=qt
}
function Dt(e,t,i,s,o){
const r=o.options
let l
j(s,"_uid")?(l=Object.create(s),l._original=s):(l=s,s=s._original)
const c=n(r._compiled),u=!c
...
const n=Ht(l,e,t,a,i,u)
return n&&!Array.isArray(n)&&(n.fnScopeId=r._scopeId,n.fnContext=s),n
}:this._c=(e,t,a,i)=>Ht(l,e,t,a,i,u)
}
function Mt(e,t,a,i,s){
const n=je(e)
return n.fnContext=a,n.fnOptions=i,(n.devtoolsMeta=n.devtoolsMeta||{}).renderContext=s,
...
!function(e,t,i,s,n){
sa=!0
const o=s.data.scopedSlots,r=e.$scopedSlots,l=!!(o&&!o.$stable||r!==a&&!r.$stable||o&&e.$scopedSlots.$key!==o.$key),c=!!(n||e.$options._renderChildren||l)
e.$options._parentVnode=s,e.$vnode=s,e._vnode&&(e._vnode.parent=s)
if(e.$options._renderChildren=n,e.$attrs=s.data.attrs||a,e.$listeners=i||a,t&&e.$options.props){
Be(!1)
const a=e._props,i=e.$options._propKeys||[]
for(let s=0;s<i.length;s++){
const n=i[s],o=e.$options.props
a[n]=Ge(n,o,t,e)
}
...
e.$options._parentListeners=i,aa(e,i,u),c&&(e.$slots=ft(n,s.context),e.$forceUpdate())
sa=!1
...
function It(e,t,o,l,c){
if(i(e)){
return
}
const u=o.$options._base
if(r(e)&&(e=u.extend(e)),"function"!=typeof e){
return void ce("Invalid Component definition: "+String(e),o)
}
let d
if(i(e.cid)&&(d=e,void 0===(e=function(e,t){
if(n(e.error)&&s(e.errorComp)){
return e.errorComp
}
if(s(e.resolved)){
return e.resolved
...
if(n(e.loading)&&s(e.loadingComp)){
return e.loadingComp
}
if(a&&!s(e.owners)){
const n=e.owners=[a]
let o=!0,l=null,c=null
a.$on("hook:destroyed",()=>y(n,a))
const u=e=>{
...
e.resolved=Jt(a,t),o?n.length=0:u(!0)
}),p=$(t=>{
...
s(m.error)&&(e.errorComp=Jt(m.error,t)),
s(m.loading)&&(e.loadingComp=Jt(m.loading,t),
...
t=t||{},xa(e),s(t.model)&&function(e,t){
const a=e.model&&e.model.prop||"value",i=e.model&&e.model.event||"input"
;(t.attrs||(t.attrs={}))[a]=t.model.value
const n=t.on||(t.on={}),o=n[i],r=t.model.callback
s(o)?(Array.isArray(o)?-1===o.indexOf(r):o!==r)&&(n[i]=[r].concat(o)):n[i]=r
}(e.options,t)
...
const u=new Dt(i,l,o,n,e),d=r.render.call(null,u._c,u)
if(d instanceof he){
...
const a=Vt[e],i=t[a],s=Gt[a]
i===s||i&&i._merged||(t[a]=i?Ft(s,i):s)
}
}(t)
const k=e.options.name||c
return new he(`vue-component-${e.cid}${k?"-"+k:""}`,t,void 0,void 0,void 0,o,{
Ctor:e,
propsData:p,
listeners:m,
tag:c,
...
return(Array.isArray(a)||o(a))&&(c=l,l=a,a=void 0),n(u)&&(c=2),
function(e,t,a,l,c){
if(s(a)&&s(a.__ob__)){
...
s(a)&&s(a.key)&&!o(a.key)&&ce("Avoid using non-primitive value as key, use string/number value instead.",e)
Array.isArray(l)&&"function"==typeof l[0]&&((a=a||{}).scopedSlots={
default:l[0]
},l.length=0)
2===c?l=bt(l):1===c&&(l=function(e){
for(let t=0;t<e.length;t++){
...
u=new he(D.parsePlatformTagName(t),a,l,void 0,void 0,e)):u=a&&a.pre||!s(i=Ue(e.$options,"components",t))?new he(t,a,l,void 0,void 0,e):It(i,a,e,l,t)
}else{
u=It(t,a,e,l)
}
return Array.isArray(u)?u:s(u)?(s(d)&&function e(t,a,o){
t.ns=a,"foreignObject"===t.tag&&(a=void 0,
o=!0)
if(s(t.children)){
for(let r=0,l=t.children.length;r<l;r++){
const l=t.children[r]
s(l.tag)&&(i(l.ns)||n(o)&&"svg"!==l.tag)&&e(l,a,o)
}
}
}(u,d),s(a)&&function(e){
...
let va=0,ba=Date.now
if(F&&!J){
const e=window.performance
e&&"function"==typeof e.now&&ba()>document.createEvent("Event").timeStamp&&(ba=()=>e.now())
}
function ha(){
let e,t
for(va=ba(),ma=!0,ca.sort((e,t)=>e.id-t.id),ka=0;ka<ca.length;ka++){
if(e=ca[ka],
...
this.deep&&dt(e),be(),this.cleanupDeps()
}
return e
}
addDep(e){
...
const a=e.$options.propsData||{},i=e._props={},s=e.$options._propKeys=[],n=!e.$parent
n||Be(!1)
for(const o in t){
s.push(o)
const r=Ge(o,t,a,e)
{
const t=_(o)
;(h(t)||D.isReservedAttr(t))&&ce(`"${t}" is a reserved attribute and cannot be used as component prop.`,e),
Oe(i,o,r,()=>{
n||sa||ce(`Avoid mutating a prop directly since the value will be overwritten whenever the parent component re-renders. Instead, use a data or computed property based on the prop's value. Prop being mutated: "${o}"`,e)
})
}
o in e||wa(e,"_props",o)
}
Be(!0)
...
for(const s in t){
const n=t[s],o="function"==typeof n?n:n.get
null==o&&ce(`Getter is missing for computed property "${s}".`,e),i||(a[s]=new fa(e,o||P,P,za)),
s in e?s in e.$data?ce(`The computed property "${s}" is already defined in data.`,e):e.$options.props&&s in e.$options.props&&ce(`The computed property "${s}" is already defined as a prop.`,e):Sa(e,s,n)
}
...
i&&x(e.extendOptions,i),t=e.options=Me(a,e.extendOptions),t.name&&(t.components[t.name]=e)
}
}
return t
}
...
const n=e.name||a.options.name
n&&Ee(n)
const o=function(e){
this._init(e)
}
return(o.prototype=Object.create(a.prototype)).constructor=o,o.cid=t++,o.options=Me(a.options,e),
o.super=a,
...
}(o),o.extend=a.extend,o.mixin=a.mixin,o.use=a.use,q.forEach((function(e){
o[e]=a[e]
})),n&&(o.options.components[n]=o),o.superOptions=a.options,o.extendOptions=e,
...
const t=this
let i,s
t._uid=Oa++,D.performance&&st&&(i="vue-perf-start:"+t._uid,s="vue-perf-end:"+t._uid,
st(i)),
...
}(t,e):t.$options=Me(xa(t.constructor),e||{},t),
ot(t),t._self=t,function(e){
const t=e.$options
let a=t.parent
if(a&&!t.abstract){
...
const n=i&&i.data
Oe(e,"$attrs",n&&n.attrs||a,()=>{
!sa&&ce("$attrs is readonly.",e)
},!0),Oe(e,"$listeners",t._parentListeners||a,()=>{
...
if(a){
a=a.length>1?O(a):a
const i=O(arguments,1),s=`event handler for "${e}"`
...
const a=this,i=a.$el,s=a._vnode,n=na(a)
a._vnode=e,a.$el=s?a.__patch__(s,e):a.__patch__(a.$el,e,t,!1),n(),i&&(i.__vue__=null),
a.$el&&(a.$el.__vue__=a),
...
try{
Zt=e,i=t.call(e._renderProxy,e.$createElement)
}catch(t){
...
return Array.isArray(i)&&1===i.length&&(i=i[0]),i instanceof he||(Array.isArray(i)&&ce("Multiple root nodes returned from render function. Render function should return a single root node.",e),
i=ye()),
i.parent=a,i
}
}(Ca)
const $a=[String,RegExp,Array]
var qa={
KeepAlive:{
name:"keep-alive",
abstract:!0,
...
const{cache:n,keys:o}=this,r=null==t.key?a.Ctor.cid+(a.tag?"::"+a.tag:""):t.key
n[r]?(t.componentInstance=n[r].componentInstance,y(o,r),o.push(r)):(n[r]=t,o.push(r),
this.max&&o.length>parseInt(this.max)&&Ra(n,o[0],o,this._vnode)),
t.data.keepAlive=!0
}
return t||e&&e[0]
}
...
mergeOptions:Me,
defineReactive:Oe
},e.set=xe,e.delete=Ce,e.nextTick=ct,e.observable=e=>(Te(e),e),
...
q.forEach(t=>{
e[t]=function(e,a){
return a?("component"===t&&Ee(e),"component"===t&&u(a)&&(a.name=a.name||e,
...
const Ea=v("style,class"),Da=v("input,textarea,option,select,progress"),Ma=(e,t,a)=>"value"===a&&Da(e)&&"button"!==t||"selected"===a&&"option"===e||"checked"===a&&"input"===e||"muted"===a&&"video"===e,Ua=v("contenteditable,draggable,spellcheck"),Ga=v("events,caret,typing,plaintext-only"),Va=v("allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,default,defaultchecked,defaultmuted,defaultselected,defer,disabled,enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,required,reversed,scoped,seamless,selected,sortable,translate,truespeed,typemustmatch,visible"),Ia="http://www.w3.org/1999/xlink",Fa=e=>":"===e.charAt(5)&&"xlink"===e.slice(0,5),Ha=e=>Fa(e)?e.slice(6,e.length):"",Ka=e=>null==e||!1===e
function Za(e){
let t=e.data,a=e,i=e
for(;s(i.componentInstance);){
i=i.componentInstance._vnode,i&&i.data&&(t=Ja(i.data,t))
}
for(;s(a=a.parent);){
a&&a.data&&(t=Ja(t,a.data))
}
return function(e,t){
if(s(e)||s(t)){
return Ya(e,Qa(t))
...
const i=e.context,n=e.componentInstance||e.elm,o=i.$refs
t?Array.isArray(o[a])?y(o[a],n):o[a]===n&&(o[a]=void 0):e.data.refInFor?Array.isArray(o[a])?o[a].indexOf(n)<0&&o[a].push(n):o[a]=[n]:o[a]=n
}
const ui=new he("",{},[]),di=["create","activate","update","remove","destroy"]
function pi(e,t){
...
let a
const i=s(a=e.data)&&s(a=a.attrs)&&a.type,n=s(a=t.data)&&s(a=a.attrs)&&a.type
return i===n||ni(i)&&ni(n)
...
const a=e===ui,i=t===ui,s=bi(e.data.directives,e.context),n=bi(t.data.directives,t.context),o=[],r=[]
let l,c,u
for(l in n){
c=s[l],u=n[l],c?(u.oldValue=c.value,u.oldArg=c.arg,yi(u,"update",t,e),
u.def&&u.def.componentUpdated&&r.push(u)):(yi(u,"bind",t,e),
u.def&&u.def.inserted&&o.push(u))
}
if(o.length){
const i=()=>{
...
s=e[i],s.modifiers||(s.modifiers=vi),a[hi(s)]=s,s.def=Ue(t.$options,"directives",s.name,!0)
}
return a
}
function hi(e){
...
let u=t.data.attrs||{}
for(n in s(u.__ob__)&&(u=t.data.attrs=x({},u)),u){
o=u[n],r=c[n],r!==o&&wi(l,n,o)
}
for(n in(J||Q)&&u.value!==c.value&&wi(l,"value",u.value),c){
i(u[n])&&(Fa(n)?l.removeAttributeNS(Ia,Ha(n)):Ua(n)||l.removeAttribute(n))
}
}
function wi(e,t,a){
e.tagName.indexOf("-")>-1?Ai(e,t,a):Va(t)?Ka(a)?e.removeAttribute(t):(a="allowfullscreen"===t&&"EMBED"===e.tagName?"true":t,
e.setAttribute(t,a)):Ua(t)?e.setAttribute(t,((e,t)=>Ka(t)||"false"===t?"false":"contenteditable"===e&&Ga(t)?t:"true")(t,a)):Fa(t)?Ka(a)?e.removeAttributeNS(Ia,Ha(t)):e.setAttributeNS(Ia,t,a):Ai(e,t,a)
}
function Ai(e,t,a){
if(Ka(a)){
e.removeAttribute(t)
}else{
if(J&&!Y&&"TEXTAREA"===e.tagName&&"placeholder"===t&&""!==a&&!e.__ieph){
const t=a=>{
...
function Si(e,t){
const a=t.elm,n=t.data,o=e.data
...
const _i=/[\w).+\-_$\]]/
function Ti(e){
let t,a,i,s,n,o=!1,r=!1,l=!1,c=!1,u=0,d=0,p=0,g=0
for(i=0;i<e.length;i++){
if(a=t,t=e.charCodeAt(i),o){
39===t&&92!==a&&(o=!1)
}else if(r){
34===t&&92!==a&&(r=!1)
}else if(l){
...
function m(){
(n||(n=[])).push(e.slice(g,i).trim()),g=i+1
}
if(void 0===s?s=e.slice(0,i).trim():0!==g&&m(),n){
...
function $i(e,t,i,s,n,o,r,l){
let c
s=s||a,o&&s.prevent&&s.passive&&o("passive and prevent can't be used together. Passive handler can't prevent default event.",r),
...
t=Ri("!",t,l)),s.once&&(delete s.once,t=Ri("~",t,l)),
s.passive&&(delete s.passive,
t=Ri("&",t,l)),s.native?(delete s.native,c=e.nativeEvents||(e.nativeEvents={})):c=e.events||(e.events={})
const u=Ui({
value:i.trim(),
dynamic:l
},r)
s!==a&&(u.modifiers=s)
const d=c[t]
Array.isArray(d)?n?d.unshift(u):d.push(u):c[t]=d?n?[u,d]:[d,u]:u,e.plain=!1
}
function qi(e,t){
...
let n="$$v"
s&&(n="(typeof $$v === 'string'? $$v.trim(): $$v)"),i&&(n=`_n(${n})`)
const o=Vi(t,n)
e.model={
value:`(${t})`,
...
function Vi(e,t){
const a=function(e){
if(e=e.trim(),Ii=e.length,e.indexOf("[")<0||e.lastIndexOf("]")<Ii-1){
...
const i=is
return function s(){
const n=t.apply(null,arguments)
null!==n&&rs(e,s,a,i)
}
}
const ns=tt&&!(ee&&Number(ee[1])<=53)
function os(e,t,a,i){
if(ns){
const e=va,a=t
...
const a=t.data.on||{},n=e.data.on||{}
is=t.elm,function(e){
if(s(e.__r)){
const t=J?"change":"input"
e[t]=[].concat(e.__r,e[t]||[]),delete e.__r
}
s(e.__c)&&(e.change=[].concat(e.__c,e.change||[]),delete e.__c)
}(a),mt(a,n,os,rs,ss,t.context),
is=void 0
}
var cs={
create:ls,
...
let a,n
const o=t.elm,r=e.data.domProps||{}
let l=t.data.domProps||{}
for(a in s(l.__ob__)&&(l=t.data.domProps=x({},l)),r){
a in l||(o[a]="")
}
for(a in l){
if(n=l[a],"textContent"===a||"innerHTML"===a){
...
o._value=n
const e=i(n)?"":String(n)
ps(o,e)&&(o.value=e)
}else if("innerHTML"===a&&ti(o.tagName)&&i(o.innerHTML)){
us=us||document.createElement("div"),
us.innerHTML=`<svg>${n}</svg>`
...
const bs=/^--/,hs=/\s*!important$/,ys=(e,t,a)=>{
if(bs.test(t)){
e.style.setProperty(t,a)
}else if(hs.test(a)){
e.style.setProperty(_(t),a.replace(hs,""),"important")
}else{
const i=ws(t)
if(Array.isArray(a)){
for(let t=0,s=a.length;t<s;t++){
...
function As(e,t){
const a=t.data,n=e.data
if(i(a.staticStyle)&&i(a.style)&&i(n.staticStyle)&&i(n.style)){
return
}
let o,r
const l=t.elm,c=n.staticStyle,u=n.normalizedStyle||n.style||{},d=c||u,p=vs(t.data.style)||{}
t.data.normalizedStyle=s(p.__ob__)?x({},p):p
...
t=t.componentInstance._vnode,t&&t.data&&(i=ks(t.data))&&x(a,i)
}
}
(i=ks(e.data))&&x(a,i)
let s=e
for(;s=s.parent;){
s.data&&(i=ks(s.data))&&x(a,i)
}
return a
}(t,!0)
for(r in d){
...
if("object"==typeof e){
const t={}
return!1!==e.css&&x(t,Os(e.name||"v")),x(t,e),t
}
...
xs&&(void 0===window.ontransitionend&&void 0!==window.onwebkittransitionend&&(Cs="WebkitTransition",
...
function Es(e,t,a){
const{type:i,timeout:s,propCount:n}=Ms(e,t)
if(!i){
return a()
}
const o="transition"===i?Ps:Ns
let r=0
const l=()=>{
e.removeEventListener(o,c),a()
},c=t=>{
t.target===e&&++r>=n&&l()
}
setTimeout(()=>{
...
function Ms(e,t){
const a=window.getComputedStyle(e),i=(a[Cs+"Delay"]||"").split(", "),s=(a[Cs+"Duration"]||"").split(", "),n=Us(i,s),o=(a[Ls+"Delay"]||"").split(", "),r=(a[Ls+"Duration"]||"").split(", "),l=Us(o,r)
let c,u=0,d=0
return"transition"===t?n>0&&(c="transition",u=n,d=s.length):"animation"===t?l>0&&(c="animation",
u=l,
d=r.length):(u=Math.max(n,l),c=u>0?n>l?"transition":"animation":null,d=c?"transition"===c?s.length:r.length:0),
{
type:c,
timeout:u,
propCount:d,
...
return Math.max.apply(null,t.map((t,a)=>Gs(t)+Gs(e[a])))
}
function Gs(e){
...
const{css:o,type:l,enterClass:c,enterToClass:u,enterActiveClass:d,appearClass:p,appearToClass:g,appearActiveClass:m,beforeEnter:v,enter:b,afterEnter:h,enterCancelled:y,beforeAppear:f,appear:j,afterAppear:w,appearCancelled:A,duration:z}=n
let S=ia,B=ia.$vnode
for(;B&&B.parent;){
...
const T=_&&p?p:c,O=_&&m?m:d,x=_&&g?g:u,C=_&&f||v,P=_&&"function"==typeof j?j:b,L=_&&w||h,N=_&&A||y,W=k(r(z)?z.enter:z)
null!=W&&Fs(W,"enter",e)
const R=!1!==o&&!Y,q=Ks(P),E=a._enterCb=$(()=>{
R&&(qs(a,x),qs(a,O)),E.cancelled?(R&&qs(a,T),
N&&N(a)):L&&L(a),a._enterCb=null
})
e.data.show||kt(e,"insert",()=>{
const t=a.parentNode,i=t&&t._pending&&t._pending[e.key]
i&&i.tag===e.tag&&i.elm._leaveCb&&i.elm._leaveCb(),P&&P(a,E)
}),C&&C(a),R&&($s(a,T),
$s(a,O),Rs(()=>{
qs(a,T),E.cancelled||($s(a,x),q||(Hs(W)?setTimeout(E,W):Es(a,l,E)))
})),e.data.show&&(t&&t(),
P&&P(a,E)),R||q||E()
}
function Is(e,t){
...
const{css:o,type:l,leaveClass:c,leaveToClass:u,leaveActiveClass:d,beforeLeave:p,leave:g,afterLeave:m,leaveCancelled:v,delayLeave:b,duration:h}=n,y=!1!==o&&!Y,f=Ks(g),j=k(r(h)?h.leave:h)
s(j)&&Fs(j,"leave",e)
const w=a._leaveCb=$(()=>{
a.parentNode&&a.parentNode._pending&&(a.parentNode._pending[e.key]=null),
y&&(qs(a,u),
qs(a,d)),w.cancelled?(y&&qs(a,c),v&&v(a)):(t(),m&&m(a)),a._leaveCb=null
})
function A(){
w.cancelled||(!e.data.show&&a.parentNode&&((a.parentNode._pending||(a.parentNode._pending={}))[e.key]=e),
p&&p(a),
y&&($s(a,c),$s(a,d),Rs(()=>{
qs(a,c),w.cancelled||($s(a,u),f||(Hs(j)?setTimeout(w,j):Es(a,l,w)))
})),g&&g(a,w),
y||f||w())
}
b?b(A):A()
...
let g=0
function m(e,t,a,i,o,l,u){
if(s(e.elm)&&s(l)&&(e=l[u]=je(e)),e.isRootInsert=!o,function(e,t,a,i){
let o=e.data
if(s(o)){
const l=s(e.componentInstance)&&o.keepAlive
if(s(o=o.hook)&&s(o=o.init)&&o(e,!1),s(e.componentInstance)){
return k(e,t),b(a,e.elm,i),
n(l)&&function(e,t,a,i){
let n,o=e
for(;o.componentInstance;){
if(o=o.componentInstance._vnode,s(n=o.data)&&s(n=n.transition)){
...
const d=e.data,m=e.children,v=e.tag
s(v)?(d&&d.pre&&g++,p(e,g)&&ce("Unknown custom element: <"+v+'> - did you register the component correctly? For recursive components, make sure to provide the "name" option.',e.context),
e.elm=e.ns?c.createElementNS(e.ns,v):c.createElement(v,e),
j(e),h(e,m,t),s(d)&&f(e,t),
b(a,e.elm,i),d&&d.pre&&g--):n(e.isComment)?(e.elm=c.createComment(e.text),
b(a,e.elm,i)):(e.elm=c.createTextNode(e.text),
b(a,e.elm,i))
}
function k(e,t){
...
o(e.text)&&c.appendChild(e.elm,c.createTextNode(String(e.text)))
}
}
function y(e){
...
for(let a=0;a<e.length;a++){
const i=e[a],n=i.key
s(n)&&(t[n]?ce(`Duplicate keys detected: '${n}'. This may cause an update error.`,i.context):t[n]=!0)
}
}
function _(e,t,a,i){
for(let n=a;n<i;n++){
...
i(t.text)?s(k)&&s(v)?k!==v&&function(e,t,a,n,o){
let r,l,u,d,p=0,g=0,k=t.length-1,v=t[0],b=t[k],h=a.length-1,y=a[0],f=a[h]
const j=!o
for(B(a);p<=k&&g<=h;){
i(v)?v=t[++p]:i(b)?b=t[--k]:pi(v,y)?(T(v,y,n,a,g),v=t[++p],
y=a[++g]):pi(b,f)?(T(b,f,n,a,h),
b=t[--k],f=a[--h]):pi(v,f)?(T(v,f,n,a,h),j&&c.insertBefore(e,v.elm,c.nextSibling(b.elm)),
v=t[++p],
f=a[--h]):pi(b,y)?(T(b,y,n,a,g),j&&c.insertBefore(e,b.elm,v.elm),b=t[--k],
y=a[++g]):(i(r)&&(r=gi(t,p,k)),
l=s(y.key)?r[y.key]:_(y,t,p,k),i(l)?m(y,n,e,v.elm,!1,a,g):(u=t[l],
pi(u,y)?(T(u,y,n,a,g),
t[l]=void 0,j&&c.insertBefore(e,u.elm,v.elm)):m(y,n,e,v.elm,!1,a,g)),
y=a[++g])
}
p>k?(d=i(a[h+1])?null:a[h+1].elm,w(e,d,a,g,h,n)):g>h&&z(t,p,k)
}(d,k,v,a,u):s(v)?(B(v),
s(e.text)&&c.setTextContent(d,""),w(d,null,v,0,v.length-1,a)):s(k)?z(k,0,k.length-1):s(e.text)&&c.setTextContent(d,""):e.text!==t.text&&c.setTextContent(d,t.text),
...
if(i=i||l&&l.pre,t.elm=e,n(t.isComment)&&s(t.asyncFactory)){
...
if(s(l)&&(s(o=l.hook)&&s(o=o.init)&&o(t,!0),s(o=t.componentInstance))){
return k(t,a),
!0
}
if(s(r)){
...
d=e,e=new he(c.tagName(d).toLowerCase(),{},[],void 0,d)
}
const o=e.elm,l=c.parentNode(o)
if(m(t,u,o._leaveCb?null:l,c.nextSibling(o)),s(t.parent)){
let e=t.parent
const a=y(t)
for(;e;){
...
}):Qs(e,t,a.context),e._vOptions=[].map.call(e.options,tn)):("textarea"===a.tag||ni(e.type))&&(e._vModifiers=t.modifiers,
t.modifiers.lazy||(e.addEventListener("compositionstart",an),
e.addEventListener("compositionend",sn),
e.addEventListener("change",sn),Y&&(e.vmodel=!0)))
},
componentUpdated(e,t,a){
if("select"===a.tag){
Qs(e,t,a.context)
const i=e._vOptions,s=e._vOptions=[].map.call(e.options,tn)
if(s.some((e,t)=>!W(e,i[t]))){
(e.multiple?t.value.some(e=>en(e,s)):t.value!==t.oldValue&&en(t.value,s))&&nn(e,"change")
}
}
}
}
function Qs(e,t,a){
Xs(e,t,a),(J||Q)&&setTimeout(()=>{
Xs(e,t,a)
},0)
}
function Xs(e,t,a){
...
if(o=e.options[t],s){
n=R(i,tn(o))>-1,o.selected!==n&&(o.selected=n)
}else if(W(tn(o),i)){
...
function sn(e){
e.target.composing&&(e.target.composing=!1,nn(e.target,"input"))
}
function nn(e,t){
...
function on(e){
return!e.componentInstance||e.data&&e.data.transition?e:on(e.componentInstance._vnode)
}
var rn={
model:Ys,
show:{
bind(e,{value:t},a){
const i=(a=on(a)).data&&a.data.transition,s=e.__vOriginalDisplay="none"===e.style.display?"":e.style.display
t&&i?(a.data.show=!0,Vs(a,()=>{
e.style.display=s
...
(i=on(i)).data&&i.data.transition?(i.data.show=!0,t?Vs(i,()=>{
...
return t&&t.Ctor.options.abstract?cn(Qt(t.children)):e
}
function un(e){
const t={},a=e.$options
...
const pn=e=>e.tag||Yt(e),gn=e=>"show"===e.name
var mn={
name:"transition",
props:ln,
abstract:!0,
...
const n=`__transition-${this._uid}-`
s.key=null==s.key?s.isComment?n+"comment":n+s.tag:o(s.key)?0===String(s.key).indexOf(n)?s.key:n+s.key:s.key
const r=(s.data||(s.data={})).transition=un(this),l=this._vnode,c=cn(l)
if(s.data.directives&&s.data.directives.some(gn)&&(s.data.show=!0),c&&c.data&&!function(e,t){
return t.key===e.key&&t.tag===e.tag
}(s,c)&&!Yt(c)&&(!c.componentInstance||!c.componentInstance._vnode.isComment)){
const t=c.data.transition=x({},r)
if("out-in"===a){
...
render(e){
const t=this.tag||this.$vnode.data.tag||"span",a=Object.create(null),i=this.prevChildren=this.children,s=this.$slots.default||[],n=this.children=[],o=un(this)
for(let e=0;e<s.length;e++){
const t=s[e]
if(t.tag){
if(null!=t.key&&0!==String(t.key).indexOf("__vlist")){
n.push(t),a[t.key]=t,(t.data||(t.data={})).transition=o
}else{
...
for(let e=0;e<i.length;e++){
const t=i[e]
t.data.transition=o,t.data.pos=t.elm.getBoundingClientRect(),a[t.key]?s.push(t):n.push(t)
}
this.kept=e(t,null,s),this.removed=n
}
return e(t,null,n)
},
updated(){
const e=this.prevChildren,t=this.moveClass||(this.name||"v")+"-move"
e.length&&this.hasMove(e[0].elm,t)&&(e.forEach(vn),e.forEach(bn),e.forEach(hn),this._reflow=document.body.offsetHeight,
e.forEach(e=>{
if(e.data.moved){
const a=e.elm,i=a.style
$s(a,t),i.transform=i.WebkitTransform=i.transitionDuration="",a.addEventListener(Ps,a._moveCb=function e(i){
...
Ca.config.mustUseProp=Ma,Ca.config.isReservedTag=ai,Ca.config.isReservedAttr=Ea,
...
x(Ca.options.directives,rn),x(Ca.options.components,yn),Ca.prototype.__patch__=F?Js:P,
...
la(e,"beforeMount"),
i=D.performance&&st?()=>{
const t=e._name,i=e._uid,s="vue-perf-start:"+i,n="vue-perf-end:"+i
st(s)
const o=e._render()
st(n),nt(`vue ${t} render`,s,n),st(s),e._update(o,a),st(n),nt(`vue ${t} patch`,s,n)
}:()=>{
...
}(this,e=e&&F?oi(e):void 0,t)
},F&&setTimeout(()=>{
D.devtools&&ne&&ne.emit("init",Ca),D.productionTip
},0)
const fn=/\{\{((?:.|\r?\n)+?)\}\}/g,jn=/[-.*+?^${}()|[\]\/\\]/g,wn=w(e=>{
const t=e[0].replace(jn,"\\$&"),a=e[1].replace(jn,"\\$&")
return new RegExp(t+"((?:.|\\n)+?)"+a,"g")
})
function An(e,t){
const a=t?wn(t):fn
...
const i=[],s=[]
let n,o,r,l=a.lastIndex=0
for(;n=a.exec(e);){
o=n.index,o>l&&(s.push(r=e.slice(l,o)),i.push(JSON.stringify(r)))
const t=Ti(n[1].trim())
i.push(`_s(${t})`),s.push({
"@binding":t
}),l=o+n[0].length
...
const a=t.warn||xi,i=Di(e,"class")
if(i){
An(i,t.delimiters)&&a(`class="${i}": Interpolation inside attributes has been removed. Use v-bind or the colon shorthand instead. For example, instead of <div class="{{ val }}">, use <div :class="val">.`,e.rawAttrsMap.class)
}
i&&(e.staticClass=JSON.stringify(i))
const s=Ei(e,"class",!1)
s&&(e.classBinding=s)
},
genData:function(e){
let t=""
...
transformNode:function(e,t){
const a=t.warn||xi,i=Di(e,"style")
if(i){
An(i,t.delimiters)&&a(`style="${i}": Interpolation inside attributes has been removed. Use v-bind or the colon shorthand instead. For example, instead of <div style="{{ val }}">, use <div :style="val">.`,e.rawAttrsMap.style)
e.staticStyle=JSON.stringify(ms(i))
}
const s=Ei(e,"style",!1)
s&&(e.styleBinding=s)
},
genData:function(e){
let t=""
...
let Bn
var _n={
decode:e=>(Bn=Bn||document.createElement("div"),Bn.innerHTML=e,Bn.textContent)
}
const Tn=v("area,base,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wbr"),On=v("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr,source"),xn=v("address,article,aside,base,blockquote,body,caption,col,colgroup,dd,details,dialog,div,dl,dt,fieldset,figcaption,figure,footer,form,h1,h2,h3,h4,h5,h6,head,header,hgroup,hr,html,legend,li,menuitem,meta,optgroup,option,param,rp,rt,source,style,summary,tbody,td,tfoot,th,thead,title,tr,track"),Cn=/^\s*([^\s"'<>\/=]+)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,Pn=/^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/,Ln=`[a-zA-Z_][\\-\\.0-9_a-zA-Z${M.source}]*`,Nn=`((?:${Ln}\\:)?${Ln})`,Wn=new RegExp("^<"+Nn),Rn=/^\s*(\/?)>/,$n=new RegExp(`^<\\/${Nn}[^>]*>`),qn=/^<!DOCTYPE [^>]+>/i,En=/^<!\--/,Dn=/^<!\[/,Mn=v("script,style,textarea",!0),Un={},Gn={
"&lt;":"<",
"&gt;":">",
"&quot;":'"',
"&amp;":"&",
...
"&#9;":"\t",
"&#39;":"'"
},Vn=/&(?:lt|gt|quot|amp|#39);/g,In=/&(?:lt|gt|quot|amp|#39|#10|#9);/g,Fn=v("pre,textarea",!0),Hn=(e,t)=>e&&Fn(e)&&"\n"===t[0]
function Kn(e,t){
const a=t?In:Vn
return e.replace(a,e=>Gn[e])
}
const Zn=/^@|^v-on:/,Jn=/^v-|^@|^:|^#/,Yn=/([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/,Qn=/,([^,\}\]]*)(?:,([^,\}\]]*))?$/,Xn=/^\(|\)$/g,eo=/^\[.*\]$/,to=/:(.*)$/,ao=/^:|^\.|^v-bind:/,io=/\.[^.\]]+(?=[^\]]*$)/g,so=/^v-slot(:|$)|^#/,no=/[\r\n]/,oo=/\s+/g,ro=/[\s"'<>\/=]/,lo=w(_n.decode)
let co,uo,po,go,mo,ko,vo,bo,ho
function yo(e,t,a){
return{
type:1,
tag:e,
...
function fo(e,t){
co=t.warn||xi,ko=t.isPreTag||L,vo=t.mustUseProp||L,bo=t.getTagNamespace||L
const a=t.isReservedTag||L
ho=e=>!!e.component||!a(e.tag),po=Ci(t.modules,"transformNode"),go=Ci(t.modules,"preTransformNode"),
mo=Ci(t.modules,"postTransformNode"),
uo=t.delimiters
const i=[],s=!1!==t.preserveWhitespace,n=t.whitespace
let o,r,l=!1,c=!1,u=!1
function d(e,t){
u||(u=!0,co(e,t))
}
function p(e){
if(g(e),l||e.processed||(e=jo(e,t)),i.length||e===o||(o.if&&(e.elseif||e.else)?(m(e),
Ao(o,{
exp:e.elseif,
block:e
...
" "!==e[t].text&&co(`text "${e[t].text.trim()}" between v-if and v-else(-if) will be ignored.`,e[t]),
e.pop()
}
}(t.children)
a&&a.if?Ao(a,{
exp:e.elseif,
block:e
}):co(`v-${e.elseif?'else-if="'+e.elseif+'"':"else"} used on element <${e.tag}> without corresponding v-if.`,e.rawAttrsMap[e.elseif?"v-else-if":"v-else"])
}(e,r)
}else{
if(e.slotScope){
...
e.children=e.children.filter(e=>!e.slotScope),g(e),e.pre&&(l=!1),ko(e.tag)&&(c=!1)
...
return function(e,t){
const a=[],i=t.expectHTML,s=t.isUnaryTag||L,n=t.canBeLeftOpenTag||L
let o,r,l=0
for(;e;){
if(o=e,r&&Mn(r)){
let a=0
const i=r.toLowerCase(),s=Un[i]||(Un[i]=new RegExp("([\\s\\S]*?)(</"+i+"[^>]*>)","i")),n=e.replace(s,(function(e,s,n){
return a=n.length,
Mn(i)||"noscript"===i||(s=s.replace(/<!\--([\s\S]*?)-->/g,"$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g,"$1")),
Hn(i,s)&&(s=s.slice(1)),
t.chars&&t.chars(s),""
}))
l+=e.length-n.length,e=n,p(i,l-a,l)
}else{
let a,i,s,n=e.indexOf("<")
if(0===n){
if(En.test(e)){
...
const s=u()
if(s){
d(s),Hn(s.tagName,e)&&c(1)
continue
}
}
if(n>=0){
for(i=e.slice(n);!($n.test(i)||Wn.test(i)||En.test(i)||Dn.test(i)||(s=i.indexOf("<",1),
s<0));){
n+=s,i=e.slice(n)
}
a=e.substring(0,n)
}
n<0&&(a=e),a&&c(a.length),t.chars&&a&&t.chars(a,l-a.length,l)
}
if(e===o){
...
let i,s
for(c(t[0].length);!(i=e.match(Rn))&&(s=e.match(Pn)||e.match(Cn));){
...
function d(e){
const o=e.tagName,l=e.unarySlash
i&&("p"===r&&xn(o)&&p(r),n(o)&&r===o&&p(o))
const c=s(o)||!!l,u=e.attrs.length,d=new Array(u)
for(let a=0;a<u;a++){
const i=e.attrs[a],s=i[3]||i[4]||i[5]||"",n="a"===o&&"href"===i[1]?t.shouldDecodeNewlinesForHref:t.shouldDecodeNewlines
d[a]={
name:i[1],
value:Kn(s,n)
...
}),r=o),t.start&&t.start(o,d,c,e.start,e.end)
}
function p(e,i,s){
let n,o
if(null==i&&(i=l),null==s&&(s=l),e){
for(o=e.toLowerCase(),n=a.length-1;n>=0&&a[n].lowerCasedTag!==o;n--){}
}else{
n=0
}
if(n>=0){
for(let o=a.length-1;o>=n;o--){
(o>n||!e&&t.warn)&&t.warn(`tag <${a[o].tag}> has no matching end tag.`,{
start:a[o].start,
end:a[o].end
}),t.end&&t.end(a[o].tag,i,s)
}
a.length=n,r=n&&a[n-1].tag
}else{
"br"===o?t.start&&t.start(e,[],!0,i,s):"p"===o&&(t.start&&t.start(e,[],!1,i,s),
t.end&&t.end(e,i,s))
}
}
p()
...
start(e,a,s,n,u){
const d=r&&r.ns||bo(e)
J&&"svg"===d&&(a=function(e){
const t=[]
for(let a=0;a<e.length;a++){
const i=e[a]
_o.test(i.name)||(i.name=i.name.replace(To,""),t.push(i))
}
return t
}(a))
let g=yo(e,a,r)
var k
d&&(g.ns=d),t.outputSourceRange&&(g.start=n,g.end=u,g.rawAttrsMap=g.attrsList.reduce((e,t)=>(e[t.name]=t,
e),{})),
a.forEach(e=>{
ro.test(e.name)&&co("Invalid dynamic argument expression: attribute names cannot contain spaces, quotes, <, >, / or =.",{
start:e.start+e.name.indexOf("["),
end:e.start+e.name.length
})
}),"style"!==(k=g).tag&&("script"!==k.tag||k.attrsMap.type&&"text/javascript"!==k.attrsMap.type)||se()||(g.forbidden=!0,
co(`Templates should only be responsible for mapping the state to the UI. Avoid placing tags with side-effects in your templates, such as <${e}>, as they will not be parsed.`,{
start:g.start
}))
...
}(g),g.pre&&(l=!0)),ko(g.tag)&&(c=!0),l?function(e){
...
}(g)),o||(o=g,m(o)),s?p(g):(r=g,i.push(g))
},
end(e,a,s){
const n=i[i.length-1]
i.length-=1,r=i[i.length-1],t.outputSourceRange&&(n.end=s),p(n)
},
chars(a,i,o){
if(!r){
...
if(J&&"textarea"===r.tag&&r.attrsMap.placeholder===a){
return
}
const u=r.children
var p
if(a=c||a.trim()?"script"===(p=r).tag||"style"===p.tag?a:lo(a):u.length?n?"condense"===n&&no.test(a)?"":" ":s?" ":"":""){
let e,s
c||"condense"!==n||(a=a.replace(oo," ")),!l&&" "!==a&&(e=An(a,uo))?s={
type:2,
...
type:3,
text:a
}),s&&(t.outputSourceRange&&(s.start=i,s.end=o),u.push(s))
}
},
comment(e,a,i){
if(r){
...
const t=Ei(e,"key")
if(t){
if("template"===e.tag&&co("<template> cannot be keyed. Place the key on real elements instead.",qi(e,"key")),
e.for){
const a=e.iterator2||e.iterator1,i=e.parent
a&&a===t&&i&&"transition-group"===i.tag&&co("Do not use v-for index as key on <transition-group> children, this is the same as not using keys.",qi(e,"key"),!0)
}
e.key=t
}
...
let t
"template"===e.tag?(t=Di(e,"scope"),t&&co('the "scope" attribute for scoped slots have been deprecated and replaced by "slot-scope" since 2.5. The new "slot-scope" attribute can also be used on plain elements in addition to <template> to denote scoped slots.',e.rawAttrsMap.scope,!0),
e.slotScope=t||Di(e,"slot-scope")):(t=Di(e,"slot-scope"))&&(e.attrsMap["v-for"]&&co(`Ambiguous combined usage of slot-scope and v-for on <${e.tag}> (v-for takes higher priority). Use a wrapper <template> for the scoped slot to make it clearer.`,e.rawAttrsMap["slot-scope"],!0),
e.slotScope=t)
const a=Ei(e,"slot")
a&&(e.slotTarget='""'===a?'"default"':a,e.slotTargetDynamic=!(!e.attrsMap[":slot"]&&!e.attrsMap["v-bind:slot"]),
"template"===e.tag||e.slotScope||Li(e,"slot",a,qi(e,"slot")))
if("template"===e.tag){
const t=Mi(e,so)
if(t){
(e.slotTarget||e.slotScope)&&co("Unexpected mixed usage of different slot syntaxes.",e),
e.parent&&!ho(e.parent)&&co("<template v-slot> can only appear at the root level inside the receiving component",e)
const{name:a,dynamic:i}=zo(t)
e.slotTarget=a,e.slotTargetDynamic=i,e.slotScope=t.value||"_empty_"
}
}else{
const t=Mi(e,so)
if(t){
ho(e)||co("v-slot can only be used on components or <template>.",t),(e.slotScope||e.slotTarget)&&co("Unexpected mixed usage of different slot syntaxes.",e),
e.scopedSlots&&co("To avoid scope ambiguity, the default slot should also use <template> syntax when there are other named slots.",t)
const a=e.scopedSlots||(e.scopedSlots={}),{name:i,dynamic:s}=zo(t),n=a[i]=yo("template",[],e)
n.slotTarget=i,n.slotTargetDynamic=s,n.children=e.children.filter(e=>{
if(!e.slotScope){
return e.parent=n,!0
}
}),n.slotScope=t.value||"_empty_",e.children=[],e.plain=!1
}
}
}(e),"slot"===(a=e).tag&&(a.slotName=Ei(a,"name"),a.key&&co("`key` does not work on <slot> because slots are abstract outlets and can possibly expand into multiple elements. Use the key on a wrapping element instead.",qi(a,"key"))),
function(e){
let t
;(t=Ei(e,"is"))&&(e.component=t)
...
if(s=n=t[a].name,o=t[a].value,Jn.test(s)){
if(e.hasBindings=!0,r=So(s.replace(Jn,"")),
r&&(s=s.replace(io,"")),ao.test(s)){
s=s.replace(ao,""),o=Ti(o),c=eo.test(s),c&&(s=s.slice(1,-1)),
0===o.trim().length&&co(`The value for a v-bind expression cannot be empty. Found in "v-bind:${s}"`),
r&&(r.prop&&!c&&(s=z(s),
"innerHtml"===s&&(s="innerHTML")),r.camel&&!c&&(s=z(s)),
r.sync&&(l=Vi(o,"$event"),
c?$i(e,`"update:"+(${s})`,l,null,!1,co,t[a],!0):($i(e,"update:"+z(s),l,null,!1,co,t[a]),
_(s)!==z(s)&&$i(e,"update:"+_(s),l,null,!1,co,t[a])))),
r&&r.prop||!e.component&&vo(e.tag,e.attrsMap.type,s)?Pi(e,s,o,t[a],c):Li(e,s,o,t[a],c)
}else if(Zn.test(s)){
s=s.replace(Zn,""),c=eo.test(s),c&&(s=s.slice(1,-1)),$i(e,s,o,r,!1,co,t[a],c)
}else{
s=s.replace(Jn,"")
const i=s.match(to)
let l=i&&i[1]
c=!1,l&&(s=s.slice(0,-(l.length+1)),eo.test(l)&&(l=l.slice(1,-1),c=!0)),Wi(e,s,n,o,l,c,r,t[a]),
"model"===s&&Oo(e,o)
}
}else{
An(o,uo)&&co(`${s}="${o}": Interpolation inside attributes has been removed. Use v-bind or the colon shorthand instead. For example, instead of <div id="{{ val }}">, use <div :id="val">.`,t[a])
Li(e,s,JSON.stringify(o),t[a]),!e.component&&"muted"===s&&vo(e.tag,e.attrsMap.type,s)&&Pi(e,s,"true",t[a])
}
}
}(e),e
}
...
const a={}
a.for=t[2].trim()
const i=t[1].trim().replace(Xn,""),s=i.match(Qn)
s?(a.alias=i.replace(Qn,"").trim(),a.iterator1=s[1].trim(),s[2]&&(a.iterator2=s[2].trim())):a.alias=i
return a
}(t)
a?x(e,a):co("Invalid v-for expression: "+t,e.rawAttrsMap["v-for"])
}
}
function Ao(e,t){
...
function zo(e){
let t=e.name.replace(so,"")
return t||("#"!==e.name[0]?t="default":co("v-slot shorthand syntax requires a slot name.",e)),
eo.test(t)?{
name:t.slice(1,-1),
dynamic:!0
}:{
...
let i
if((a[":type"]||a["v-bind:type"])&&(i=Ei(e,"type")),a.type||i||!a["v-bind"]||(i=`(${a["v-bind"]}).type`),
i){
const a=Di(e,"v-if",!0),s=a?`&&(${a})`:"",n=null!=Di(e,"v-else",!0),o=Di(e,"v-else-if",!0),r=xo(e)
wo(r),Ni(r,"type","checkbox"),jo(r,t),r.processed=!0,r.if=`(${i})==='checkbox'`+s,
Ao(r,{
exp:r.if,
block:r
})
const l=xo(e)
Di(l,"v-for",!0),Ni(l,"type","radio"),jo(l,t),Ao(r,{
exp:`(${i})==='radio'`+s,
block:l
})
const c=xo(e)
return Di(c,"v-for",!0),Ni(c,":type",i),jo(c,t),Ao(r,{
exp:a,
block:c
}),n?r.else=!0:o&&(r.elseif=o),r
}
}
}
}]
...
Yi=a
const i=t.value,s=t.modifiers,n=e.tag,o=e.attrsMap.type
if("input"===n&&"file"===o&&Yi(`<${e.tag} v-model="${i}" type="file">:\nFile inputs are read only. Use a v-on:change listener instead.`,e.rawAttrsMap["v-model"]),
e.component){
return Gi(e,i,s),!1
}
if("select"===n){
...
i=`${i} ${Vi(t,"$event.target.multiple ? $$selectedVal : $$selectedVal[0]")}`,$i(e,"change",i,null,!0)
}(e,i,s)
}else if("input"===n&&"checkbox"===o){
!function(e,t,a){
const i=a&&a.number,s=Ei(e,"value")||"null",n=Ei(e,"true-value")||"true",o=Ei(e,"false-value")||"false"
Pi(e,"checked",`Array.isArray(${t})?_i(${t},${s})>-1`+("true"===n?`:(${t})`:`:_q(${t},${n})`)),
$i(e,"change",`var $$a=${t},$$el=$event.target,$$c=$$el.checked?(${n}):(${o});if(Array.isArray($$a)){var $$v=${i?"_n("+s+")":s},$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(${Vi(t,"$$a.concat([$$v])")})}else{$$i>-1&&(${Vi(t,"$$a.slice(0,$$i).concat($$a.slice($$i+1))")})}}else{${Vi(t,"$$c")}}`,null,!0)
}(e,i,s)
}else if("input"===n&&"radio"===o){
!function(e,t,a){
const i=a&&a.number
let s=Ei(e,"value")||"null"
s=i?`_n(${s})`:s,Pi(e,"checked",`_q(${t},${s})`),$i(e,"change",Vi(t,s),null,!0)
}(e,i,s)
...
const{lazy:s,number:n,trim:o}=a||{},r=!s&&"range"!==i,l=s?"change":"range"===i?"__r":"input"
let c="$event.target.value"
o&&(c="$event.target.value.trim()")
n&&(c=`_n(${c})`)
let u=Vi(t,c)
r&&(u="if($event.target.composing)return;"+u)
Pi(e,"value",`(${t})`),$i(e,l,u,null,!0),(o||n)&&$i(e,"blur","$forceUpdate()")
}(e,i,s)
}else{
if(!D.isReservedTag(n)){
return Gi(e,i,s),!1
}
...
return!(!e.pre&&(e.hasBindings||e.if||e.for||b(e.tag)||!No(e.tag)||function(e){
for(;e.parent;){
...
if(!No(t.tag)&&"slot"!==t.tag&&null==t.attrsMap["inline-template"]){
return
}
...
const $o=/^([\w$_]+|\([^)]*?\))\s*=>|^function(?:\s+[\w$]+)?\s*\(/,qo=/\([^)]*?\);*$/,Eo=/^[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['[^']*?']|\["[^"]*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*$/,Do={
esc:27,
tab:9,
enter:13,
space:32,
...
if(Array.isArray(e)){
return`[${e.map(e=>Io(e)).join(",")}]`
}
const t=Eo.test(e.value),a=$o.test(e.value),i=Eo.test(e.value.replace(qo,""))
if(e.modifiers){
let s="",n=""
const o=[]
for(const t in e.modifiers){
if(Go[t]){
n+=Go[t],Do[t]&&o.push(t)
}else if("exact"===t){
const t=e.modifiers
n+=Uo(["ctrl","shift","alt","meta"].filter(e=>!t[e]).map(e=>`$event.${e}Key`).join("||"))
}else{
o.push(t)
}
}
return o.length&&(s+=function(e){
return"if(!$event.type.indexOf('key')&&"+e.map(Fo).join("&&")+")return null;"
}(o)),
n&&(s+=n),`function($event){${s}${t?`return ${e.value}($event)`:a?`return (${e.value})($event)`:i?"return "+e.value:e.value}}`
}
...
class Ko{
constructor(e){
this.options=e,this.warn=e.warn||xi,this.transforms=Ci(e.modules,"transformCode"),
this.dataGenFns=Ci(e.modules,"genData"),
this.directives=x(x({},Ho),e.directives)
...
const a=new Ko(t)
return{
render:`with(this){return ${e?Jo(e,a):'_c("div")'}}`,
...
let s=`_t(${a}${i?","+i:""}`
const n=e.attrs||e.dynamicAttrs?rr((e.attrs||[]).concat(e.dynamicAttrs||[]).map(e=>({
name:z(e.name),
value:e.value,
dynamic:e.dynamic
...
e.staticProcessed=!0
const a=t.pre
return e.pre&&(t.pre=e.pre),t.staticRenderFns.push(`with(this){return ${Jo(e,t)}}`),
t.pre=a,
...
return a?`_o(${Jo(e,t)},${t.onceId++},${a})`:(t.warn("v-once can only be used inside v-for that is keyed. ",e.rawAttrsMap["v-once"]),
Jo(e,t))
}
return Yo(e,t)
}
...
const n=t.shift()
return n.exp?`(${n.exp})?${o(n.block)}:${e(t,a,i,s)}`:""+o(n.block)
function o(e){
return i?i(e,a):e.once?Qo(e,a):Jo(e,a)
}
}(e.ifConditions.slice(),t,a,i)
}
function er(e,t,a,i){
const s=e.for,n=e.alias,o=e.iterator1?","+e.iterator1:"",r=e.iterator2?","+e.iterator2:""
return t.maybeComponent(e)&&"slot"!==e.tag&&"template"!==e.tag&&!e.key&&t.warn(`<${e.tag} v-for="${n} in ${s}">: component lists rendered with v-for should have explicit keys. See https://vuejs.org/guide/list.html#key for more info.`,e.rawAttrsMap["v-for"],!0),
e.forProcessed=!0,
`${i||"_l"}((${s}),function(${n}${o}${r}){return `+(a||Jo)(e,t)+"})"
}
function tr(e,t){
let a="{"
...
let i,s,n,o,r="directives:[",l=!1
for(i=0,s=a.length;i<s;i++){
n=a[i],o=!0
const s=t.directives[n.name]
s&&(o=!!s(e,n,t.warn)),o&&(l=!0,r+=`{name:"${n.name}",rawName:"${n.rawName}"${n.value?`,value:(${n.value}),expression:${JSON.stringify(n.value)}`:""}${n.arg?",arg:"+(n.isDynamicArg?n.arg:`"${n.arg}"`):""}${n.modifiers?",modifiers:"+JSON.stringify(n.modifiers):""}},`)
}
if(l){
return r.slice(0,-1)+"]"
}
...
e.events&&(a+=Vo(e.events,!1)+","),
e.nativeEvents&&(a+=Vo(e.nativeEvents,!0)+","),
...
const n=Object.keys(t).map(e=>ir(t[e],a)).join(",")
return`scopedSlots:_u([${n}]${i?",null,true":""}${!i&&s?",null,false,"+function(e){
...
return Xo(e,t,ir,"null")
}
if(e.for&&!e.forProcessed){
return er(e,t,ir)
}
const i="_empty_"===e.slotScope?"":String(e.slotScope),s=`function(${i}){return ${"template"===e.tag?e.if&&a?`(${e.if})?${sr(e,t)||"undefined"}:undefined`:sr(e,t)||"undefined":Jo(e,t)}}`,n=i?"":",proxy:true"
...
if(n.length){
const e=n[0]
if(1===n.length&&e.for&&"template"!==e.tag&&"slot"!==e.tag){
...
const s=e[i]
if(1===s.type){
if(nr(s)||s.ifConditions&&s.ifConditions.some(e=>nr(e.block))){
a=2
break
}
...
return a
}(n,t.maybeComponent):0,r=s||or
return`[${n.map(e=>r(e,t)).join(",")}]${o?","+o:""}`
}
}
function nr(e){
...
function or(e,t){
return 1===e.type?Jo(e,t):3===e.type&&e.isComment?function(e){
...
let t="",a=""
for(let i=0;i<e.length;i++){
const s=e[i],n=lr(s.value)
s.dynamic?a+=`${s.name},${n},`:t+=`"${s.name}":${n},`
}
...
"v-for"===e?mr(t,`v-for="${i}"`,a,s):"v-slot"===e||"#"===e[0]?br(i,`${e}="${i}"`,a,s):Zn.test(e)?gr(i,`${e}="${i}"`,a,s):vr(i,`${e}="${i}"`,a,s)
}
}
}
if(t.children){
...
2===t.type&&vr(t.expression,t.text,a,t)
}
}(e,t)
}
function gr(e,t,a,i){
const s=e.replace(dr,""),n=s.match(ur)
n&&"$"!==s.charAt(n.index-1)&&a(`avoid using JavaScript unary operator as property name: "${n[0]}" in expression ${t.trim()}`,i),
vr(e,t,a,i)
}
function mr(e,t,a,i){
vr(e.for||"",t,a,i),kr(e.alias,"v-for alias",t,a,i),kr(e.iterator1,"v-for iterator",t,a,i),
...
const n=e.replace(dr,"").match(cr)
a(n?`avoid using JavaScript keyword as property name: "${n[0]}"\n  Raw expression: ${t.trim()}`:`invalid expression: ${s.message} in\n\n    ${e}\n\n  Raw expression: ${t.trim()}\n`,i)
}
}
function br(e,t,a,i){
try{
...
const n=(i=x({},i)).warn||ce
delete i.warn
try{
new Function("return 1")
}catch(e){
e.toString().match(/unsafe-eval|CSP/)&&n("It seems you are using the standalone build of Vue.js in an environment with Content Security Policy that prohibits unsafe-eval. The template compiler cannot work in this environment. Consider relaxing the policy to allow unsafe-eval or pre-compiling your templates into render functions.")
}
const o=i.delimiters?String(i.delimiters)+a:a
if(t[o]){
return t[o]
}
const r=e(a,i)
r.errors&&r.errors.length&&(i.outputSourceRange?r.errors.forEach(e=>{
n(`Error compiling template:\n\n${e.msg}\n\n`+function(e,t=0,a=e.length){
const i=e.split(/\r?\n/)
let s=0
const n=[]
for(let e=0;e<i.length;e++){
if(s+=i[e].length+1,s>=t){
for(let o=e-2;o<=e+2||a>s;o++){
if(o<0||o>=i.length){
continue
}
n.push(`${o+1}${hr(" ",3-String(o+1).length)}|  ${i[o]}`)
const r=i[o].length
if(o===e){
...
r.errors&&r.errors.length||!c.length||n("Failed to generate render function:\n\n"+c.map(({err:e,code:t})=>`${e.toString()} in\n\n${t}\n`).join("\n"),s),
t[o]=l
}
}
...
a&&(null!=a.start&&(o.start=a.start+e),null!=a.end&&(o.end=a.end+e)),(i?n:s).push(o)
}
}
...
i.warn=o
const r=wr(t.trim(),i)
return pr(r.ast,o),r.errors=s,r.tips=n,r
}
return{
compile:t,
...
var wr
const{compile:Ar,compileToFunctions:zr}=jr(Po)
let Sr
function Br(e){
return Sr=Sr||document.createElement("div"),Sr.innerHTML=e?'<a href="\n"/>':'<div a="\n"/>',
Sr.innerHTML.indexOf("&#10;")>0
}
const _r=!!F&&Br(!1),Tr=!!F&&Br(!0),Or=w(e=>{
const t=oi(e)
return t&&t.innerHTML
}),xr=Ca.prototype.$mount
Ca.prototype.$mount=function(e,t){
...
if(t){
if("string"==typeof t){
"#"===t.charAt(0)&&(t=Or(t),t||ce("Template element not found or is empty: "+a.template,this))
}else{
if(!t.nodeType){
...
a.render=e,a.staticRenderFns=i,D.performance&&st&&(st("compile end"),nt(`vue ${this._name} compile`,"compile","compile end"))
}
}
...
this.element=e,this.settings=h(h({},l.defaults),t||{}),
...
bind:function(){
var e,t,a,i,s=this.listeners={},n=this.scrollEl
for(var o in s.scroll=(e=p.scroll.bind(this),t=c.scrollMinUpdateInterval,function(){
var s=this,n=Date.now(),o=arguments
a&&n<a+t?(clearTimeout(i),i=setTimeout((function(){
a=n,e.apply(s,o)
}),t)):(a=n,e.apply(s,o))
}),k.isTouch&&(s.touchstart=p.touchstart.bind(this),s.touchend=p.touchend.bind(this)),
s.mousewheel=s.wheel=p.wheel.bind(this),
s){
n.addEventListener(o,s[o],k.passiveEvent)
}
},
update:function(){
var e=this.scrollEl,t=this.cache,a=t.clientH,i=e.scrollHeight,s=e.clientHeight,o=e.scrollWidth,r=e.clientWidth
if(i!==t.scrollH||s!==t.clientH||o!==t.scrollW||r!==t.clientW){
if(t.scrollH=i,t.clientH=s,
t.scrollW=o,t.clientW=r,void 0!==a){
if(0===i&&0===s&&!n.body.contains(this.element)){
...
n=+e,
"left"===e&&(n=0),"right"===e&&(n=r.scrollW-r.clientW),!1===e&&(n=i),o=+t,"top"===t&&(o=0),
"bottom"===t&&(o=r.scrollH-r.clientH),
!1===t&&(o=s),this.animateScroll(i,n,s,o,+a)
},
scrollIntoView:function(e,t,a){
var i,s,n,o,r,l,c,u,d,p,g,m,v=this.scrollEl
k.pauseCheck=!0,this.update(),"string"==typeof e?e=v.querySelector(e):e.length&&e.jquery&&(e=e[0]),
"number"==typeof a&&(a={
top:a,
right:a,
bottom:a,
left:a
}),a=a||{},i=e.getBoundingClientRect(),s=v.getBoundingClientRect(),d=g=v.scrollLeft,
p=m=v.scrollTop,
c=d+i.left-s.left,u=p+i.top-s.top,n=c-(a.left||0),o=u-(a.top||0),
n<d&&(g=n),(r=c+i.width-this.cache.clientW+(a.right||0))>d&&(g=r),
o<p&&(m=o),(l=u+i.height-this.cache.clientH+(a.bottom||0))>p&&(m=l),
this.animateScroll(d,g,p,m,+t)
},
animateScroll:function(e,t,a,i,n){
var r=this,l=this.scrollEl,c=Date.now()
if(t!==e||i!==a){
if(0===n){
return l.scrollLeft=t,void(l.scrollTop=i)
}
isNaN(n)&&(n=15*o.pow(o.max(o.abs(t-e),o.abs(i-a)),.54)),function u(){
var d=o.min(1,(Date.now()-c)/n),p=m.easingFunction(d)
i!==a&&(l.scrollTop=~~(p*(i-a))+a),t!==e&&(l.scrollLeft=~~(p*(t-e))+e),r.scrollAnimation=d<1?s.requestAnimationFrame(u):null
}()
}
},
destroy:function(){
var e,t=this,a=this.element,i=this.scrollEl,n=this.listeners
if(this.scrollEl){
for(var o in n){
i.removeEventListener(o,n[o])
}
...
b(a,this.settings.classPrefix+"prevent",!1),b(a,"is-enabled",!1),s.requestAnimationFrame((function(){
...
var t,a,i=this.cache,s=i.scrollH,o=i.scrollW
t={
scrollbarV:h({},i.v),
scrollbarH:h({},i.h),
...
detail:t
}):(a=n.createEvent("CustomEvent")).initCustomEvent(e,!1,!1,t),this.element.dispatchEvent(a)
}
}
var u,d,p={
scroll:function(e){
...
wheel:function(e){
var t=this.cache,a=t.v,i=t.h,n=this.settings.preventParentScroll&&k.isTouch
s.cancelAnimationFrame(this.scrollAnimation),n&&a.enabled&&a.percent%100==0&&(this.scrollEl.scrollTop=a.percent?t.scrollH-t.clientH-1:1),
n&&i.enabled&&i.percent%100==0&&(this.scrollEl.scrollLeft=i.percent?t.scrollW-t.clientW-1:1)
}
},g=function(e,t){
var a="v"===e,i=t.element,r=t.scrollEl,l=t.settings,c=t.cache,u=c[e]={},d=a?"H":"W",p="client"+d,g="scroll"+d,m=a?"scrollTop":"scrollLeft",v=a?["top","bottom"]:["left","right"],y=/^(mouse|touch|pointer)/,f=k.scrollbarSpec.rtl,j=!1,w=null,A=null,z={
dragData:null,
...
n[a](i,z.dragMove),n[a](s,z.dragEnd),n[a](t+"cancel",z.dragEnd)
}
}
return{
toggle:function(t){
...
create:function(){
(w=n.createElement("div"),A=n.createElement("b"),w.className=l.classPrefix+e,
...
s=o.abs(a.position-(u.position||0))*c[p],
1===e&&j&&this.toggle(!1),e<1&&!j&&this.toggle(!0),
A&&j&&this.style(i,s,e,t),u=h(u,a),
j&&this.fireEdgeEv())
},
...
calc:function(){
var e,t=r[m],i=c[p],s=c[g],n=i/s,u=s-i
return n>=1||!s?{
position:0,
size:1,
percent:0
}:(!a&&l.rtl&&f&&(t=u-t*f),e=100*t/u,t<=1&&(e=0),t>=u-1&&(e=100),n=o.max(n,l.minTrackSize/100),
{
position:e/100*(1-(n=o.min(n,l.maxTrackSize/100))),
size:n,
percent:e
})
},
fireEdgeEv:function(){
var e=u.percent
u.was!==e&&e%100==0&&(t.fireCustomEvent("scrollreachedge"),t.fireCustomEvent("scrollreach"+v[e/100])),
u.was=e
},
remove:function(){
...
var a=n.getElementById("scroll-sheet")
a||((a=n.createElement("style")).id="scroll-sheet",a.appendChild(n.createTextNode("")),
...
for(var a,i=n.createElement("div");a=e.childNodes[0];){
i.appendChild(a)
}
...
cssTransition:v("transition"),
cssTransform:v("transform"),
scrollbarSpec:function(){
var e,t,a,i=n.documentElement,s=1
;(e=n.createElement("div")).style.cssText="overflow:scroll;width:50px;height:50px;position:absolute;left:-100px;direction:rtl",
(t=n.createElement("div")).style.cssText="width:100px;height:100px",
e.appendChild(t),
...
function v(e){
var t=e.charAt(0).toUpperCase()+e.slice(1),a=n.createElement("test"),i=[e,"Webkit"+t]
for(var s in i){
...
staticClass:"aos-section aos-flex aos-column",
attrs:{
"data-section":"Advertisers"
}
},[a("h3",{
staticClass:"aos-h3 aos-g-padding-bottom--10 aos-g-margin-bottom--10"
},[e._v("\n\t\t\t\t\t\t\t"+e._s(e.nls("advertisers.title"))+"\n\t\t\t\t\t\t")]),e._v(" "),a("div",{
staticClass:"aos-flex aos-align-center"
},["ONBOARDING"===e.advertisers.state||"FINISHED_GET"===e.advertisers.state?a("span",{
staticClass:"aos-advertisers-danger-icon aos-icon-on aos-flex-no"
}):"RUNNING_GET"===e.advertisers.state||"RUNNING_OPT_OUT"===e.advertisers.state?a("span",{
staticClass:"aos-advertisers-loading-icon aos-icon-on aos-flex-no"
}):"FINISHED_OPT_OUT"===e.advertisers.state?a("span",{
staticClass:"aos-advertisers-success-icon aos-icon-on aos-flex-no"
}):a("span",{
staticClass:"aos-advertisers-error-icon aos-icon-bad aos-icon-on aos-flex-no"
}),e._v(" "),a("div",{
staticClass:"aos-privacy-text"
},["ONBOARDING"===e.advertisers.state?a("p",{
staticClass:"aos-i-col aos-critical aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.onboarding.description"))
}
}):"RUNNING_GET"===e.advertisers.state?a("p",{
staticClass:"aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.runningGet.description"))
}
}):"FINISHED_GET"===e.advertisers.state?a("p",{
staticClass:"aos-i-col aos-critical aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.finishedGet.description",e.advertisersGetReadyForOptOut().length))
}
}):"RUNNING_OPT_OUT"===e.advertisers.state?a("p",{
staticClass:"aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.runningAct.description"))
}
}):"FINISHED_OPT_OUT"===e.advertisers.state?a("p",{
staticClass:"aos-i-col aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.finishedAct.description",e.advertisersGetOptedOut().length))
}
}):a("p",{
staticClass:"aos-i-col aos-critical aos-g-margin-bottom--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.error.description"))
}
})])]),e._v(" "),"ONBOARDING"===e.advertisers.state?[a("p",{
staticClass:"aos-i-col aos-g-margin-top--5 aos-g-margin-top--10 aos-g-margin-bottom--10"
},[a("span",[e._v(e._s(e.nls("advertisers.onboarding.description2")))])]),e._v(" "),a("button",{
staticClass:"aos-section-details-button aos-button aos-g-margin-top--5 aos-secondary aos-small",
on:{
click:function(t){
return e.advertisersStartScan()
}
}
},[e._v("\n\t\t\t\t\t\t\t\t"+e._s(e.nls("advertisers.onboarding.cta"))+"\n\t\t\t\t\t\t\t")])]:e._e(),e._v(" "),"RUNNING_GET"===e.advertisers.state||"RUNNING_OPT_OUT"===e.advertisers.state?[e._m(0)]:e._e(),e._v(" "),"FINISHED_GET"===e.advertisers.state||"FINISHED_OPT_OUT"===e.advertisers.state?[a("div",{
staticClass:"aos-section-details aos-hidden"
},[a("div",{
staticClass:"aos-flex aos-column"
},[a("div",{
staticClass:"aos-accordions"
},[a("div",{
staticClass:"aos-trackers aos-accordion aos-no-border"
},[a("button",{
staticClass:"aos-trackers-header aos-accordion-button aos-g-align--left"
},[a("div",{
staticClass:"aos-advertisers-header"
},[a("span",{
staticClass:"aos-text-col aos-white aos-g-margin-left--5"
},[e._v(e._s(e.nls("advertisers.list.advertisers")))]),e._v(" "),"FINISHED_GET"===e.advertisers.state?[a("span",{
staticClass:"aos-i-col aos-critical aos-g-margin-left--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.list.found",e.advertisersGetReadyForOptOut().length))
}
})]:[e.advertisersGetAvailableBrokers().length?[a("span",{
staticClass:"aos-i-col aos-secondary aos-g-margin-left--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.list.available",e.advertisersGetAvailableBrokers().length))
}
})]:e.advertisersGetReadyForOptOut().length?e._e():[a("span",{
staticClass:"aos-i-col aos-g-margin-left--5",
domProps:{
innerHTML:e._s(e.nls("advertisers.list.disabled",e.advertisersGetOptedOut().length))
}
})]]],2)]),e._v(" "),a("div",{
staticClass:"aos-g-display--none aos-accordion-content"
},["FINISHED_GET"===e.advertisers.state||"FINISHED_OPT_OUT"===e.advertisers.state&&e.advertisersGetAvailableBrokers().length||e.advertisersGetReadyForOptOut().length?[a("ul",{
staticClass:"aos-trackers-list aos-advertisers"
},[e._l(e.advertisersGetReadyForOptOut(),(function(t){
return a("li",{
key:t.title
},[a("input",{
directives:[{
name:"model",
rawName:"v-model",
value:t.isSelectedForOptOut,
expression:"broker.isSelectedForOptOut"
}],
staticClass:"aos-block",
attrs:{
type:"checkbox",
id:"aos-advertiser-"+t.title
},
domProps:{
checked:Array.isArray(t.isSelectedForOptOut)?e._i(t.isSelectedForOptOut,null)>-1:t.isSelectedForOptOut
},
on:{
change:[function(a){
var i=t.isSelectedForOptOut,s=a.target,n=!!s.checked
if(Array.isArray(i)){
var o=e._i(i,null)
s.checked?o<0&&e.$set(t,"isSelectedForOptOut",i.concat([null])):o>-1&&e.$set(t,"isSelectedForOptOut",i.slice(0,o).concat(i.slice(o+1)))
}else{
e.$set(t,"isSelectedForOptOut",n)
}
},function(a){
return e.advertisersSelectOneForOptOut(t.title,t.isSelectedForOptOut)
}]
}
}),e._v(" "),a("label",{
attrs:{
for:"aos-advertiser-"+t.title
}
},[e._v(e._s(t.title))])])
})),e._v(" "),e._l(e.advertisersGetOptedOut(),(function(t){
return"FINISHED_OPT_OUT"===e.advertisers.state?a("li",{
key:t.title
},[a("span",[e._v(e._s(t.title))])]):e._e()
}))],2),e._v(" "),a("a",{
staticClass:"aos-link aos-a aos-center",
on:{
click:function(t){
return e.advertisersSelectAllForOptOut()
}
}
},[e._v(e._s(e.nls("advertisers.list.selectAll")))])]:[a("ul",{
staticClass:"aos-trackers-list aos-advertisers aos-no-bottom-margin"
},e._l(e.advertisersGetOptedOut(),(function(t){
return a("li",{
key:t.title
},[a("span",[e._v(e._s(t.title))])])
})),0)]],2)])]),e._v(" "),"FINISHED_GET"===e.advertisers.state||"FINISHED_OPT_OUT"===e.advertisers.state&&e.advertisersGetAvailableBrokers().length||e.advertisersGetReadyForOptOut().length?a("button",{
staticClass:"aos-button aos-advertisers aos-g-margin-top--5 aos-g-margin-bottom--20 aos-small",
class:{
"aos-disabled":e.advertisersGetSelectedForOptOut().length<1
},
on:{
click:function(t){
return e.advertisersStartOptOut()
}
}
},[e._v("\n\t\t\t\t\t\t\t\t\t\t"+e._s(e.nls("advertisers.list.cta"))+"\n\t\t\t\t\t\t\t\t\t")]):e._e()]),e._v(" "),a("div",{
staticClass:"aos-flex aos-align-center aos-advertisers-settings aos-g-margin-bottom--20 aos-text-col aos-white"
},[a("span",[e._v(e._s(e.nls("advertisers.list.settings.autoScan")))]),e._v(" "),a("span",{
staticClass:"aos-g-nowrap"
},[a("input",{
staticClass:"aos-switch aos-no-label",
attrs:{
type:"checkbox",
id:"aosAdvertisersAutoScan"
},
domProps:{
checked:e.advertisers.settings.autoOptOut
},
on:{
click:function(t){
return e.action("advertisersAutoScanChanged",!e.advertisers.settings.autoOptOut)
}
}
}),e._v(" "),a("label",{
staticClass:"aos-g-margin-left--5",
attrs:{
tabindex:"0",
for:"aosAdvertisersAutoScan",
"data-off":e.nls("global.switcher.off"),
"data-on":e.nls("global.switcher.on")
}
})])])])]:e._e(),e._v(" "),"FINISHED_GET"===e.advertisers.state||"FINISHED_OPT_OUT"===e.advertisers.state?[a("button",{
staticClass:"aos-section-details-button aos-button aos-advertisers-secondary aos-small aos-g-margin-bottom--5",
on:{
click:function(t){
return e.sectionToggle("Advertisers")
}
}
},[e._v("\n\t\t\t\t\t\t\t\t"+e._s(e.isSectionOpened.Advertisers?e.nls("global.detailsHide"):e.nls("global.detailsShow"))+"\n\t\t\t\t\t\t\t")])]:e._e(),e._v(" "),"FAILED"===e.advertisers.state?[a("button",{
staticClass:"aos-section-details-button aos-button aos-advertisers-secondary aos-small aos-g-margin-bottom--5",
on:{
click:function(t){
return e.advertisersTryAgain()
}
}
},[e._v("\n\t\t\t\t\t\t\t\t"+e._s(e.nls("advertisers.error.cta"))+"\n\t\t\t\t\t\t\t")])]:e._e()],2),e._v(" "),"card"===e.feedback.style?a("div",{
staticClass:"aos-section",
attrs:{
...
on:{
change:[function(a){
var i=t.value,s=a.target,n=!!s.checked
if(Array.isArray(i)){
var o=e._i(i,null)
s.checked?o<0&&e.$set(t,"value",i.concat([null])):o>-1&&e.$set(t,"value",i.slice(0,o).concat(i.slice(o+1)))
}else{
e.$set(t,"value",n)
}
},function(a){
...
return t("div",{
staticClass:"aos-advertisers-loader aos-g-margin-top--20"
},[t("div",{
staticClass:"aos-advertisers-loader-bar"
})])
}]
...
var s,n,o,r,l,c,u,p=[],g=t.length,m=t[i],k=t[i+1]
if(i===g&&a._listeners){
if("function"==typeof a._listeners){
return e&&e.push(a._listeners),[a]
}
for(s=0,n=a._listeners.length;s<n;s++){
...
if("*"===m){
for(o in a){
"_listeners"!==o&&a.hasOwnProperty(o)&&(p=p.concat(d(e,t,a[o],i+1)))
}
return p
}
if("**"===m){
for(o in(u=i+1===g||i+2===g&&"*"===k)&&a._listeners&&(p=p.concat(d(e,t,a,g))),
a){
"_listeners"!==o&&a.hasOwnProperty(o)&&("*"===o||"**"===o?(a[o]._listeners&&!u&&(p=p.concat(d(e,t,a[o],g))),
p=p.concat(d(e,t,a[o],i))):p=o===k?p.concat(d(e,t,a[o],i+2)):p.concat(d(e,t,a[o],i)))
}
return p
}
...
if(i<g){
for(o in l._listeners&&d(e,t,l,g),l){
"_listeners"!==o&&l.hasOwnProperty(o)&&(o===k?d(e,t,l[o],i+2):o===m?d(e,t,l[o],i+1):((c={})[o]=l[o],
d(e,t,{
"**":c
},i+1)))
}
...
for(var s=this.listenerTree,n=e.shift();void 0!==n;){
if(s[n]||(s[n]={}),s=s[n],0===e.length){
...
c.call(this,s._listeners.length,n))):s._listeners=t,
!0
}
n=e.shift()
}
...
function n(){
return 0==--t&&s.off(e,n),a.apply(this,arguments)
}
return n._origin=a,this._on(e,n,i),s
...
var t,a,i,s,n,o=arguments.length
if(this._all&&this._all.length){
if(n=this._all.slice(),o>3){
for(t=new Array(o),s=0;s<o;s++){
t[s]=arguments[s]
}
}
...
break
case 2:
n[i].call(this,e,arguments[1])
break
case 3:
n[i].call(this,e,arguments[1],arguments[2])
break
default:
n[i].apply(this,t)
}
...
d.call(this,n,l,this.listenerTree,0)
}else{
if("function"==typeof(n=this._events[e])){
switch(this.event=e,o){
case 1:
n.call(this)
break
...
break
case 3:
n[i].call(this,arguments[1],arguments[2])
break
default:
n[i].apply(this,t)
}
...
var t,a,i,s,n,o=[],l=arguments.length
if(this._all){
if(l>3){
...
d.call(this,n,c,this.listenerTree,0)
}else{
n=this._events[e]
}
...
break
case 2:
o.push(n.call(this,arguments[1]))
break
case 3:
o.push(n.call(this,arguments[1],arguments[2]))
break
default:
for(t=new Array(l-1),s=1;s<l;s++){
t[s-1]=arguments[s]
}
o.push(n.apply(this,t))
}
}else if(n&&n.length){
if(n=n.slice(),l>3){
for(t=new Array(l-1),s=1;s<l;s++){
...
switch(this.event=e,l){
case 1:
o.push(n[i].call(this))
break
case 2:
o.push(n[i].call(this,arguments[1]))
break
case 3:
o.push(n[i].call(this,arguments[1],arguments[2]))
break
default:
o.push(n[i].apply(this,t))
}
}
...
for(var i in a){
var s=a[i],n=t[s]
n instanceof Function||"object"!=typeof n||null===n||(Object.keys(n).length>0&&e(t[s]),
0===Object.keys(n).length&&delete t[s])
}
}
...
return this._events||r.call(this),this._events[e]||(this._events[e]=[]),o(this._events[e])||(this._events[e]=[this._events[e]]),
this._events[e]
...
for(var a,s=t.split("."),n=0;n<s.length;++n){
if(!(a=s[n]).length){
...
var l=function(){
return/xn--/.test(a)?(o.domain&&(o.domain=i.toASCII(o.domain)),
o.subdomain&&(o.subdomain=i.toASCII(o.subdomain)),
o):o
},c=s.findRule(a)
if(!c){
return r.length<2?o:(o.tld=r.pop(),o.sld=r.pop(),o.domain=[o.sld,o.tld].join("."),
r.length&&(o.subdomain=r.pop()),
l())
}
o.listed=!0
var u=c.suffix.split("."),d=r.slice(0,r.length-u.length)
return c.exception&&d.push(u.shift()),o.tld=u.join("."),d.length?(c.wildcard&&(u.unshift(d.pop()),
o.tld=u.join(".")),
d.length?(o.sld=d.pop(),o.domain=[o.sld,o.tld].join("."),d.length&&(o.subdomain=d.join(".")),
l()):l()):l()
},t.get=function(e){
...
var o,r=2147483647,l=/^xn--/,c=/[^\x20-\x7E]/,u=/[\x2E\u3002\uFF0E\uFF61]/g,d={
...
function b(e){
for(var t,a,i=[],s=0,n=e.length;s<n;){
(t=e.charCodeAt(s++))>=55296&&t<=56319&&s<n?56320==(64512&(a=e.charCodeAt(s++)))?i.push(((1023&t)<<10)+(1023&a)+65536):(i.push(t),
s--):i.push(t)
}
return i
}
...
function j(e){
var t,a,i,s,n,o,l,c,u,d,g,k=[],v=e.length,b=0,y=128,j=72
for((a=e.lastIndexOf("-"))<0&&(a=0),i=0;i<a;++i){
e.charCodeAt(i)>=128&&m("not-basic"),
k.push(e.charCodeAt(i))
}
for(s=a>0?a+1:0;s<v;){
for(n=b,o=1,l=36;s>=v&&m("invalid-input"),((c=(g=e.charCodeAt(s++))-48<10?g-22:g-65<26?g-65:g-97<26?g-97:36)>=36||c>p((r-b)/o))&&m("overflow"),
b+=c*o,
!(c<(u=l<=j?1:l>=j+26?26:l-j));l+=36){
o>p(r/(d=36-u))&&m("overflow"),o*=d
}
j=f(b-n,t=k.length+1,0==n),p(b/t)>r-y&&m("overflow"),y+=p(b/t),b%=t,k.splice(b++,0,y)
}
return h(k)
}
function w(e){
var t,a,i,s,n,o,l,c,u,d,k,v,h,j,w,A=[]
for(v=(e=b(e)).length,t=128,a=0,n=72,o=0;o<v;++o){
(k=e[o])<128&&A.push(g(k))
}
for(i=s=A.length,s&&A.push("-");i<v;){
for(l=r,o=0;o<v;++o){
(k=e[o])>=t&&k<l&&(l=k)
}
for(l-t>p((r-a)/(h=i+1))&&m("overflow"),a+=(l-t)*h,t=l,o=0;o<v;++o){
if((k=e[o])<t&&++a>r&&m("overflow"),
k==t){
for(c=a,u=36;!(c<(d=u<=n?1:u>=n+26?26:u-n));u+=36){
w=c-d,j=36-d,A.push(g(y(d+w%j,0))),
c=p(w/j)
}
A.push(g(y(c,0))),n=f(a,h,i==s),a=0,++i
}
}
++a,++t
}
...
"use strict"
if(!t.setImmediate){
var i,s,n,o,r,l=1,c={},u=!1,d=t.document,p=Object.getPrototypeOf&&Object.getPrototypeOf(t)
...
}()?t.MessageChannel?((n=new MessageChannel).port1.onmessage=function(e){
m(e.data)
},i=function(e){
...
setTimeout(m,0,e)
}:(o="setImmediate$"+Math.random()+"$",r=function(e){
...
o.t=i-o.t,o.t<0&&(o.t=0)
let e=o.valueStart
o.valueStart=o.valueEnd,o.valueEnd=e
},l=function(){
let t=o.valueStart,a=o.valueEnd
if(o.t>=i){
s(e,1,t,a,r)
}else{
let n=o.t/i
...
o.t>=i?n():e.dataset.animationTimeout=setTimeout(()=>{
o.t+=20,l()
},20)
}
l()
...
animateStyle(e,t,a,i,s,n,o){
let r=function(){
return"function"==typeof s?s():s
},l=function(s){
if(s>=n){
e.style[t]=r()+a,"function"==typeof o&&o(),delete e.dataset.animationTimeout,
delete e.dataset.animationFinishCallback
}else{
let o="function"==typeof i?i():i,c=r(),u=o+s/n*(c-o)
e.style[t]=u+a,e.dataset.animationTimeout=setTimeout(()=>{
l(s+20)
},20)
}
}
e.dataset.animationFinishCallback=o,l(0)
}
animateAttribute(e,t,a,i,s,n,o){
let r=function(){
return"function"==typeof s?s():s
},l=function(s){
if(s>=n){
e[t]=r()+a,"function"==typeof o&&o(),delete e.dataset.animationTimeout,
delete e.dataset.animationFinishCallback
}else{
let o="function"==typeof i?i():i,c=r(),u=o+s/n*(c-o)
...
let n=parseInt(e.dataset.slideSwapRevert)
n&&(n%2==1&&s(),e.dataset.slideSwapRevert=0,e.dataset.slideSwapReverted?e.dataset.slideSwapReverted="":e.dataset.slideSwapReverted="1")
}).then(()=>{
...
e.style.whiteSpace="nowrap",this.animate(e,o,n,250,(e,n,o,r)=>{
...
e.style.whiteSpace="nowrap",e.style.width=o+(r-o)*n+"px"
}).then(()=>{
e.removeAttribute("style"),e.style.width=n+"px"
})
}
buttonSwap(e){
...
e.removeAttribute("style")
let n=this.elementColorGet(e)
if(t<=.5){
let i=(t-0)/.5
e.innerHTML=a.text,this.elementColorSet(e,n.r,n.g,n.b,n.a*(1-i)*(1-i))
}else{
let a=(t-.5)/.5
e.innerHTML=i.text,this.elementColorSet(e,n.r,n.g,n.b,n.a*a*a)
}
e.style.whiteSpace="nowrap",e.style.width=a.width+(i.width-a.width)*t+"px"
let o=parseInt(e.dataset.buttonSwapRevert)
o&&(o%2==1&&s(),e.dataset.buttonSwapRevert=0,e.dataset.buttonSwapReverted?e.dataset.buttonSwapReverted="":e.dataset.buttonSwapReverted="1")
}).then(()=>{
...
let t=a.scrollTop,i=a.clientHeight,s=parseInt(window.getComputedStyle(e).marginTop),n=parseInt(window.getComputedStyle(e).marginBottom),o=e.offsetHeight
return e.offsetTop+o+n>t+i&&(t=e.offsetTop+s+n+o-i),e.offsetTop-s<t&&(t=e.offsetTop-s),
t
},300,(function(){}))
...
i.style.left="0px",
i.style.top="0px"
let n=i.scrollHeight,o=i.scrollWidth,r=t.getBoundingClientRect(),l=(r.left+r.right)/2-o/2,c=r.bottom+6
l<12&&(l=12),l+o>a.scrollWidth-12&&(l=a.scrollWidth-12-o),c+n>a.scrollHeight-12&&(c=r.top-6-n),
c<12&&(c=12),
...
const m="FINISHED_GET",k="FINISHED_OPT_OUT",v="READY_FOR_OPT_OUT",b="OPTED_OUT",h="OPTED_OUT_ALREADY",y=(e,t)=>e.title.localeCompare(t.title)
var f=a(5),j=a.n(f)
class w{
constructor(e){
this.execute=e
...
var C=Array.isArray,P="object"==typeof global&&global&&global.Object===Object&&global,L="object"==typeof self&&self&&self.Object===Object&&self,N=P||L||Function("return this")(),W=N.Symbol,R=Object.prototype,$=R.hasOwnProperty,q=R.toString,E=W?W.toStringTag:void 0
var D=function(e){
var t=$.call(e,E),a=e[E]
try{
e[E]=void 0
var i=!0
}catch(e){}
var s=q.call(e)
return i&&(t?e[E]=a:delete e[E]),s
},M=Object.prototype.toString
var U=function(e){
return M.call(e)
},G=W?W.toStringTag:void 0
var V=function(e){
return null==e?void 0===e?"[object Undefined]":"[object Null]":G&&G in Object(e)?D(e):U(e)
}
var I=function(e){
return null!=e&&"object"==typeof e
}
var F=function(e){
return"symbol"==typeof e||I(e)&&"[object Symbol]"==V(e)
},H=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,K=/^\w*$/
var Z=function(e,t){
if(C(e)){
return!1
...
var a=typeof e
return!("number"!=a&&"symbol"!=a&&"boolean"!=a&&null!=e&&!F(e))||(K.test(e)||!H.test(e)||null!=t&&e in Object(t))
}
var J=function(e){
var t=typeof e
...
},X=N["__core-js_shared__"],ee=(Y=/[^.]+$/.exec(X&&X.keys&&X.keys.IE_PROTO||""))?"Symbol(src)_1."+Y:""
var te=function(e){
return!!ee&&ee in e
...
return""
},se=/^\[object .+?Constructor\]$/,ne=Function.prototype,oe=Object.prototype,re=ne.toString,le=oe.hasOwnProperty,ce=RegExp("^"+re.call(le).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$")
var ue=function(e){
return!(!J(e)||te(e))&&(Q(e)?ce:se).test(ie(e))
}
var de=function(e,t){
...
var ye=function(e){
var t=this.__data__
return ge?void 0!==t[e]:he.call(t,e)
}
var fe=function(e,t){
var a=this.__data__
return this.size+=this.has(e)?0:1,a[e]=ge&&void 0===t?"__lodash_hash_undefined__":t,
this
}
function je(e){
...
je.prototype.clear=me,je.prototype.delete=ke,je.prototype.get=be,je.prototype.has=ye,
je.prototype.set=fe
var we=je
var Ae=function(){
...
Ce.prototype.clear=Ae,Ce.prototype.delete=_e,Ce.prototype.get=Te,Ce.prototype.has=Oe,
Ce.prototype.set=xe
var Pe=Ce,Le=pe(N,"Map")
var Ne=function(){
...
Me.prototype.clear=Ne,Me.prototype.delete=$e,Me.prototype.get=qe,Me.prototype.has=Ee,
Me.prototype.set=De
var Ue=Me
function Ge(e,t){
...
var a=function(){
var i=arguments,s=t?t.apply(this,i):i[0],n=a.cache
if(n.has(s)){
return n.get(s)
}
var o=e.apply(this,i)
return a.cache=n.set(s,o)||n,o
}
return a.cache=new(Ge.Cache||Ue),a
}
Ge.Cache=Ue
var Ve=Ge
var Ie=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,Fe=/\\(\\)?/g,He=function(e){
...
var t=[]
return 46===e.charCodeAt(0)&&t.push(""),e.replace(Ie,(function(e,a,i,s){
t.push(i?s.replace(Fe,"$1"):a||e)
})),t
}))
var Ke=function(e,t){
...
return s
},Ze=W?W.prototype:void 0,Je=Ze?Ze.toString:void 0
var Ye=function e(t){
if("string"==typeof t){
return t
}
...
var tt=function(e,t){
for(var a=0,i=(t=Xe(t,e)).length;null!=e&&a<i;){
e=e[et(t[a++])]
}
return a&&a==i?e:void 0
}
var at=function(e,t,a){
var i=null==e?void 0:tt(e,t)
return void 0===i?a:i
}
class it{
constructor(){
...
var st=a(6),nt=a(7),ot=a.n(nt),rt=a(8),lt=a.n(rt),ct=a(9),ut=a.n(ct),dt=a(10),pt=a.n(dt)
const gt=new class{
constructor(e){
const t=function(){
const t=[...arguments],a=at(e,t.shift())||{},i=a[t.shift()]
return"function"==typeof i?i.apply(a,t):i
}
this.browserAction=new w(t),this.extension=new A(t),this.i18n=new S(t),this.runtime=new z(t),
this.storage=new B(t),
this.tabs=new _(t),this.windows=new T(t),this.webNavigation=new O(t),
this.webRequest=new x(t)
}
}(chrome)
let mt={}
mt.Api=gt,mt.DEFAULTS={},mt.DEFAULTS.BRAND="AVG",mt.DEFAULTS.BRAND_NAME="AVG",
mt.bs=new class{
constructor(e){
...
if("attributes"===a.type&&(o=!0),o||n){
break
}
}
n?"function"==typeof t&&(s.disconnect(),t(),e.parentNode&&s.observe(e.parentNode,{
childList:!0
}),e&&s.observe(e,{
attributes:!0
})):o&&"function"==typeof a&&(s.disconnect(),a(),e.parentNode&&s.observe(e.parentNode,{
childList:!0
}),e&&s.observe(e,{
attributes:!0
}))
...
if(1!=arguments.length||"[object String]"!=Object.prototype.toString.call(s)||/\d/.test(s)||(n=s,
s=void 0),
s=s?new Date(s):new Date,isNaN(s)){
throw SyntaxError("invalid date")
}
"UTC:"==(n=String(r.masks[n]||n||r.masks.default)).slice(0,4)&&(n=n.slice(4),o=!0)
var l=o?"getUTC":"get",c=s[l+"Date"](),u=s[l+"Day"](),d=s[l+"Month"](),p=s[l+"FullYear"](),g=s[l+"Hours"](),m=s[l+"Minutes"](),k=s[l+"Seconds"](),v=s[l+"Milliseconds"](),b=o?0:s.getTimezoneOffset(),h={
d:c,
dd:i(c),
...
ss:i(k),
l:i(v,3),
L:i(v>99?Math.round(v/10):v),
t:g<12?"a":"p",
tt:g<12?"am":"pm",
T:g<12?"A":"P",
TT:g<12?"AM":"PM",
Z:o?"UTC":(String(s).match(t)||[""]).pop().replace(a,""),
...
try{
var i=/((https?\:\/\/(www\.)?|www\.)(([\w|\-]+\.)+(\w+)))([\/#\?].*)?/,s=decodeURIComponent(t[a]),n=s.match(i)
if(n){
return n[2]+n[4]
}
if(n=atob(s).match(i)){
...
let n=e.target.classList.contains("wrc_icon_right"),o=s.left-112
if(n){
...
t.style.left=o+"px",t.style.top=l+"px"
}
}
docMouseOut(e){
...
let n=i.getAttribute("href"),o=i.dataset.url
if(o&&-1!=o.indexOf("http")&&(n=o),!n){
continue
}
...
const t=this.AvastWRC.localization.localizeString("installPage.consent.desc",[]),a=this.urlToText(t,"https://addons.mozilla.org/firefox/addon/avg-online-security/privacy/")
...
advertisersStartScan:()=>{
this.sendAction("advertisersStartScan")
},
advertisersStartOptOut:()=>{
this.sendAction("advertisersStartOptOut")
},
advertisersTryAgain:()=>{
this.sendAction("advertisersTryAgain")
},
advertisersSelectOneForOptOut:(e,t)=>{
this.sendAction("advertisersSelectOneForOptOut",{
title:e,
value:t
})
},
advertisersSelectAllForOptOut:()=>{
this.sendAction("advertisersSelectAllForOptOut")
},
advertisersOpenLearnMore:()=>{
this.sendAction("advertisersOpenLearnMore")
},
advertisersGetReadyForOptOut:()=>this.vue&&this.vue.advertisers.brokers.filter(e=>e.state===v).sort(y),
advertisersGetOptedOut:()=>this.vue&&this.vue.advertisers.brokers.filter(e=>e.state===b||e.state===h).sort(y),
advertisersGetSelectedForOptOut:()=>this.vue.advertisers.brokers.filter(e=>e.isSelectedForOptOut&&e.state===v),
advertisersGetAvailableBrokers:()=>this.vue.advertisers.brokers.filter(e=>!e.isSelectedForOptOut),
settingReset:()=>{
...
this.isSafari?g()(s):d()(s),this.vue=new n.a(s),this.ui=new l(this.sidebar),this.ui.initPanel()
}
updatePanel(e){
if(!this.vue){
return
...
t.uiAction.advertisers&&(this.vue.advertisers.state=t.advertisers.state,this.vue.advertisers.brokers=t.advertisers.brokers,
this.vue.advertisers.settings=t.advertisers.settings,
this.vue.advertisers.state!==m&&this.vue.advertisers.state!==k||this.vue.sectionToggle("Advertisers"))
})
}
deletePanel(){
...
}else if("action.advertisersAutoScanChanged"===e){
const e=t[0]
this.sendAction("advertisersSettingsAutoScanChanged",{
value:e
})
...
const t=this.AvastWRC.DEFAULTS.BRAND_NAME,a=this.AvastWRC.localization.localizeString("installPage.consent.desc",[]),i=this.urlToText(a,"https://addons.mozilla.org/firefox/addon/avg-online-security/privacy/")
let s={
...
}(mt,lt.a,ut.a,pt.a),mt.ial.topbar=new class{
constructor(e){
...
j()(t),this.vue=new n.a(t),this.ui=new l(this.topbarShadow),this.ui.initTopBar()
}
showBankbar(){
...
const kt=window.location.href
"webshieldLogs.html"===mt.bs.getMessageFromExtensionUrl(kt)&&gt.runtime.sendMessage({
